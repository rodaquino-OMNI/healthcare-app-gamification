    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Icon name={metricIcon} color={journeyColor.primary} size={sizing.icon.md} aria-hidden="true" />
                    <Text fontWeight="medium" color="gray900">
                        {metricName}
                    </Text>
                </div>

                {mockAchievement && <AchievementBadge achievement={mockAchievement} size="sm" />}
            </div>
            ...
            >
                ...
                <Text fontSize="lg" color="gray600" style={{ marginLeft: spacing.xs }}>
                    {unit}
                </Text>
            </div>
            ...
            {trend && (
                ...
                >
                    {trendInfo.icon && (
                        <Icon name={trendInfo.icon} color={trendInfo.color} size={sizing.icon.xs} aria-hidden="true" />
                    )}
