...
describe('RewardCard', () => {
    ...
    it('applies journey-specific styling', () => {
        ...
        const { unmount } = renderWithTheme(<RewardCard reward={healthReward} testID="health-reward" />);
        ...
        const { unmount: unmountCare } = renderWithTheme(<RewardCard reward={careReward} testID="care-reward" />);
        ...
        renderWithTheme(<RewardCard reward={planReward} testID="plan-reward" />);
    ...
    it('calls onPress callback when clicked', () => {
        ...
        renderWithTheme(<RewardCard reward={mockReward} onPress={onPressMock} testID="reward-card" />);
    ...
    it('renders with accessibility attributes', () => {
        ...
        const { unmount } = renderWithTheme(
            <RewardCard reward={mockReward} testID="reward-card" accessibilityLabel="Custom accessibility label" />
        );
