...
export const AchievementNotification: React.FC<AchievementNotificationProps> = ({ achievement, onClose }) => {
    return (
        <NotificationContainer role="dialog" aria-label={`Achievement notification: ${achievement.title}`}>
            <NotificationContent>
                <AchievementBadge achievement={achievement} size="lg" showProgress={!achievement.unlocked} />

                <NotificationTitle>{achievement.title}</NotificationTitle>
                ...
                <button
                    ...
                    style={{
                        ...
                        backgroundColor:
                            colors.journeys[achievement.journey as keyof typeof colors.journeys]?.primary ??
