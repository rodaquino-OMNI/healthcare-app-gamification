      ...
      {(['primary', 'secondary', 'tertiary'] as const).map((variant) => (
        <div key={variant}>
          ...
          <Tabs journey="health" variant={variant}>
            ...
            <Tabs.Panel index={0}><p>Panel One</p></Tabs.Panel>
            <Tabs.Panel index={1}><p>Panel Two</p></Tabs.Panel>
            <Tabs.Panel index={2}><p>Panel Three</p></Tabs.Panel>
          </Tabs>
        </div>
      ))}
    </div>
      ...
      {(['sm', 'md', 'lg'] as const).map((size) => (
        <div key={size}>
          ...
          <Tabs journey="health" size={size}>
            ...
            <Tabs.Panel index={0}><p>First panel</p></Tabs.Panel>
            <Tabs.Panel index={1}><p>Second panel</p></Tabs.Panel>
          </Tabs>
        </div>
      ))}
    </div>
