...
describe('Avatar', () => {
    ...
    it('renders with fallback icon when no image is provided', () => {
        renderWithTheme(<Avatar fallbackType="icon" />);
    ...
    it('renders with different sizes', () => {
        // Small size
        const { rerender } = renderWithTheme(<Avatar size="24px" name="John Doe" />);
        ...
        rerender(
            <ThemeProvider theme={baseTheme}>
                <Avatar size="40px" name="John Doe" />
            </ThemeProvider>
        );
        ...
        rerender(
            <ThemeProvider theme={baseTheme}>
                <Avatar size="56px" name="John Doe" />
            </ThemeProvider>
        );
    ...
    it('handles image loading errors', () => {
        ...
        renderWithTheme(<Avatar src="https://example.com/avatar.jpg" name="John Doe" onImageError={onImageError} />);
    ...
    it('uses journey colors when provided', () => {
        renderWithTheme(<Avatar name="John Doe" journey="health" />);
    ...
    it('shows fallback when showFallback is true, even with src', () => {
        renderWithTheme(<Avatar src="https://example.com/avatar.jpg" name="John Doe" showFallback={true} />);
