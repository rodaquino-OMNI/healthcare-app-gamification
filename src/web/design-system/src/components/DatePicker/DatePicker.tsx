...
const DateInputContainer = styled(Box)<{ hasError?: boolean; journey?: string }>`
  ...
  &:focus-within {
    border-color: ${props => props.journey 
      ? colors.journeys[props.journey].accent 
      : colors.brand.primary};
    box-shadow: 0 0 0 2px ${props => props.journey 
      ? `${colors.journeys[props.journey].primary}33` 
...
const CalendarContainer = styled.div<{ journey?: string }>`
  ...
  .react-datepicker__day--keyboard-selected {
    background-color: ${props => props.journey 
      ? colors.journeys[props.journey].primary 
      : colors.brand.primary};
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Box padding="xs">
            <Text fontSize="xl" color={colors.neutral.gray600}>📅</Text>
          </Box>
        </DateInputContainer>
      </Touchable>
    );
