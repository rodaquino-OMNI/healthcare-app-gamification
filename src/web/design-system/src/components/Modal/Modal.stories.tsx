...
export const Default: Story = {
  render: () => {
    ...
    return (
      <div>
        <Button journey="health" onPress={() => setVisible(true)}>Open Modal</Button>
        <Modal
          visible={visible}
...
export const WithTitle: Story = {
  render: () => {
    ...
    return (
      <div>
        <Button journey="care" onPress={() => setVisible(true)}>Open Care Modal</Button>
        <Modal
          visible={visible}
          onClose={() => setVisible(false)}
...
export const BottomSheet: Story = {
  render: () => {
    ...
    return (
      <div>
        <Button journey="plan" onPress={() => setVisible(true)}>Open Bottom Sheet</Button>
        <Modal
          visible={visible}
          onClose={() => setVisible(false)}
