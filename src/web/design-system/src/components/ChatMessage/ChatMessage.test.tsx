...
describe('ChatMessage', () => {
  ...
  it('displays sender name', () => {
    render(
      <ChatMessage message="Test" sender="Alice" timestamp="10:30 AM" variant="sent" />
    );
  ...
  it('renders sent variant chat bubble', () => {
    render(
      <ChatMessage message="Hello" sender="Alice" timestamp="10:30 AM" variant="sent" />
    );
  ...
  it('renders received variant chat bubble', () => {
    render(
      <ChatMessage message="Hello" sender="Bob" timestamp="10:30 AM" variant="received" />
    );
    expect(screen.getByTestId('chat-bubble')).toBeInTheDocument();
  });
  ...
  it('renders with journey prop health', () => {
    render(
      <ChatMessage message="Test" sender="Alice" timestamp="10:30 AM" variant="sent" journey="health" />
    );
    expect(screen.getByTestId('chat-message')).toBeInTheDocument();
  });
  ...
  it('renders with journey prop care', () => {
    render(
      <ChatMessage message="Test" sender="Alice" timestamp="10:30 AM" variant="sent" journey="care" />
    );
    expect(screen.getByTestId('chat-message')).toBeInTheDocument();
  });
  ...
  it('renders with journey prop plan', () => {
    render(
      <ChatMessage message="Test" sender="Alice" timestamp="10:30 AM" variant="sent" journey="plan" />
    );
    expect(screen.getByTestId('chat-message')).toBeInTheDocument();
  });
  ...
  it('shows first letter initial from multi-word sender name', () => {
    render(
      <ChatMessage message="Test" sender="Dr. Smith" timestamp="10:30 AM" variant="received" />
    );
