...
describe('RadioButton component', () => {
  ...
  it('applies health journey theme correctly', () => {
    renderWithTheme(
      <RadioButton {...defaultProps} checked={true} journey="health" />,
      healthTheme
    );
  ...
  it('applies care journey theme correctly', () => {
    renderWithTheme(
      <RadioButton {...defaultProps} checked={true} journey="care" />,
      careTheme
    );
  ...
  it('applies plan journey theme correctly', () => {
    renderWithTheme(
      <RadioButton {...defaultProps} checked={true} journey="plan" />,
      planTheme
    );
