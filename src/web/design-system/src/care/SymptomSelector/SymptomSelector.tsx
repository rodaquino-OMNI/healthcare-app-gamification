...
export const SymptomSelector: React.FC<{
...
}> = ({ symptoms, journey, onSymptomsSelected }) => {
    ...
    const filteredSymptoms = useMemo(() => {
        ...
        return symptoms.filter((symptom) => symptom.name.toLowerCase().includes(lowerCaseSearch));
    }, [symptoms, searchTerm]);
    ...
    return (
        <Box padding="md">
            <Text fontSize="xl" fontWeight="bold" color={`journeys.${journey}.primary`}>
