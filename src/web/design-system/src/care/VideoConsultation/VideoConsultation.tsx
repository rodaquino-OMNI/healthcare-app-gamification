...
const VideoConsultation: React.FC = () => {
  ...
  const [callStatus, setCallStatus] = useState<'connecting' | 'connected' | 'reconnecting' | 'disconnected'>('connecting');
  ...
  return (
    <VideoContainer>
      ...
      <ProviderInfoContainer>
        ...
        <div>
          <Text fontWeight="medium" color="white">{provider.name}</Text>
          <Text fontSize="sm" color="white">{provider.specialty}</Text>
          <Text fontSize="xs" color="white">Duração: {formatDuration(sessionDuration)}</Text>
        </div>
      </ProviderInfoContainer>
