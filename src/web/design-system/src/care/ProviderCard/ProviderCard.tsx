        ...
        >
            <Stack spacing="md">
                ...
                <Stack spacing="xs">
                    ...
                    <Text color={colors.neutral.gray700}>{provider.specialty}</Text>
                ...
                <Stack spacing="md">
                    ...
                    {provider.location && (
                        <Stack direction="row" spacing="sm" align="center">
                            <Icon name="clinic" color={careColors.primary} size={sizing.icon.sm} aria-hidden="true" />
                            <Text>
                    ...
                    {provider.availability && provider.availability.length > 0 && (
                        <Stack direction="row" spacing="sm" align="flex-start">
                            <Icon name="calendar" color={careColors.primary} size={sizing.icon.sm} aria-hidden="true" />
                            <Text>
                    ...
                    {provider.isTelemedicineAvailable && (
                        <Stack direction="row" spacing="sm" align="center">
                            <Icon name="video" color={careColors.primary} size={sizing.icon.sm} aria-hidden="true" />
                    ...
                    {provider.isCoveredByInsurance !== undefined && (
                        <Stack direction="row" spacing="sm" align="center">
                            <Icon name="money" color={careColors.primary} size={sizing.icon.sm} aria-hidden="true" />
                            <Text>
