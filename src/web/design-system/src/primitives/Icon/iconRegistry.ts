/**
 * Icon Registry — Strangeicons Health & Biology Icons
 *
 * Maps icon names to their SVG data for the Austa SuperApp.
 * Supports 111 Health & Biology icons from the strangeicons library (via Figma)
 * plus legacy icons for backward compatibility.
 *
 * Source: Figma design system — strangeicons by Strange Helix
 * Reference: handoff-spec-austa-icon-set.md
 */
...
/**
 * Complete icon registry with health icons and legacy icons
 * All icons use 24x24 viewBox unless otherwise specified
 */
export const iconRegistry: Record<string, IconData> = {
    // =====================================================================
    // LEGACY ICONS (37 existing hardcoded icons — maintained for compatibility)
    // =====================================================================
    ...
    // =====================================================================
    // STRANGEICONS — HEALTH & BIOLOGY (111 icons)
    // =====================================================================
    // Note: These are placeholder paths. In production, export actual SVG
    // data from Figma (strangeicons library) for each icon.
    // For now, using simplified geometric representations as placeholders.
    ...
    'anatomy-kidney-single': {
        path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z',
        viewBox: '0 0 24 24',
    },
    'anatomy-kidney-double': {
        path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z',
        viewBox: '0 0 24 24',
    },
    'anatomy-ribcage': {
...
/**
 * Type-safe icon name union type
 * Automatically inferred from the icon registry keys
 */
export type IconName = keyof typeof iconRegistry;

/**
 * Get icon data by name with type safety
 */
export const getIcon = (name: IconName): IconData | undefined => {
    return iconRegistry[name];
};

/**
 * List all available icon names (useful for debugging and documentation)
 */
