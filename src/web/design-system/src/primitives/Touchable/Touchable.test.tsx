...
jest.mock('./Touchable.styles', () => ({
  StyledTouchableOpacity: React.forwardRef(({ children, fullWidth, onPress, disabled, testID, ...props }: any, ref: any) => (
    <button
      ref={ref}
...
describe('Touchable', () => {
  it('renders children correctly', () => {
    render(<Touchable testID="touchable"><span>Press me</span></Touchable>);
  ...
  it('calls onPress when pressed', () => {
    ...
    render(<Touchable testID="touchable" onPress={onPressMock}><span>Click</span></Touchable>);
  ...
  it('applies disabled attribute', () => {
    render(<Touchable testID="touchable" disabled><span>Disabled</span></Touchable>);
    const touchable = screen.getByTestId('touchable');
    expect(touchable).toBeDisabled();
  });

  it('applies journey prop for theming', () => {
    render(<Touchable testID="touchable" journey="health"><span>Health</span></Touchable>);
    const touchable = screen.getByTestId('touchable');
    expect(touchable).toBeInTheDocument();
  });
  ...
  it('forwards ref correctly', () => {
    ...
    render(<Touchable ref={ref} testID="touchable"><span>Ref</span></Touchable>);
