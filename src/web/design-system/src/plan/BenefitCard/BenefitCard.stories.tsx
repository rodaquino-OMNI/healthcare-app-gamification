...
export const WithLimitations: Story = {
  args: {
    benefit: {
      ...
      limitations: 'Limite de 12 exames simples por ano. Exames de alta complexidade sujeitos a autorização prévia.',
    },
    onPress: () => {},
  },
};
...
export const WithUsage: Story = {
  args: {
    benefit: {
      ...
      description: 'Cobertura para internações hospitalares em casos de emergência ou eletivas conforme indicação médica.',
