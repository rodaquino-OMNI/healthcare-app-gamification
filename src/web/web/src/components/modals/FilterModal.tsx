...
export const FilterModal: React.FC<FilterModalProps> = ({
  ...
  return (
    ...
    <Modal visible={visible} onClose={onClose} title={title} journey={journey?.id as any}>
      ...
      <Button onPress={handleApply} journey={journey?.id as any}>Apply</Button>
      <Button variant="secondary" onPress={handleCancel} journey={journey?.id as any}>Cancel</Button>
    </Modal>
  );
};