...
jest.mock('src/web/web/src/hooks/useClaims', () => ({
  useClaims: () => ({
    claims: [
      { id: 'c1', planId: 'p1', type: 'medical', amount: 200, status: 'approved', submittedAt: '2026-01-01', documents: [] },
      { id: 'c2', planId: 'p1', type: 'dental', amount: 150, status: 'pending', submittedAt: '2026-01-15', documents: [] },
    ],
    loading: false,
    error: null,
  }),
...
jest.mock('@web/design-system/src/tokens', () => ({
  ...
  spacing: {
    xs: '8px', sm: '12px', md: '16px', lg: '24px', xl: '32px', '3xl': '64px',
  },
