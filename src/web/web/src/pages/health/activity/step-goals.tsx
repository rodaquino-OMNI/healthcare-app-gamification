  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="health" elevation="sm" padding="lg" style={{ marginBottom: spacing.xl, textAlign: 'center' }}>
        <Text fontSize="sm" color={colors.gray[50]}>Today's Progress</Text>
        ...
        <div style={{
          width: '100%', height: 12, borderRadius: '6px',
          backgroundColor: colors.gray[10], overflow: 'hidden', marginTop: spacing.sm,
        }}>
          <div style={{
            width: `${PROGRESS_PCT}%`, height: '100%', borderRadius: '6px',
            backgroundColor: colors.journeys.health.primary,
          }} />
        </div>
        <Text fontSize="xs" color={colors.gray[40]} style={{ marginTop: spacing.xs }}>{PROGRESS_PCT}% complete</Text>
      </Card>

      <Card journey="health" elevation="sm" padding="lg" style={{ marginBottom: spacing.xl, textAlign: 'center' }}>
        <Text fontSize="sm" color={colors.gray[50]}>Current Streak</Text>
        <Text fontSize="2xl" fontWeight="bold" color={colors.journeys.health.primary} style={{ margin: `${spacing.xs} 0` }}>
          7 days
        </Text>
        <Text fontSize="xs" color={colors.semantic.success}>Goal met every day this week</Text>
      </Card>
      ...
      <Card journey="health" elevation="sm" padding="md" style={{ marginBottom: spacing['2xl'] }}>
        <Box display="flex" alignItems="center" style={{ gap: spacing.md }}>
          <Box style={{ flex: 1 }}>
            <Text fontSize="sm" color={colors.gray[50]} style={{ marginBottom: spacing['3xs'] }}>Daily Step Target</Text>
            <input type="number" value={goal} onChange={(e) => setGoal(e.target.value)} aria-label="Daily step target" style={inputStyle} />
          </Box>
          <Text fontSize="sm" color={colors.gray[40]}>steps/day</Text>
        </Box>
      </Card>
