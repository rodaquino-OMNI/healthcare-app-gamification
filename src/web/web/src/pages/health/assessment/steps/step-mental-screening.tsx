  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.lg }}>
      ...
      {bothAnswered && (
        ...
        >
          <Text fontSize="sm" color={colors.neutral.gray700}>PHQ-2 Score</Text>
          <div
            style={{
      ...
      <Card journey="health" elevation="sm" padding="lg" style={{ borderLeft: `3px solid ${colors.semantic.info}` }}>
        ...
        <Text fontSize="xs" color={colors.gray[50]} style={{ marginTop: spacing['3xs'] }}>
          Your responses are confidential and protected by medical privacy regulations. This screening is not a diagnosis but helps identify areas where you may benefit from additional support.
        </Text>
      </Card>
    </div>
  );
