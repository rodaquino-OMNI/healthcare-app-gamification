      ...
      <Card journey="health" elevation="md" padding="lg">
        ...
        >
          <Box>
            ...
            <Text fontSize="xs" color={colors.gray[50]}>Total Doses</Text>
          </Box>
          <Box>
            <Text fontSize="heading-xl" fontWeight="bold" color={colors.semantic.success}>
              {summary.takenDoses}
            </Text>
            <Text fontSize="xs" color={colors.gray[50]}>Taken</Text>
          </Box>
          <Box>
            <Text fontSize="heading-xl" fontWeight="bold" color={colors.semantic.error}>
              {summary.missedDoses}
            </Text>
            <Text fontSize="xs" color={colors.gray[50]}>Missed</Text>
          </Box>
          <Box>
            <Text fontSize="heading-xl" fontWeight="bold" color={colors.journeys.health.primary}>
              {summary.adherence}%
            </Text>
            <Text fontSize="xs" color={colors.gray[50]}>Adherence</Text>
          </Box>
        </div>
      </Card>
        ...
        {MOCK_MEDICATIONS.map((med, idx) => (
          <Box
            ...
            style={{
              ...
              borderBottom:
                idx < MOCK_MEDICATIONS.length - 1
                  ? `1px solid ${colors.neutral.gray200}`
                  : 'none',
            }}
          >
            <Box>
              <Text fontWeight="medium" fontSize="sm">{med.name}</Text>
