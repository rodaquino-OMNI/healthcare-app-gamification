...
const MedicationAddPage: React.FC = () => {
  ...
  const updateField = <K extends keyof MedicationFormState>(
    field: K,
    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="health" elevation="md" padding="lg">
        ...
        <Box style={{ marginBottom: spacing.lg }}>
          ...
          />
          {errors.form && (
            <Text fontSize="sm" color={colors.semantic.error}>{errors.form}</Text>
          )}
        </Box>
        ...
        <Box style={{ marginBottom: spacing.lg }}>
          ...
          />
          {errors.frequency && (
            <Text fontSize="sm" color={colors.semantic.error}>{errors.frequency}</Text>
          )}
        </Box>
