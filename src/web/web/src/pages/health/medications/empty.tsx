    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      >
        ...
        <Text
          ...
          style={{ marginTop: spacing.sm, maxWidth: 360 }}
        >
          Start tracking your health by adding your first medication.
          We will help you stay on schedule with reminders and dose tracking.
        </Text>
