        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
            ...
            <Box display="flex" justifyContent="center" style={{ marginBottom: spacing.xl }}>
                <Button
                    variant="secondary"
                    journey="health"
                    onPress={() => window.alert('Add step dialog')}
                ...
                {[
                    {
                        ...
                        desc: 'Silence notifications during routine',
                        value: dndMode,
                        toggle: () => setDndMode(!dndMode),
                    },
                    {
                        label: 'Routine Reminder',
                        desc: 'Notify when it is time to start',
                        value: reminder,
