...
const ProgramDetailPage: React.FC = () => {
    ...
    return (
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
                ...
                {steps.map((step) => (
                    ...
                    >
                        <Box display="flex" alignItems="center" style={{ gap: spacing.sm }}>
                            ...
                            <Text
                                fontSize="sm"
                                fontWeight={step.done ? 'semiBold' : 'regular'}
                                color={step.done ? colors.journeys.health.text : colors.gray[50]}
            ...
            <Button
                journey="health"
                onPress={() => window.alert('Continuing program...')}
                accessibilityLabel={progress > 0 ? 'Continue program' : 'Start program'}
            >
