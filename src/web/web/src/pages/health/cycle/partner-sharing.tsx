    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="health" elevation="sm" padding="md" style={{ marginBottom: spacing.xl }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box>
            <Text fontWeight="semiBold" fontSize="md">Enable Sharing</Text>
            <Text fontSize="sm" color={colors.gray[50]}>Allow your partner to view selected data</Text>
          </Box>
          <button
      ...
      {sharingEnabled && (
        <>
              ...
              <Card key={opt.id} journey="health" elevation="sm" padding="md">
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Box style={{ flex: 1, marginRight: spacing.md }}>
                    <Text fontWeight="semiBold" fontSize="sm">{opt.label}</Text>
                    <Text fontSize="xs" color={colors.gray[50]}>{opt.description}</Text>
                  </Box>
                  <button
          ...
          <Card journey="health" elevation="sm" padding="md" style={{ marginBottom: spacing.xl }}>
            {partnerConnected ? (
              <Box>
                <Text fontWeight="semiBold" fontSize="md">Partner Name</Text>
                <Text fontSize="sm" color={colors.gray[50]}>Connected since Jan 15, 2026</Text>
                <Button variant="secondary" journey="health" onPress={handleDisconnect} accessibilityLabel="Disconnect partner" style={{ marginTop: spacing.sm }}>
                  Disconnect
                </Button>
              </Box>
            ) : (
              <Box>
                ...
                <Button journey="health" onPress={handleGenerateLink} accessibilityLabel="Generate invite link">
