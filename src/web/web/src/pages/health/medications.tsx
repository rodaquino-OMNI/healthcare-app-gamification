...
const MOCK_MEDICATIONS: Medication[] = [
  { id: '1', name: 'Losartan', dosage: '50mg', schedule: 'Once daily, morning', status: 'active', adherence: true, refillDate: '2026-03-15' },
  { id: '2', name: 'Metformin', dosage: '500mg', schedule: 'Twice daily with meals', status: 'active', adherence: true, refillDate: '2026-03-01' },
  { id: '3', name: 'Omeprazole', dosage: '20mg', schedule: 'Once daily before breakfast', status: 'active', adherence: false, refillDate: '2026-02-28' },
  { id: '4', name: 'Amoxicillin', dosage: '500mg', schedule: '3 times daily for 10 days', status: 'completed', adherence: true },
  ...
  const renderMedicationCard = (med: Medication) => (
    ...
    >
      <Box display="flex" justifyContent="space-between" alignItems="center">
        ...
        <Badge
          variant="status"
          status={med.adherence ? 'success' : 'warning'}
        >
      ...
      <Tabs journey="health" defaultTab={0}>
        ...
        <Tabs.Panel index={1}>
          {completedMeds.length === 0 ? (
            <Box style={{ textAlign: 'center', padding: spacing.xl }}>
              <Text color={colors.gray[50]}>
                {searchTerm ? 'No completed medications match your search.' : 'No completed medications.'}
              </Text>
            </Box>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.sm }}>
