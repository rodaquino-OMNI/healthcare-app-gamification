...
const MOCK_NOTIFICATIONS: CategoryNotification[] = [
    {
        ...
        preview: 'Voce atingiu 8.000 de 10.000 passos.',
        timestamp: '1h',
    },
    {
        id: 'c2',
        ...
        preview: 'Consulta com Dr. Carlos Lima em 25 Fev.',
        timestamp: '3h',
    },
    {
        id: 'c3',
        ...
        preview: 'Plano agora inclui odontologia.',
        timestamp: '5h',
    },
    {
        id: 'c4',
        category: 'system',
        title: 'Manutencao',
        preview: 'Manutencao dia 28 Fev 02:00-04:00.',
        timestamp: '8h',
    },
    {
        id: 'c5',
        ...
        preview: 'Losartana 50mg tomada com sucesso.',
        timestamp: '12h',
    },
    {
        id: 'c6',
        ...
        preview: 'Hemograma completo pronto.',
        timestamp: '1d',
    },
                        ...
                        return (
                            <div key={n.id} style={{ ...styles.card, borderLeftColor: catColor }}>
                                <div style={styles.cardHeader}>
                                    <span
                                        style={{ ...styles.badge, color: catColor, backgroundColor: `${catColor}20` }}
                                    >
