...
const getSeverityBgColor = (severity: AlertSeverity): string => {
  switch (severity) {
    case 'critical': return colors.semantic.errorBg;
    case 'warning': return colors.semantic.warningBg;
    case 'info': return `${colors.semantic.info}10`;
  }
};
      ...
      <div style={pageStyles.header}>
        <div>
          ...
          <p style={pageStyles.pageSubtitle}>
            Acompanhe notificacoes e alertas sobre sua saude.
          </p>
        </div>
        {activeAlerts.length > 0 && (
          <button
            style={pageStyles.dismissAllButton}
            ...
            >
              <div style={pageStyles.alertHeader}>
                <div style={pageStyles.alertTitleRow}>
                  ...
                  <span style={pageStyles.alertTimestamp}>
              ...
              <div style={pageStyles.alertActions}>
                ...
                <button
                  style={pageStyles.dismissButton}
