...
import { QuestCard } from 'src/web/design-system/src/gamification/QuestCard';
...
const MOCK_QUESTS: Quest[] = [
  { id: 'q1', title: 'First Steps', description: 'Complete your health profile and connect a device', journey: 'health', icon: 'heart', progress: 2, total: 3, completed: false },
  { id: 'q2', title: 'Health Tracker', description: 'Log your vitals for 7 consecutive days', journey: 'health', icon: 'activity', progress: 5, total: 7, completed: false },
  { id: 'q3', title: 'Wellness Check', description: 'Schedule and attend a preventive care appointment', journey: 'care', icon: 'calendar', progress: 1, total: 1, completed: true },
  { id: 'q4', title: 'Know Your Coverage', description: 'Review all sections of your insurance plan', journey: 'plan', icon: 'shield', progress: 3, total: 5, completed: false },
  { id: 'q5', title: 'Medication Master', description: 'Set up reminders for all your medications', journey: 'health', icon: 'pill', progress: 4, total: 4, completed: true },
  { id: 'q6', title: 'Symptom Scholar', description: 'Use the symptom checker 3 times', journey: 'care', icon: 'search', progress: 1, total: 3, completed: false },
  { id: 'q7', title: 'Claim Champion', description: 'Submit and track an insurance claim', journey: 'plan', icon: 'file', progress: 0, total: 2, completed: false },
  { id: 'q8', title: 'Community Helper', description: 'Share a health tip with another user', journey: 'health', icon: 'users', progress: 0, total: 1, completed: false },
];
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: spacing.xl }}>
      <Box display="flex" alignItems="center" style={{ marginBottom: spacing.lg, gap: spacing.md }}>
        <Link href="/achievements">
          <Button variant="secondary" onPress={() => {}}>Back</Button>
        </Link>
        <Text fontSize="2xl" fontWeight="bold">Quests</Text>
      </Box>

      {/* Summary bar */}
      <Box display="flex" style={{ gap: spacing.md, marginBottom: spacing.xl }}>
        <Card padding="md" style={{ flex: 1, textAlign: 'center' }}>
          <Text fontSize="2xl" fontWeight="bold" color="#6C63FF">{activeCount}</Text>
          <Text fontSize="sm" color={colors.gray[50]}>Active</Text>
        </Card>
        <Card padding="md" style={{ flex: 1, textAlign: 'center' }}>
          <Text fontSize="2xl" fontWeight="bold" color={colors.semantic.success}>{completedCount}</Text>
          <Text fontSize="sm" color={colors.gray[50]}>Completed</Text>
        </Card>
        <Card padding="md" style={{ flex: 1, textAlign: 'center' }}>
          <Text fontSize="2xl" fontWeight="bold">{MOCK_QUESTS.length}</Text>
          <Text fontSize="sm" color={colors.gray[50]}>Total</Text>
        </Card>
      </Box>
