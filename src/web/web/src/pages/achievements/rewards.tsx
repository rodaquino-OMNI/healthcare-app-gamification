...
const MOCK_REWARDS: Reward[] = [
  { id: 'r1', title: 'Premium Health Report', description: 'Get a detailed analysis of your health metrics with personalized recommendations', journey: 'health', icon: 'chart', xp: 500 },
  { id: 'r2', title: 'Priority Appointment', description: 'Skip the queue and book a priority appointment with your preferred doctor', journey: 'care', icon: 'calendar', xp: 750 },
  { id: 'r3', title: 'Plan Upgrade Discount', description: 'Get 10% off your next plan upgrade or renewal', journey: 'plan', icon: 'tag', xp: 1000 },
  { id: 'r4', title: 'Wellness Kit', description: 'Receive a curated wellness kit with health monitoring accessories', journey: 'health', icon: 'gift', xp: 1500 },
  { id: 'r5', title: 'Free Telemedicine Session', description: 'One complimentary telemedicine consultation with a specialist', journey: 'care', icon: 'video', xp: 800 },
  { id: 'r6', title: 'Dental Coverage Add-on', description: 'One month of free dental coverage added to your current plan', journey: 'plan', icon: 'shield', xp: 2000 },
  { id: 'r7', title: 'Fitness Class Pass', description: 'Access to 5 partner gym classes or fitness sessions', journey: 'health', icon: 'dumbbell', xp: 600 },
  { id: 'r8', title: 'Nutritionist Consultation', description: 'A personalized nutrition plan from a certified nutritionist', journey: 'care', icon: 'apple', xp: 900 },
];
...
const RewardsPage: React.FC = () => {
  ...
  const filteredRewards = MOCK_REWARDS
    .filter((reward) => journeyFilter === 'all' || reward.journey === journeyFilter)
    .sort((a, b) => {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: spacing.xl }}>
      <Box display="flex" alignItems="center" style={{ marginBottom: spacing.lg, gap: spacing.md }}>
        ...
        <Text fontSize="2xl" fontWeight="bold">Rewards</Text>
      </Box>

      {/* XP Balance header */}
      <Card padding="lg" style={{ marginBottom: spacing['2xl'], textAlign: 'center', backgroundColor: '#f0eeff' }}>
      ...
      <Box display="flex" alignItems="center" style={{ gap: spacing.sm, marginBottom: spacing['2xl'] }}>
        <Text fontSize="sm" color={colors.gray[50]}>Sort by:</Text>
