...
import { Leaderboard } from 'src/web/design-system/src/gamification/Leaderboard';
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: spacing.xl }}>
        ...
        {(Object.keys(TIMEFRAME_LABELS) as Timeframe[]).map((tf) => (
          <button
            ...
            style={{
              ...
              backgroundColor: timeframe === tf ? colors.brand?.primary ?? '#6C63FF' : colors.gray[10] ?? '#f0f0f0',
      ...
      <Card padding="md" style={{ marginTop: spacing.lg, backgroundColor: '#f0eeff' }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Text fontSize="xl" fontWeight="bold" color="#6C63FF">#4</Text>
        </Box>
