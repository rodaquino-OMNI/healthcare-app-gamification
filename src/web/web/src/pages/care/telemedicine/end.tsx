      ...
      <Card journey="care" elevation="md" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.xs }}>
          <Box display="flex" justifyContent="space-between">
            ...
            <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_SUMMARY.doctorName}</Text>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Text fontSize="sm" color={colors.gray[50]}>Specialty</Text>
            <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_SUMMARY.specialty}</Text>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Text fontSize="sm" color={colors.gray[50]}>Duration</Text>
            <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_SUMMARY.duration}</Text>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Text fontSize="sm" color={colors.gray[50]}>Date</Text>
            <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_SUMMARY.date}</Text>
          </Box>
        </div>
      </Card>
