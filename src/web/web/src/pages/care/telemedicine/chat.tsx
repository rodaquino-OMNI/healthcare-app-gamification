...
const MOCK_MESSAGES: ChatMessage[] = [
  ...
  { id: 'm3', sender: 'doctor', text: 'I see. Can you describe the pain? Is it constant or intermittent?', time: '10:03' },
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" style={{ marginBottom: spacing.lg }}>
        ...
        <Badge variant="status" status="success">Live</Badge>
      </Box>
      ...
      <Box display="flex" style={{ gap: spacing.sm }}>
        ...
        >
          <Text fontSize="sm" color={colors.gray[40]}>Type a message...</Text>
        </div>
        <Button
          journey="care"
          onPress={() => {}}
