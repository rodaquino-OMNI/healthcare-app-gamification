    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="care" elevation="sm" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <Box display="flex" justifyContent="space-between" style={{ marginBottom: spacing['3xs'] }}>
          ...
          <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_PAYMENT.doctor}</Text>
        </Box>
        <Box display="flex" justifyContent="space-between" style={{ marginBottom: spacing['3xs'] }}>
          <Text fontSize="sm" color={colors.gray[50]}>Service</Text>
          <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_PAYMENT.service}</Text>
        </Box>
        <Box display="flex" justifyContent="space-between">
          <Text fontSize="sm" color={colors.gray[50]}>Date</Text>
          <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_PAYMENT.date}</Text>
        </Box>
      </Card>
      ...
      <Card journey="care" elevation="sm" padding="lg" style={{ marginBottom: spacing.xl }}>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <div>
            <Text fontWeight="bold" fontSize="md" color={colors.journeys.care.text}>Payment Method</Text>
            <Text fontSize="sm" color={colors.gray[50]}>{MOCK_PAYMENT.method}</Text>
          </div>
          <Badge variant="status" status="info">Saved</Badge>
        </Box>
      </Card>
