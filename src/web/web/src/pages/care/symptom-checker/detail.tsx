      ...
      <Card journey="care" elevation="md" padding="lg">
        <Box style={{ marginBottom: spacing.xl }}>
          ...
          <Box display="flex" justifyContent="space-between" style={{ marginTop: spacing.xs }}>
            <Text fontSize="sm" color={colors.semantic.success}>Mild</Text>
            <Text fontSize="sm" color={colors.semantic.warning}>Moderate</Text>
            <Text fontSize="sm" color={colors.semantic.error}>Severe</Text>
          </Box>
        </Box>
