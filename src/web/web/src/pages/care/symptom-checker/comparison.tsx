...
const ComparisonPage: React.FC = () => {
        ...
        >
          <div
            style={{
              ...
              height: '100%',
              backgroundColor: severity > 6 ? colors.semantic.error : severity > 3 ? colors.journeys.care.primary : colors.semantic.warning,
              borderRadius: '4px',
            }}
          />
        </div>
      </div>
      <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text} style={{ minWidth: '30px', textAlign: 'right' }}>
        {severity}/10
      </Text>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text} style={{ marginBottom: spacing.sm }}>
          Resumo do Progresso
        </Text>
