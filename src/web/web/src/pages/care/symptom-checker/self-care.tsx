...
const SELF_CARE_TIPS: SelfCareTip[] = [
  { id: 't1', category: 'Hydration', title: 'Drink Plenty of Fluids', description: 'Aim for 8-10 glasses of water daily. Warm beverages like tea with honey can soothe the throat.' },
  { id: 't2', category: 'Hydration', title: 'Avoid Dehydrating Drinks', description: 'Limit caffeine and alcohol as they can contribute to dehydration.' },
  { id: 't3', category: 'Rest', title: 'Get Adequate Sleep', description: 'Aim for 7-9 hours of sleep. Your body heals faster during rest.' },
  { id: 't4', category: 'Rest', title: 'Reduce Physical Activity', description: 'Avoid strenuous exercise until symptoms improve. Light walking is acceptable.' },
  { id: 't5', category: 'Nutrition', title: 'Eat Nutrient-Rich Foods', description: 'Focus on fruits, vegetables, and lean proteins. Vitamin C and zinc may support recovery.' },
  { id: 't6', category: 'Nutrition', title: 'Warm Soups and Broths', description: 'Chicken soup and bone broth provide hydration and nutrients while being easy to digest.' },
  { id: 't7', category: 'Environment', title: 'Use a Humidifier', description: 'Adding moisture to the air can ease congestion and soothe irritated airways.' },
  { id: 't8', category: 'Environment', title: 'Keep Warm and Comfortable', description: 'Maintain a comfortable room temperature and dress in layers.' },
];
