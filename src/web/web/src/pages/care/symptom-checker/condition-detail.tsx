...
const CONDITION_DETAIL = {
  ...
  sections: [
    {
      title: 'Overview',
      content: 'An upper respiratory infection (URI) is a viral illness that affects the nose, throat, and airways. It is one of the most common reasons for medical visits and typically resolves without treatment.',
    },
    {
      title: 'Common Causes',
      content: 'Rhinoviruses are the most common cause. Other causes include coronavirus, adenovirus, and influenza virus. Transmission occurs through respiratory droplets or contaminated surfaces.',
    },
    {
      title: 'Treatment Options',
      content: 'Rest and fluids are the primary treatment. Over-the-counter medications like acetaminophen, ibuprofen, decongestants, and antihistamines can help manage symptoms. Antibiotics are not effective against viral infections.',
    },
    {
      title: 'When to Worry',
      content: 'Seek medical attention if symptoms worsen after 10 days, you develop a high fever (above 39.4C), experience difficulty breathing, chest pain, severe headache with stiff neck, or symptoms significantly impact daily activities.',
    },
  ] as Section[],
};
