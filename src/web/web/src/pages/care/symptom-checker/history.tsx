...
const MOCK_HISTORY: CheckHistory[] = [
  { id: 'h1', date: '2026-02-18', primarySymptom: 'Headache, nasal congestion', topCondition: 'Upper Respiratory Infection', severity: 'low', status: 'ongoing' },
  { id: 'h2', date: '2026-02-10', primarySymptom: 'Sore throat, fever', topCondition: 'Pharyngitis', severity: 'moderate', status: 'resolved' },
  { id: 'h3', date: '2026-01-25', primarySymptom: 'Lower back pain', topCondition: 'Lumbar Strain', severity: 'low', status: 'resolved' },
  { id: 'h4', date: '2026-01-15', primarySymptom: 'Chest tightness, wheezing', topCondition: 'Asthma Exacerbation', severity: 'high', status: 'resolved' },
  { id: 'h5', date: '2025-12-28', primarySymptom: 'Stomach pain, nausea', topCondition: 'Gastritis', severity: 'moderate', status: 'resolved' },
];
        ...
        {FILTER_TABS.map((tab) => (
          <button
            ...
            style={{
              ...
              backgroundColor: activeFilter === tab.key ? colors.journeys.care.primary : colors.neutral.gray200,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.md }}>
          {filteredHistory.map((item) => (
            <Card
              ...
              padding="lg"
              interactive
              onPress={() => router.push({ pathname: '/care/symptom-checker/condition-detail', query: { checkId: item.id } })}
            ...
            >
              <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: spacing['3xs'] }}>
