...
const FollowUpPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.text} style={{ marginBottom: spacing.md }}>
          Status Atual
        </Text>
        <div
          style={{
        ...
        >
          {(['Melhor', 'Igual', 'Pior'] as const).map((option) => (
            <button
              ...
              style={{
                padding: spacing.md,
                backgroundColor: status === option ? colors.journeys.care.primary : colors.neutral.white,
      ...
      >
        <Text fontSize="sm" color={colors.journeys.care.text}>
          Seu acompanhamento ajuda a melhorar seu historico de saude e fornece informacoes valiosas para seus medicos.
        </Text>
      </div>
