  ...
  return (
    ...
    >
      ...
      <Text
        ...
        style={{ marginTop: spacing.xs, marginBottom: spacing['2xl'] }}
      >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.sm, width: '100%', maxWidth: '400px' }}>
        {ANALYSIS_STEPS.map((step, index) => {
          ...
          return (
            <Box key={step.id} display="flex" alignItems="center" style={{ gap: spacing.sm }}>
              ...
              <Text
                fontSize="sm"
                color={isComplete ? colors.semantic.success : isActive ? colors.journeys.care.text : colors.gray[40]}
