...
const MOCK_CONDITIONS: Condition[] = [
  { id: 'c1', name: 'Upper Respiratory Infection', probability: 72, severity: 'low', summary: 'Common viral infection of the nose and throat.' },
  { id: 'c2', name: 'Seasonal Allergies', probability: 58, severity: 'low', summary: 'Immune response to airborne allergens.' },
  { id: 'c3', name: 'Sinusitis', probability: 34, severity: 'moderate', summary: 'Inflammation of the sinus cavities.' },
  { id: 'c4', name: 'Migraine', probability: 22, severity: 'moderate', summary: 'Recurrent headaches with sensitivity to light and sound.' },
  { id: 'c5', name: 'Tension Headache', probability: 18, severity: 'low', summary: 'Mild to moderate diffuse head pain.' },
];
