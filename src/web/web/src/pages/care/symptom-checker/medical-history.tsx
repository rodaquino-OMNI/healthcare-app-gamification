          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.xs }}>
            {HISTORY_ITEMS.filter((item) => item.category === category).map((item) => (
              <Card
                ...
                backgroundColor={enabled[item.id] ? colors.journeys.care.background : colors.neutral.white}
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center" padding="sm">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: '22px',
                      borderRadius: '11px',
                      backgroundColor: enabled[item.id] ? colors.journeys.care.primary : colors.neutral.gray400,
                      position: 'relative',
