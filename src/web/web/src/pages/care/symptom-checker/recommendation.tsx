...
const MOCK_RECOMMENDATIONS: Recommendation[] = [
  ...
  },
  {
    ...
    description: 'Consider acetaminophen or ibuprofen for fever and pain. Decongestants may help with nasal symptoms.',
    urgency: 'routine',
  },
  {
    id: 'r3',
    ...
    description: 'If symptoms persist beyond 10 days or worsen significantly, schedule an appointment with your primary care provider.',
    urgency: 'soon',
  },
  {
    id: 'r4',
    ...
    description: 'Go to the emergency room if you experience difficulty breathing, chest pain, persistent high fever (above 39.4C/103F), or confusion.',
    urgency: 'immediate',
  },
];
...
const getUrgencyLabel = (urgency: string): string => {
  switch (urgency) {
    ...
    case 'soon': return 'Within a few days';
          ...
          >
            ...
            >
              <Box display="flex" alignItems="center" style={{ gap: spacing.xs }}>
                <Badge
                  variant="status"
                  status={getUrgencyStatus(rec.urgency)}
                >
