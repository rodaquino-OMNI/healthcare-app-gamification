  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="care" elevation="sm" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <Text fontSize="md" color={colors.journeys.care.text}>{MOCK_REFERRAL.referringDoctor}</Text>
        <Text fontSize="sm" color={colors.gray[50]}>{MOCK_REFERRAL.referringSpecialty}</Text>
      </Card>
      ...
      <Card journey="care" elevation="md" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <Text fontSize="lg" fontWeight="medium" color={colors.journeys.care.text}>{MOCK_REFERRAL.specialist}</Text>
        <Text fontSize="sm" color={colors.journeys.care.primary}>{MOCK_REFERRAL.specialistField}</Text>
        <Text fontSize="sm" color={colors.gray[60]} style={{ marginTop: spacing.xs }}>
          {MOCK_REFERRAL.specialistClinic}
        </Text>
        <Text fontSize="sm" color={colors.gray[50]}>{MOCK_REFERRAL.specialistAddress}</Text>
      </Card>
      ...
      <Card journey="care" elevation="sm" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <Text fontSize="sm" color={colors.gray[60]}>{MOCK_REFERRAL.reason}</Text>
      </Card>
      ...
      <Card journey="care" elevation="sm" padding="lg" style={{ marginBottom: spacing.lg }}>
        ...
        <Text fontSize="sm" color={colors.gray[60]}>{MOCK_REFERRAL.notes}</Text>
