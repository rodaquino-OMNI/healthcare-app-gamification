...
const TYPES: AppointmentTypeOption[] = [
  { id: 'presencial', label: 'Presencial', description: 'Consulta na clinica com o medico pessoalmente.', icon: 'P', price: 'R$ 350,00' },
  { id: 'telemedicina', label: 'Telemedicina', description: 'Consulta por video chamada, no conforto de casa.', icon: 'T', price: 'R$ 250,00' },
  { id: 'domiciliar', label: 'Visita Domiciliar', description: 'O medico vai ate voce. Ideal para acamados.', icon: 'D', price: 'R$ 550,00' },
];
            ...
            return (
              ...
              >
                <Box padding="lg" style={{
                  border: isSelected ? `2px solid ${colors.journeys.care.primary}` : `2px solid transparent`,
                  borderRadius: '12px',
                  ...
                  <div style={{
                    ...
                    height: '56px',
                    borderRadius: '50%',
                    backgroundColor: isSelected ? colors.journeys.care.primary : colors.neutral.gray100,
                    display: 'inline-flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    marginBottom: spacing.md,
                  }}>
                    <Text fontSize="xl" fontWeight="bold" color={isSelected ? colors.neutral.white : colors.gray[50]}>
                      {t.icon}
                    </Text>
                  </div>
                  <Text fontWeight="bold" fontSize="md" color={colors.journeys.care.text}>{t.label}</Text>
                  <Text fontSize="sm" color={colors.gray[50]} style={{ marginTop: spacing.xs, minHeight: '40px' }}>
                    {t.description}
                  </Text>
                  <Text fontWeight="bold" fontSize="md" color={colors.journeys.care.primary} style={{ marginTop: spacing.sm }}>
                    {t.price}
                  </Text>
                </Box>
              </Card>
