      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: spacing.xl }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: spacing.xl }}>
          <div
            ...
            aria-hidden="true"
          >
            <Text fontSize="2xl" color={colors.journeys.care.primary}>OK</Text>
          </div>
        ...
        <Card journey="care" elevation="md">
          <Box padding="lg">
            ...
            <div style={{ display: 'grid', gap: spacing.md }}>
              <div>
                <Text fontSize="xs" color={colors.gray[50]}>Medico</Text>
              ...
              <div>
                <Text fontSize="xs" color={colors.gray[50]}>Data</Text>
                <Text fontSize="md" fontWeight="medium" color={colors.journeys.care.text}>
                  {formattedDate}
                </Text>
              </div>
              ...
              <div>
                <Text fontSize="xs" color={colors.gray[50]}>Horario</Text>
                <Text fontSize="md" fontWeight="medium" color={colors.journeys.care.text}>
                  {time || '—'}
                </Text>
              </div>
              ...
              <div>
                <Text fontSize="xs" color={colors.gray[50]}>Tipo</Text>
                <span
                  style={{
                    display: 'inline-block',
                    padding: `${spacing.xs} ${spacing.sm}`,
                    borderRadius: '20px',
                    backgroundColor: isTelemedicine ? colors.journeys.care.background : colors.neutral.gray100,
                    color: isTelemedicine ? colors.journeys.care.primary : colors.journeys.care.text,
                    fontSize: '14px',
                    fontWeight: 600,
                    marginTop: '4px',
                  }}
              ...
              <div>
                <Text fontSize="xs" color={colors.gray[50]}>Valor</Text>
