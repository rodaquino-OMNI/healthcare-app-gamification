...
const MOCK_APPOINTMENTS: AppointmentItem[] = [
  { id: '1', doctor: 'Dra. Ana Silva', specialty: 'Cardiologia', date: '03/03/2026', time: '14:00', type: 'Presencial', status: 'upcoming' },
  { id: '2', doctor: 'Dr. Carlos Santos', specialty: 'Clinico Geral', date: '10/03/2026', time: '09:30', type: 'Telemedicina', status: 'upcoming' },
  { id: '3', doctor: 'Dra. Maria Oliveira', specialty: 'Dermatologia', date: '15/01/2026', time: '10:00', type: 'Presencial', status: 'past' },
  { id: '4', doctor: 'Dr. Pedro Lima', specialty: 'Ortopedia', date: '20/12/2025', time: '16:00', type: 'Presencial', status: 'past' },
  { id: '5', doctor: 'Dra. Lucia Ferreira', specialty: 'Pediatria', date: '08/01/2026', time: '11:00', type: 'Telemedicina', status: 'cancelled' },
];
    ...
    <CareLayout>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: spacing.xl }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.xl }}>
            ...
            {TABS.map((tab) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '20px',
                  border: 'none',
                  backgroundColor: activeTab === tab.key ? colors.journeys.care.primary : colors.neutral.gray100,
          ...
          <Button journey="care" onPress={() => router.push('/care/appointments/search')} accessibilityLabel="Nova consulta">
            Nova Consulta
          </Button>
        </div>
        ...
        {filtered.length === 0 ? (
          <Card journey="care" elevation="sm">
            <Box padding="xl" style={{ textAlign: 'center' }}>
              <Text fontSize="md" color={colors.gray[50]}>Nenhuma consulta nesta categoria.</Text>
            </Box>
          </Card>
        ) : (
              ...
              >
                <Box padding="md">
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: spacing.xs }}>
                    <Text fontWeight="bold" fontSize="md" color={colors.journeys.care.text}>{apt.doctor}</Text>
                    <span style={{
                  ...
                  <Text fontSize="sm" color={colors.gray[50]}>{apt.specialty}</Text>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: spacing.sm }}>
                    <Text fontSize="sm" color={colors.journeys.care.text}>{apt.date} - {apt.time}</Text>
                    <span style={{
                      padding: `${spacing['3xs']} ${spacing.xs}`,
                      borderRadius: '12px',
