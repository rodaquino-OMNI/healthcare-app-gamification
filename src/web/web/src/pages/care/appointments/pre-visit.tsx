      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: spacing.xl }}>
        <Card journey="care" elevation="sm" style={{ marginBottom: spacing.xl }}>
          <Box padding="md">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.xs }}>
              ...
              <Text fontSize="sm" color={colors.journeys.care.primary}>03/03/2026 14:00</Text>
            </div>
          </Box>
        </Card>
        ...
        <div style={{ marginBottom: spacing.xl }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: spacing.xs }}>
            <Text fontSize="sm" color={colors.gray[50]}>Progresso</Text>
                ...
                .map((item) => (
                  <label
                    ...
                    style={{
                      ...
                      padding: spacing.sm,
                      borderRadius: '8px',
                      backgroundColor: item.checked ? colors.semantic.successBg : colors.neutral.white,
        ...
        {allDone && (
          <Card journey="care" elevation="md" style={{ borderLeft: `4px solid ${colors.semantic.success}`, marginBottom: spacing.xl }}>
