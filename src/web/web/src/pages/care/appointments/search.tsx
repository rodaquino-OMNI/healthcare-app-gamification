...
const MOCK_DOCTORS: DoctorResult[] = [
  { id: '1', name: 'Dra. Ana Silva', specialty: 'Cardiologia', rating: 4.8, distance: '2.3 km', nextAvailable: 'Hoje, 14:00' },
  { id: '2', name: 'Dr. Carlos Santos', specialty: 'Clinico Geral', rating: 4.6, distance: '3.1 km', nextAvailable: 'Amanha, 09:00' },
  { id: '3', name: 'Dra. Maria Oliveira', specialty: 'Dermatologia', rating: 4.9, distance: '1.8 km', nextAvailable: 'Hoje, 16:30' },
];
...
const DoctorSearchPage: React.FC = () => {
  ...
  const filteredDoctors = MOCK_DOCTORS.filter((doc) => {
    ...
    const matchesSpecialty = !selectedSpecialty || doc.specialty.toLowerCase().includes(
      SPECIALTIES.find((s) => s.id === selectedSpecialty)?.label.toLowerCase() ?? ''
    );
          ...
          {SPECIALTIES.map((spec) => (
            <button
              ...
              style={{
                ...
                backgroundColor: selectedSpecialty === spec.id ? colors.journeys.care.background : 'transparent',
                color: selectedSpecialty === spec.id ? colors.journeys.care.primary : colors.journeys.care.text,
                cursor: 'pointer',
                fontSize: '14px',
              }}
          ...
          {filteredDoctors.map((doctor) => (
            ...
            >
              <Box padding="md">
                ...
                <Text fontSize="sm" fontWeight="medium" color={colors.journeys.care.primary} style={{ marginTop: spacing.sm }}>
