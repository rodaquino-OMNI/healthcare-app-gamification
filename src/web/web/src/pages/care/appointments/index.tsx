...
import {
  CareLayout,
} from 'src/web/web/src/layouts/CareLayout';
import {
  useAppointments,
} from 'src/web/web/src/hooks/useAppointments';
import {
  Appointment,
...
import {
  Box,
  Text,
} from 'src/web/design-system/src/primitives';
import {
  EmptyState,
} from 'src/web/web/src/components/shared/EmptyState';
import {
  LoadingIndicator,
} from 'src/web/web/src/components/shared/LoadingIndicator';
import {
  ErrorState,
} from 'src/web/web/src/components/shared/ErrorState';
