...
const JournalEntryPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: spacing.xl }}>
      ...
      <Card journey="health" elevation="sm" padding="md" style={{ marginBottom: spacing.lg, marginTop: spacing.md }}>
        ...
        <Box display="flex" justifyContent="flex-end" style={{ marginTop: spacing.xs }}>
          <Text fontSize="xs" color={colors.gray[40]}>{wordCount} words</Text>
        </Box>
      </Card>
          ...
          {MOOD_TAGS.map((mood) => (
            <button
              ...
              style={{
                ...
                backgroundColor: selectedMood === mood ? colors.journeys.health.background : colors.gray[0],
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        ...
        <Button variant="secondary" journey="health" onPress={() => router.push('/wellness/journal/history')} accessibilityLabel="View history">
          View History
        </Button>
      </Box>
    </div>
