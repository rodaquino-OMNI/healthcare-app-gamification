...
const CHALLENGES_DB: Record<string, ChallengeDetail> = {
    '1': {
        ...
        description:
            'Meditate for at least 10 minutes every day for 7 consecutive days. This challenge helps build a consistent meditation habit that can reduce stress and improve focus.',
        rules: [
    ...
    '2': {
        ...
        category: 'Fitness',
        description:
            'Walk at least 10,000 steps every day for 14 days. Regular walking improves cardiovascular health, boosts mood, and helps maintain a healthy weight.',
        rules: [
