...
const ChatPage: NextPage = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '80vh', maxWidth: '600px', margin: '0 auto', padding: spacing.md }}>
      {/* Header */}
      <div style={headerStyle}>
        <button onClick={() => router.push('/help')} style={backBtnStyle}>&larr;</button>
        <div>
...
const headerStyle: React.CSSProperties = {
  ...
  padding: spacing.md, backgroundColor: colors.gray[0],
  borderRadius: `${borderRadius.md} ${borderRadius.md} 0 0`,
  borderBottom: `1px solid ${colors.gray[10]}`,
};
const backBtnStyle: React.CSSProperties = {
  background: 'none', border: 'none', color: colors.brand.primary,
  fontSize: typography.fontSize['heading-md'], cursor: 'pointer', padding: spacing.xs,
};
...
const headerStatusStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-xs'], color: colors.semantic.success, fontFamily: typography.fontFamily.body,
};
...
const bubbleTextStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-sm'], lineHeight: typography.lineHeight.base,
  fontFamily: typography.fontFamily.body, margin: 0,
};
const timeStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-2xs'], display: 'block',
  marginTop: spacing['3xs'], textAlign: 'right' as const,
};
const inputAreaStyle: React.CSSProperties = {
  display: 'flex', gap: spacing.xs, padding: spacing.md,
  backgroundColor: colors.gray[0], borderTop: `1px solid ${colors.gray[10]}`,
...
const sendBtnStyle: React.CSSProperties = {
  padding: `${spacing.sm} ${spacing.md}`, color: colors.neutral.white,
  border: 'none', borderRadius: borderRadius.md, cursor: 'pointer',
  fontSize: typography.fontSize['text-sm'], fontWeight: typography.fontWeight.semiBold,
  fontFamily: typography.fontFamily.body, flexShrink: 0,
};
