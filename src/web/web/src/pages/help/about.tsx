  ...
  return (
    <div style={{ padding: spacing.xl, maxWidth: '480px', margin: '0 auto' }}>
      ...
      <div style={{ ...cardStyle, marginTop: spacing.md }}>
        ...
        <p style={creditTextStyle}>
          Desenvolvido pela equipe AUSTA Saude S.A.
        </p>
        <p style={creditTextStyle}>
          Design System: AUSTA Design System v3.0
        </p>
        <p style={creditTextStyle}>
          Tecnologias: React, Next.js, React Native, NestJS
        </p>
      </div>

      {/* Footer */}
      <p style={copyrightStyle}>
        &copy; 2024 AUSTA Saude S.A. Todos os direitos reservados.
      </p>
    </div>
  );
};
...
const logoStyle: React.CSSProperties = {
  ...
  backgroundColor: colors.brand.primary, color: colors.neutral.white,
  display: 'flex', alignItems: 'center', justifyContent: 'center',
  fontSize: typography.fontSize['heading-md'], fontWeight: typography.fontWeight.bold,
  fontFamily: typography.fontFamily.logo, margin: '0 auto', marginBottom: spacing.md,
};
const titleStyle: React.CSSProperties = {
  fontSize: typography.fontSize['heading-xl'], fontWeight: typography.fontWeight.semiBold,
  color: colors.gray[70], marginBottom: spacing['3xs'], fontFamily: typography.fontFamily.heading,
};
...
const sectionTitleStyle: React.CSSProperties = {
  fontSize: typography.fontSize['heading-xs'], fontWeight: typography.fontWeight.semiBold,
...
const legalLinkStyle: React.CSSProperties = {
  ...
  width: '100%', padding: `${spacing.sm} 0`, background: 'none', border: 'none',
  borderBottom: `1px solid ${colors.gray[10]}`, cursor: 'pointer',
  fontSize: typography.fontSize['text-sm'], color: colors.gray[70],
  fontFamily: typography.fontFamily.body, textAlign: 'left' as const,
};
const creditTextStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-sm'], color: colors.gray[50],
  marginBottom: spacing.xs, fontFamily: typography.fontFamily.body,
};
const copyrightStyle: React.CSSProperties = {
  textAlign: 'center' as const, fontSize: typography.fontSize['text-xs'],
  color: colors.gray[40], marginTop: spacing.xl, fontFamily: typography.fontFamily.body,
};
