...
const CATEGORIES: HelpCategory[] = [
  ...
  { id: 'appointments', title: 'Consultas e Agendamentos', description: 'Agendar, cancelar, telemedicina', icon: 'C', articleCount: 10 },
  { id: 'health', title: 'Saude e Metricas', description: 'Exames, medicamentos, metas', icon: 'S', articleCount: 7 },
  { id: 'gamification', title: 'Conquistas e Recompensas', description: 'XP, missoes, ranking', icon: 'G', articleCount: 5 },
  { id: 'privacy', title: 'Privacidade e LGPD', description: 'Dados pessoais, exportacao', icon: 'L', articleCount: 6 },
];
    ...
    <div style={{ padding: spacing.xl, maxWidth: '720px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: spacing['2xl'] }}>
        ...
        <div style={{ display: 'flex', gap: spacing.xs, flexWrap: 'wrap' as const }}>
          <button onClick={() => router.push('/help/contact')} style={quickLinkStyle}>Falar com Suporte</button>
          <button onClick={() => router.push('/help/chat')} style={quickLinkStyle}>Chat ao Vivo</button>
          <button onClick={() => router.push('/help/report')} style={quickLinkStyle}>Reportar Problema</button>
        </div>
      </div>
    </div>
  );
...
const categoryIconStyle: React.CSSProperties = {
  ...
  fontFamily: typography.fontFamily.heading, marginBottom: spacing.sm,
};
const categoryTitleStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-md'], fontWeight: typography.fontWeight.semiBold,
  color: colors.gray[70], margin: `0 0 ${spacing['3xs']} 0`, fontFamily: typography.fontFamily.body,
};
const categoryDescStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-xs'], color: colors.gray[40],
  margin: `0 0 ${spacing.xs} 0`, fontFamily: typography.fontFamily.body,
};
const articleCountStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-2xs'], color: colors.gray[40],
...
const quickLinkStyle: React.CSSProperties = {
  padding: `${spacing.xs} ${spacing.md}`, backgroundColor: colors.gray[0],
