  ...
  return (
    <AuthLayout>
      <ContentContainer>
        ...
        <Subtitle>
          Personalize o AUSTA para atender melhor as suas necessidades de saude.
        ...
        <PrimaryButton onClick={() => router.push('/auth/goal-selection')}>
          Comecar
        </PrimaryButton>

        <SkipLink onClick={() => router.push('/home')}>
          Pular por enquanto
        </SkipLink>
      </ContentContainer>
    </AuthLayout>
