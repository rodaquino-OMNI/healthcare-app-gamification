...
const GoalCard = styled.button<{ $selected: boolean }>`
    ...
    background-color: ${(props) => (props.$selected ? colors.gray[5] : colors.neutral.white)};
    border: 2px solid ${(props) => (props.$selected ? colors.brand.primary : colors.gray[20])};
    ...
    &:hover {
        border-color: ${(props) => (props.$selected ? colors.brand.primary : colors.gray[40])};
    }
`;
    ...
    return (
        <AuthLayout>
            <ContentContainer>
                ...
                <Subtitle>
                    Selecione os objetivos de saude que mais importam para voce. Voce pode alterar depois.
                </Subtitle>
