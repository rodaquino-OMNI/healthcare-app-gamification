  ...
  return (
    <PageContainer>
      <HeroCard>
        ...
        <Subtitle>
          Gerencie sua saude, consultas, plano e conquistas em um unico lugar.
        </Subtitle>
        <ButtonGroup>
          <PrimaryButton onClick={() => router.push(WEB_AUTH_ROUTES.LOGIN)}>
            Entrar
          </PrimaryButton>
          <SecondaryButton onClick={() => router.push(WEB_AUTH_ROUTES.REGISTER)}>
            Criar Conta
          </SecondaryButton>
        </ButtonGroup>
      </HeroCard>
