  ...
  return (
    <AuthLayout>
      <ContentContainer>
        ...
        <Subtitle>
          Suas preferencias foram salvas com sucesso. O AUSTA esta pronto para
          ajudar voce a alcancar seus objetivos.
        </Subtitle>
        ...
        <PrimaryButton onClick={() => router.push('/home')}>
          Comecar a Usar o AUSTA
        </PrimaryButton>

        <CelebrationText>
          Bem-vindo ao AUSTA SuperApp!
        </CelebrationText>
      </ContentContainer>
    </AuthLayout>
  );
