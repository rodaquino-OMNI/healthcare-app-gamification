...
export default function ForgotPasswordPage() {
    ...
    return (
      <AuthLayout>
        <SuccessCard>
          ...
          <SuccessText>
            Se uma conta com o e-mail <strong>{email}</strong> existir,
            voce recebera um link para redefinir sua senha.
          </SuccessText>
          <SubmitButton onClick={() => router.push(WEB_AUTH_ROUTES.LOGIN)}>
            Voltar ao Login
          </SubmitButton>
        </SuccessCard>
      </AuthLayout>
  ...
  return (
    <AuthLayout>
      ...
      <BackLink onClick={() => router.push(WEB_AUTH_ROUTES.LOGIN)}>
        Voltar ao Login
      </BackLink>
    </AuthLayout>
  );
