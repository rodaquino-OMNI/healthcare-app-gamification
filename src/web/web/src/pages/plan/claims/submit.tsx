...
export const ClaimForm: React.FC = () => {
    ...
    const canProceed = (): boolean => {
        switch (currentStep) {
            case 0:
                return !!formValues.procedureType;
            case 1:
                return !!formValues.provider && !!formValues.date && formValues.amount > 0;
            case 2:
                return true;
            case 3:
                return isValid;
                ...
                {currentStep === 1 && (
                    <div>
                        ...
                        <div style={{ marginBottom: spacing.md }}>
                            ...
                            {errors.provider && <span style={errorStyle}>{errors.provider.message}</span>}
                        </div>
