...
const LogoutPage: NextPage = () => {
  ...
  return (
    <div style={{
      padding: spacing.xl, maxWidth: '400px', margin: '0 auto',
...
const cardStyle: React.CSSProperties = {
  ...
  padding: spacing['2xl'], boxShadow: '0 1px 3px rgba(0,0,0,0.06)',
  width: '100%',
};
const iconStyle: React.CSSProperties = {
  width: 64, height: 64, borderRadius: '50%',
  backgroundColor: colors.semantic.warningBg, color: colors.semantic.warning,
