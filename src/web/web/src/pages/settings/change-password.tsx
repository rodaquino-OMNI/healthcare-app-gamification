...
const errorStyle: React.CSSProperties = {
  ...
  fontSize: typography.fontSize['text-sm'], fontFamily: typography.fontFamily.body,
};
const rulesStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-xs'], color: colors.gray[40],
  paddingLeft: spacing.lg, marginBottom: spacing.lg, fontFamily: typography.fontFamily.body,
};
