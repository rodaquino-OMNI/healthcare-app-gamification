  ...
  return (
    <div style={{ padding: spacing.xl, maxWidth: '600px', margin: '0 auto' }}>
      ...
      <p style={subtitleStyle}>
        Leia atentamente antes de prosseguir. Esta acao e irreversivel.
      </p>
      ...
      <div style={dangerCardStyle}>
        ...
        <ul style={{ paddingLeft: spacing.lg, margin: 0 }}>
          {consequences.map((c, i) => (
            <li key={i} style={consequenceStyle}>{c}</li>
          ))}
        </ul>
      </div>
...
const dangerCardStyle: React.CSSProperties = {
  ...cardStyle, borderLeft: `4px solid ${colors.semantic.error}`,
};
const sectionTitleStyle: React.CSSProperties = {
  fontSize: typography.fontSize['heading-sm'], fontWeight: typography.fontWeight.semiBold,
  marginBottom: spacing.md, fontFamily: typography.fontFamily.heading,
};
const consequenceStyle: React.CSSProperties = {
  fontSize: typography.fontSize['text-sm'], color: colors.gray[60],
  marginBottom: spacing.xs, fontFamily: typography.fontFamily.body, lineHeight: typography.lineHeight.base,
};
...
const checkLabelStyle: React.CSSProperties = {
  display: 'flex', alignItems: 'center', marginTop: spacing.lg,
  fontSize: typography.fontSize['text-sm'], color: colors.gray[60],
  fontFamily: typography.fontFamily.body, cursor: 'pointer',
};
const dangerButtonStyle: React.CSSProperties = {
  width: '100%', padding: spacing.sm, backgroundColor: colors.semantic.error,
