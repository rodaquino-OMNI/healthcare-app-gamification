    ...
    <div style={{ padding: spacing.xl, maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={cardStyle}>
        <div style={fieldGroup}>
          ...
          <input type="text" value={name} onChange={(e) => setName(e.target.value)} style={inputStyle} placeholder="Nome do dependente" />
        </div>

        <div style={fieldGroup}>
          <label style={labelStyle}>CPF *</label>
          <input type="text" value={cpf} onChange={(e) => setCpf(e.target.value)} style={inputStyle} placeholder="000.000.000-00" />
        </div>
...
const selectStyle: React.CSSProperties = {
  ...inputStyle, backgroundColor: colors.gray[0],
};
