...
const BiometricPage: NextPage = () => {
    ...
    const toggleItems = [
        {
            label: 'Face ID',
            desc: 'Use reconhecimento facial para autenticar',
            value: faceId,
            toggle: () => setFaceId(!faceId),
        },
        {
            label: 'Impressao Digital',
            desc: 'Use sua digital para autenticar',
            value: fingerprint,
            toggle: () => setFingerprint(!fingerprint),
        },
        {
            label: 'Login Biometrico',
            desc: 'Usar biometria ao fazer login no app',
            value: loginBiometric,
            toggle: () => setLoginBiometric(!loginBiometric),
        },
        {
            label: 'Confirmar Transacoes',
            desc: 'Exigir biometria para confirmar agendamentos',
            value: transactionBiometric,
            toggle: () => setTransactionBiometric(!transactionBiometric),
        },
    ];
        ...
        <div style={{ padding: spacing.xl, maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={infoBoxStyle}>
                <p style={{ fontSize: typography.fontSize['text-xs'], color: colors.gray[50], margin: 0 }}>
                    A biometria e armazenada de forma segura no seu dispositivo. A AUSTA nao tem acesso aos seus dados
                    biometricos.
                </p>
            </div>
        </div>
