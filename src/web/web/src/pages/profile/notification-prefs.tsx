  ...
  return (
    <AuthLayout>
      <ContentContainer>
        ...
        <Description>
          Escolha quais notificacoes voce deseja receber. Voce pode alterar
          essas preferencias a qualquer momento nas configuracoes.
        </Description>
        ...
        <InfoText>
          Voce pode alterar suas preferencias a qualquer momento em Configuracoes.
        </InfoText>
      </ContentContainer>
    </AuthLayout>
  );
