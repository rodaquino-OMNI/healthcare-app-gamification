  ...
  return (
    <AuthLayout>
      <ContentContainer>
        ...
        <Subtitle>
          Ative a autenticacao biometrica para acessar sua conta de forma rapida
          e segura.
        </Subtitle>
        ...
        <SecurityNote>
          Seus dados biometricos sao armazenados de forma segura no seu
          dispositivo e nunca sao compartilhados com terceiros.
        </SecurityNote>
      </ContentContainer>
    </AuthLayout>
  );
