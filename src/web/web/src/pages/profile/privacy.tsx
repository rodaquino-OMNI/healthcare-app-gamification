    ...
    <MainLayout>
      <PageContainer>
        ...
        <Section>
          ...
          <SectionDescription>
            Controle como seus dados sao compartilhados com terceiros. Seus dados
            de saude sao protegidos conforme a LGPD e regulamentacoes de saude.
          </SectionDescription>
          {settings.filter(s => ['share_health_data', 'analytics', 'location'].includes(s.key)).map(setting => (
        ...
        <Section>
          ...
          {settings.filter(s => s.key === 'biometric').map(setting => (
            <ToggleRow key={setting.key}>
              <div>
                <ToggleLabel>{setting.label}</ToggleLabel>
                <ToggleDescription>{setting.description}</ToggleDescription>
        ...
        <Section>
          ...
          <SectionDescription>
            Voce tem o direito de acessar, exportar ou excluir seus dados pessoais
            a qualquer momento.
          </SectionDescription>
          <LinkButton onClick={handleExportData}>
            Exportar Meus Dados
          </LinkButton>
        </Section>
