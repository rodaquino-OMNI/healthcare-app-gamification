...
const getValidationMessages = (
    ...
    required: string;
    email: string;
    password: { min: string; uppercase: string; lowercase: string; number: string; special: string };
    match: string;
    date: { required: string; future: string };
    amount: { required: string; positive: string };
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type, @typescript-eslint/explicit-module-boundary-types -- Zod schema return type is excessively verbose
