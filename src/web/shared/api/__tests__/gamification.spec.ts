...
describe('getGameProfile', () => {
  ...
  it('should throw a user-friendly error on network failure', async () => {
    ...
    await expect(getGameProfile('u1')).rejects.toThrow(
      'Failed to retrieve game profile. Please try again later.',
    );
  });
...
describe('getUserQuests', () => {
  ...
  it('should throw a user-friendly error on failure', async () => {
    ...
    await expect(getUserQuests('u1')).rejects.toThrow(
      'Failed to retrieve quests. Please try again later.',
    );
  });
});
...
describe('getUserRewards', () => {
  ...
  it('should throw a user-friendly error on failure', async () => {
    ...
    await expect(getUserRewards('u1')).rejects.toThrow(
      'Failed to retrieve rewards. Please try again later.',
    );
  });
});
...
describe('submitGamificationEvent', () => {
  ...
  it('should throw a user-friendly error on failure', async () => {
    ...
    await expect(
      submitGamificationEvent('u1', 'test', {}),
    ).rejects.toThrow(
