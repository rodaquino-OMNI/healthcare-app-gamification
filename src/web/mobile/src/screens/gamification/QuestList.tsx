...
const QuestList: React.FC = () => {
    ...
    const renderSummaryCard = (): React.ReactElement | null => (
        <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryRow}>
                ...
                <View style={styles.summaryItem}>
                    <Text style={[styles.summaryValue, { color: colors.journeys.health.primary }]}>{stats.active}</Text>
                    <Text style={styles.summaryLabel}>{t('gamification.quests.summaryActive')}</Text>
                </View>
                <View style={styles.summaryDivider} />
                <View style={styles.summaryItem}>
                    <Text style={[styles.summaryValue, { color: colors.semantic.success }]}>{stats.completed}</Text>
    ...
    const renderQuestItem = ({ item }: { item: CategorizedQuest }): React.ReactElement | null => (
