...
const MOCK_REWARDS: Reward[] = [
    {
        ...
        description: 'Get priority access when booking your next appointment within 30 days.',
        journey: 'care',
        icon: '\u{1F4C5}',
        xp: 500,
    },
    {
        id: 'r-002',
        title: 'Health Report',
        description: 'Detailed monthly health insights report with personalized analysis of vitals and trends.',
        journey: 'health',
        icon: '\u{1F4CA}',
        xp: 300,
    },
    {
        id: 'r-003',
        title: 'Plan Upgrade',
        description: 'One month of premium plan features including extended telehealth and priority support.',
        journey: 'plan',
        icon: '\u{1F31F}',
        xp: 1000,
    },
    {
        id: 'r-004',
        title: 'Wellness Kit',
        description: 'Curated digital wellness pack with meditations, exercise plans, and nutrition guides.',
        journey: 'health',
        icon: '\u{1F381}',
        xp: 750,
    },
    {
        ...
        description: 'Credit toward your next telemedicine consultation with any AUSTA network specialist.',
        journey: 'care',
        icon: '\u{1F4F1}',
        xp: 600,
    },
    {
        ...
        description: 'Percentage discount on your next copayment based on your plan tier.',
        journey: 'plan',
        icon: '\u{1F4B0}',
        xp: 800,
    },
    {
        id: 'r-007',
        title: 'Fitness Badge',
        description: 'Exclusive digital fitness badge displayed on your profile.',
        journey: 'health',
        icon: '\u{1F3C5}',
        xp: 150,
    },
    {
        id: 'r-008',
        title: 'Care Package',
        description: 'Personalized care recommendations based on your health history and goals.',
        journey: 'care',
        icon: '\u{1F49D}',
        xp: 400,
    },
...
const RewardDetail: React.FC = () => {
    ...
    const reward = useMemo(() => MOCK_REWARDS.find((r) => r.id === rewardId), [rewardId]);

    const relatedRewards = useMemo(() => {
        if (!reward) {
            return [];
        }
        return MOCK_REWARDS.filter((r) => r.journey === reward.journey && r.id !== reward.id).slice(0, 4);
    }, [reward]);
    ...
    const renderRelatedItem = ({ item }: { item: Reward }): React.ReactElement | null => {
        ...
        return (
            ...
            >
                ...
                <Text style={[styles.relatedXP, { color: relColor }]}>{item.xp} XP</Text>
            </TouchableOpacity>
        );
    };
            ...
            >
                ...
                <View style={styles.journeyBadge}>
                    ...
                    <Text style={[styles.journeyLabel, { color: journeyColor }]}>
                        {t('gamification.rewardDetail.journeyLabel', {
                            journey: reward.journey.charAt(0).toUpperCase() + reward.journey.slice(1),
                        })}
                    </Text>
                </View>
                ...
                <TouchableOpacity
                    ...
                    accessibilityLabel={
                        showTerms
                            ? t('gamification.rewardDetail.collapseTerms')
                            : t('gamification.rewardDetail.expandTerms')
                    }
                >
                ...
                <TouchableOpacity
                    ...
                    style={[
                        styles.claimButton,
                        canAfford ? { backgroundColor: journeyColor } : { backgroundColor: colors.neutral.gray400 },
                    ]}
                    disabled={!canAfford}
                    accessibilityLabel={
                        canAfford
                            ? t('gamification.rewardDetail.claimAccessibility', { title: reward.title, xp: reward.xp })
                            : t('gamification.rewardDetail.notEnoughXPLabel')
                    }
                >
                    <Text style={styles.claimButtonText}>
                        {canAfford
                            ? t('gamification.rewardDetail.claimFor', { xp: reward.xp })
                            : t('gamification.rewardDetail.notEnoughXP')}
                    </Text>
                </TouchableOpacity>
...
const createStyles = (theme: Theme) => {
    ...
    return StyleSheet.create({
        ...
        termsContent: {
            backgroundColor: theme.colors.background.default,
            borderBottomLeftRadius: borderRadiusValues.lg,
            borderBottomRightRadius: borderRadiusValues.lg,
            paddingHorizontal: spacingValues.md,
