...
const MOCK_ENTRIES: LeaderboardEntry[] = [
  { id: 'u1', rank: 1, username: 'Maria Silva', avatarInitials: 'MS', xp: 12450, level: 15, badgeCount: 24, journey: 'health', isCurrentUser: false },
  { id: 'u2', rank: 2, username: 'Joao Santos', avatarInitials: 'JS', xp: 11200, level: 14, badgeCount: 21, journey: 'care', isCurrentUser: false },
  { id: 'u3', rank: 3, username: 'Ana Oliveira', avatarInitials: 'AO', xp: 10800, level: 13, badgeCount: 19, journey: 'health', isCurrentUser: false },
  { id: 'u4', rank: 4, username: 'Carlos Souza', avatarInitials: 'CS', xp: 9750, level: 12, badgeCount: 17, journey: 'plan', isCurrentUser: false },
  { id: 'u5', rank: 5, username: 'Lucia Pereira', avatarInitials: 'LP', xp: 9100, level: 11, badgeCount: 15, journey: 'health', isCurrentUser: false },
  { id: 'u6', rank: 6, username: 'Pedro Costa', avatarInitials: 'PC', xp: 8500, level: 10, badgeCount: 14, journey: 'care', isCurrentUser: false },
  { id: 'u7', rank: 7, username: 'Voce', avatarInitials: 'EU', xp: 7800, level: 9, badgeCount: 12, journey: 'health', isCurrentUser: true },
  { id: 'u8', rank: 8, username: 'Fernanda Lima', avatarInitials: 'FL', xp: 7200, level: 9, badgeCount: 11, journey: 'plan', isCurrentUser: false },
  { id: 'u9', rank: 9, username: 'Rafael Mendes', avatarInitials: 'RM', xp: 6900, level: 8, badgeCount: 10, journey: 'care', isCurrentUser: false },
  { id: 'u10', rank: 10, username: 'Beatriz Alves', avatarInitials: 'BA', xp: 6400, level: 8, badgeCount: 9, journey: 'health', isCurrentUser: false },
  { id: 'u11', rank: 11, username: 'Diego Rocha', avatarInitials: 'DR', xp: 5800, level: 7, badgeCount: 8, journey: 'plan', isCurrentUser: false },
  { id: 'u12', rank: 12, username: 'Camila Dias', avatarInitials: 'CD', xp: 5200, level: 7, badgeCount: 7, journey: 'care', isCurrentUser: false },
  { id: 'u13', rank: 13, username: 'Thiago Nunes', avatarInitials: 'TN', xp: 4600, level: 6, badgeCount: 6, journey: 'health', isCurrentUser: false },
  { id: 'u14', rank: 14, username: 'Juliana Ribeiro', avatarInitials: 'JR', xp: 4100, level: 5, badgeCount: 5, journey: 'plan', isCurrentUser: false },
  { id: 'u15', rank: 15, username: 'Bruno Martins', avatarInitials: 'BM', xp: 3500, level: 5, badgeCount: 4, journey: 'care', isCurrentUser: false },
];
...
const LeaderboardScreen: React.FC = () => {
  ...
  const renderPodiumItem = (entry: LeaderboardEntry, position: number) => {
