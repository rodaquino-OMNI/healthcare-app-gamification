...
const AchievementDetailScreen: React.FC = () => {
  ...
  const achievement = useMemo(() => {
    if (!achievements || !achievementId) return undefined;
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={[styles.journeyBadge, { backgroundColor: journeyBg }]}>
          ...
          <Text style={[styles.journeyBadgeText, { color: journeyColor }]}>
            {journeyLabel}
          </Text>
        </View>
          ...
          {requirements.map((req) => (
            <View key={req.id} style={styles.requirementRow}>
              <View
                style={[
                  styles.checkCircle,
                  req.completed && { backgroundColor: colors.semantic.success, borderColor: colors.semantic.success },
                ]}
              >
                {req.completed && (
              ...
              <Text
                style={[
                  ...
                  req.completed && styles.requirementLabelDone,
                ]}
              >
                {req.label}
              </Text>
...
const createStyles = (theme: Theme) => StyleSheet.create({
  ...
  scrollContent: { alignItems: 'center', paddingHorizontal: spacingValues.xl, paddingBottom: spacingValues['4xl'] },
  iconContainer: { width: 96, height: 96, borderRadius: 48, borderWidth: 3, justifyContent: 'center', alignItems: 'center', marginTop: spacingValues['2xl'], marginBottom: spacingValues.md },
