...
const MOCK_QUESTS: Quest[] = [
    {
        ...
        description:
            'Log your vitals before 9 AM every morning. Consistent records help your doctor understand trends and provide useful daily health insights.',
        journey: 'health',
        icon: '\u{1F3AF}',
        progress: 1,
        total: 1,
    ...
    },
    {
        ...
        description: 'Drink 8 glasses of water today to stay properly hydrated and improve energy levels.',
        journey: 'health',
        icon: '\u{1F4A7}',
        progress: 5,
        total: 8,
    ...
    },
    {
        ...
        description: 'Take all prescribed medications on time. Consistent adherence is crucial for treatment outcomes.',
        journey: 'care',
        icon: '\u{1F48A}',
        progress: 2,
        total: 3,
    ...
    },
    {
        id: 'q-004',
        title: 'Step Master',
        description: 'Walk 50,000 steps this week. Regular walking improves cardiovascular health and boosts mood.',
        journey: 'health',
        icon: '\u{1F6B6}',
        progress: 32000,
        total: 50000,
    ...
    },
    {
        id: 'q-006',
        title: 'Plan Review',
        description: 'Review your insurance coverage details to maximize savings and access care efficiently.',
        journey: 'plan',
        icon: '\u{1F4CB}',
        progress: 0,
        total: 1,
    ...
    },
    {
        id: 'q-007',
        title: 'Care Champion',
        description: 'Schedule and attend 3 appointments this month for preventive care.',
        journey: 'care',
        icon: '\u{1F3C6}',
        progress: 1,
        total: 3,
    ...
    },
    {
        ...
        description: 'Connect 2 health devices to the app for comprehensive tracking and insights.',
        journey: 'health',
        icon: '\u{1F4F1}',
        progress: 2,
        total: 2,
    ...
    },
    {
        ...
        description: 'Use 3 different plan benefits this month to get the most value from your coverage.',
        journey: 'plan',
        icon: '\u{2B50}',
        progress: 3,
        total: 3,
...
const getTimeRemainingKey = (quest: Quest): { key: string; params?: Record<string, unknown> } => {
    if (quest.completed) {
        return { key: 'gamification.questDetail.timeCompleted' };
    }
    if (quest.progress === 0) {
        return { key: 'gamification.questDetail.timeNoDeadline' };
    }
...
const QuestDetail: React.FC = () => {
    ...
    const handleAction = useCallback(() => {
        if (quest.completed) {
            Alert.alert(
                t('gamification.questDetail.rewardClaimedTitle'),
                t('gamification.questDetail.rewardClaimedMessage', { xp: rewardXP })
            );
        } else {
            Alert.alert(
                t('gamification.questDetail.questUpdatedTitle'),
                quest.progress > 0
                    ? t('gamification.questDetail.questInProgress')
                    : t('gamification.questDetail.questStarted')
            );
        }
    }, [quest, rewardXP]);
    ...
    const getActionLabel = (): string => {
        if (quest.completed) {
            return t('gamification.questDetail.claimReward');
        }
        if (quest.progress > 0) {
            return t('gamification.questDetail.continue');
        }
            ...
            >
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.progressDetails}>
                        ...
                        <Text style={[styles.progressPercent, { color: journeyColor }]}>{progressPercent}%</Text>
                    </View>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    {requirements.map((req) => (
                        <View key={req.id} style={styles.requirementRow}>
                            ...
                            <Text style={[styles.requirementLabel, req.completed && styles.requirementCompleted]}>
                                {req.label}
                            </Text>
                        </View>
                    ))}
