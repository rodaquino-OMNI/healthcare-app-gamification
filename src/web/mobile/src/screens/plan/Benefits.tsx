                ...
                <View style={styles.filterContainer}>
                    ...
                    >
                        {BENEFIT_CATEGORIES.map((cat) => (
                            ...
                            >
                                <Text
                                    style={[styles.filterTabText, activeFilter === cat && styles.filterTabTextActive]}
                                >
                                    {cat}
                                </Text>
                            </TouchableOpacity>
                        ...
                        <View style={styles.benefitContent}>
                            ...
                            {item.limitations && (
                                <View style={styles.benefitDetailRow}>
                                    <Text style={styles.benefitDetailLabel}>
                                        {t('journeys.plan.benefits.limitations')}:{' '}
                                    </Text>
                                    <Text style={styles.benefitDetailValue}>{item.limitations}</Text>
                                </View>
                            )}
                            {item.usage && (
                                <View style={styles.benefitDetailRow}>
