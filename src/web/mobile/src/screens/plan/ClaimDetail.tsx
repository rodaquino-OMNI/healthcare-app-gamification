    ...
    if (!claim) {
        return (
            <View style={styles.centeredContainer}>
                ...
                <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('ClaimHistory')}>
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.headerCard}>
                <View style={styles.headerRow}>
                    <Text testID="plan-claim-detail-title" style={styles.typeLabel}>
                        {TYPE_LABELS[claim.type] || claim.type}
                    </Text>
                    <View
                        testID="plan-claim-detail-status"
                        style={[styles.statusBadge, { backgroundColor: statusConfig.bg }]}
                    >
                        <Text style={[styles.statusBadgeText, { color: statusConfig.text }]}>{statusConfig.label}</Text>
                    </View>
                </View>
                <Text style={styles.amountValue}>R$ {claim.amount.toFixed(2).replace('.', ',')}</Text>
