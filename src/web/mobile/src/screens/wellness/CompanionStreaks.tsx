...
const MOCK_MILESTONES: Milestone[] = [
    {
        id: 'ms-1',
        days: 7,
        labelKey: 'journeys.health.wellness.streaks.milestones.week',
        icon: '\u{1F31F}',
        unlocked: true,
    },
    {
        id: 'ms-2',
        days: 14,
        labelKey: 'journeys.health.wellness.streaks.milestones.twoWeeks',
        icon: '\u{2B50}',
        unlocked: true,
    },
    {
        id: 'ms-3',
        days: 30,
        labelKey: 'journeys.health.wellness.streaks.milestones.month',
        icon: '\u{1F3C5}',
        unlocked: false,
    },
    {
        id: 'ms-4',
        days: 60,
        labelKey: 'journeys.health.wellness.streaks.milestones.twoMonths',
        icon: '\u{1F947}',
        unlocked: false,
    },
    {
        id: 'ms-5',
        days: 90,
        labelKey: 'journeys.health.wellness.streaks.milestones.quarter',
        icon: '\u{1F3C6}',
        unlocked: false,
    },
    {
        id: 'ms-6',
        days: 365,
        labelKey: 'journeys.health.wellness.streaks.milestones.year',
        icon: '\u{1F451}',
        unlocked: false,
    },
];
...
const MOCK_REWARDS: Reward[] = [
    {
        id: 'rw-1',
        titleKey: 'journeys.health.wellness.streaks.rewards.weekStreak',
        descriptionKey: 'journeys.health.wellness.streaks.rewards.weekStreakDesc',
        icon: '\u{1F381}',
        earnedDate: '2026-02-01',
    },
    {
        id: 'rw-2',
        titleKey: 'journeys.health.wellness.streaks.rewards.twoWeekStreak',
        descriptionKey: 'journeys.health.wellness.streaks.rewards.twoWeekStreakDesc',
        icon: '\u{1F389}',
        earnedDate: '2026-02-08',
    },
    {
        id: 'rw-3',
        titleKey: 'journeys.health.wellness.streaks.rewards.consistencyBadge',
        descriptionKey: 'journeys.health.wellness.streaks.rewards.consistencyBadgeDesc',
        icon: '\u{1F396}',
...
export const CompanionStreaksScreen: React.FC = () => {
    ...
    const renderMilestone = (milestone: Milestone): React.ReactElement | null => (
        <View
            key={milestone.id}
    ...
    const renderReward = ({ item }: { item: Reward }): React.ReactElement | null => (
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-streaks-screen">
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.streaks.title')}</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.streakCounter}>
                    ...
                    <Text style={styles.streakLabel}>{t('journeys.health.wellness.streaks.currentStreak')}</Text>
                ...
                <View style={styles.heatMapCard}>
                    <Text style={styles.sectionTitle}>{t('journeys.health.wellness.streaks.activityMap')}</Text>
                        ...
                        {heatMapData.map((day) => (
                            <View
                                ...
                                style={[
                                    ...
                                    {
                                        backgroundColor:
                                            day.level > 0 ? ACTIVITY_COLORS[day.level] : theme.colors.border.default,
                                    },
                                ]}
                    ...
                    <View style={styles.legendRow}>
                        <Text style={styles.legendLabel}>{t('journeys.health.wellness.streaks.less')}</Text>
                        {([0, 1, 2, 3] as ActivityLevel[]).map((level) => (
                            <View
                                ...
                                style={[
                                    ...
                                    {
                                        backgroundColor:
                                            level > 0 ? ACTIVITY_COLORS[level] : theme.colors.border.default,
                                    },
                                ]}
                            />
                        ))}
                        <Text style={styles.legendLabel}>{t('journeys.health.wellness.streaks.more')}</Text>
                    </View>
                </View>

                {/* Milestones */}
                <Text style={styles.sectionTitle}>{t('journeys.health.wellness.streaks.milestonesTitle')}</Text>
                <ScrollView
                    horizontal
                ...
                {/* Rewards Earned */}
                <Text style={styles.sectionTitle}>{t('journeys.health.wellness.streaks.rewardsTitle')}</Text>
                <FlatList
                    data={MOCK_REWARDS}
                ...
                >
                    <Text style={styles.shareButtonText}>{t('journeys.health.wellness.streaks.share')}</Text>
                </TouchableOpacity>
            </ScrollView>
        </SafeAreaView>
    );
