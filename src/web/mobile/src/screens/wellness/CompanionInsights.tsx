...
const MOCK_METRICS: MetricCard[] = [
  { id: 'm-1', labelKey: 'journeys.health.wellness.insights.moodTrend', value: '7.2', trend: 'up', icon: '\u{1F60A}' },
  { id: 'm-2', labelKey: 'journeys.health.wellness.insights.activityScore', value: '85%', trend: 'up', icon: '\u{1F3C3}' },
  { id: 'm-3', labelKey: 'journeys.health.wellness.insights.sleepQuality', value: '6.8', trend: 'down', icon: '\u{1F634}' },
  { id: 'm-4', labelKey: 'journeys.health.wellness.insights.stressLevel', value: '3.1', trend: 'stable', icon: '\u{1F9D8}' },
];

const MOCK_INSIGHTS: InsightItem[] = [
  { id: 'i-1', titleKey: 'journeys.health.wellness.insights.moodImproved', descriptionKey: 'journeys.health.wellness.insights.moodImprovedDesc', icon: '\u{2B06}' },
  { id: 'i-2', titleKey: 'journeys.health.wellness.insights.sleepPatterns', descriptionKey: 'journeys.health.wellness.insights.sleepPatternsDesc', icon: '\u{1F319}' },
  { id: 'i-3', titleKey: 'journeys.health.wellness.insights.activityGoal', descriptionKey: 'journeys.health.wellness.insights.activityGoalDesc', icon: '\u{1F3AF}' },
];
    ...
    <SafeAreaView style={styles.container} testID="wellness-insights-screen">
      ...
      <View style={styles.headerBar}>
        ...
        <Text style={styles.screenTitle}>
          {t('journeys.health.wellness.insights.title')}
        </Text>
      ...
      >
          ...
          {MOCK_METRICS.map((metric) => (
            <View key={metric.id} style={styles.metricCard}>
              ...
              <Text
                style={[
                  styles.metricTrend,
                  { color: metric.trend === 'up' ? colors.semantic.success : metric.trend === 'down' ? colors.semantic.error : colors.semantic.info },
                ]}
              >
        ...
        <View style={styles.chartCard}>
          <Text style={styles.chartTitle}>
            {t('journeys.health.wellness.insights.moodOverTime')}
          </Text>
        ...
        <Text style={styles.sectionTitle}>
          {t('journeys.health.wellness.insights.aiSummary')}
        </Text>
        ...
        >
          <Text style={styles.ctaText}>
            {t('journeys.health.wellness.insights.viewGoals')}
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
