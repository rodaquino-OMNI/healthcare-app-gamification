...
const MOCK_REPLIES: QuickReply[] = [
    {
        id: 'qr-001',
        labelKey: 'journeys.health.wellness.quickReplies.feelingGreat',
        icon: '\u{1F60A}',
        category: 'mood',
    },
    {
        id: 'qr-002',
        labelKey: 'journeys.health.wellness.quickReplies.feelingAnxious',
        icon: '\u{1F630}',
        category: 'mood',
    },
    {
        id: 'qr-003',
        labelKey: 'journeys.health.wellness.quickReplies.feelingTired',
        icon: '\u{1F634}',
        category: 'mood',
    },
    {
        id: 'qr-004',
        labelKey: 'journeys.health.wellness.quickReplies.feelingStressed',
        icon: '\u{1F625}',
        category: 'mood',
    },
    ...
    {
        id: 'qr-006',
        labelKey: 'journeys.health.wellness.quickReplies.sleepIssues',
        icon: '\u{1F62B}',
        category: 'health',
    },
    ...
    {
        id: 'qr-008',
        labelKey: 'journeys.health.wellness.quickReplies.suggestWorkout',
        icon: '\u{1F3CB}',
        category: 'activity',
    },
    {
        id: 'qr-009',
        labelKey: 'journeys.health.wellness.quickReplies.suggestYoga',
        icon: '\u{1F9D8}',
        category: 'activity',
    },
    {
        id: 'qr-010',
        labelKey: 'journeys.health.wellness.quickReplies.suggestWalk',
        icon: '\u{1F6B6}',
        category: 'activity',
    },
    {
        id: 'qr-011',
        labelKey: 'journeys.health.wellness.quickReplies.mealIdeas',
        icon: '\u{1F957}',
        category: 'nutrition',
    },
    {
        id: 'qr-012',
        labelKey: 'journeys.health.wellness.quickReplies.hydrationTip',
        icon: '\u{1F4A7}',
        category: 'nutrition',
    },
    {
        id: 'qr-013',
        labelKey: 'journeys.health.wellness.quickReplies.snackSuggestion',
        icon: '\u{1F34E}',
        category: 'nutrition',
    },
];
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-quick-replies-screen">
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.quickReplies.screenTitle')}</Text>
                <View style={styles.headerSpacer} />
            </View>

            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <Text style={styles.description}>{t('journeys.health.wellness.quickReplies.description')}</Text>
