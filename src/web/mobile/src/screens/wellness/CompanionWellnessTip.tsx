...
export const CompanionWellnessTipScreen: React.FC = () => {
    ...
    const handleRelatedTipPress = (relatedTipId: string): void => {
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-tip-detail-screen">
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.tipDetail.screenTitle')}</Text>
                <TouchableOpacity
                    onPress={handleShare}
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                {/* Related Tips */}
                <Text style={styles.relatedTitle}>{t('journeys.health.wellness.tipDetail.relatedTips')}</Text>
