...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, SectionList, ScrollView } from 'react-native';
...
const MOCK_CHALLENGES: WellnessChallenge[] = [
    {
        id: 'ch-1',
        titleKey: 'journeys.health.wellness.challenges.items.walkChallenge',
        descriptionKey: 'journeys.health.wellness.challenges.items.walkChallengeDesc',
        icon: '\u{1F6B6}',
        progress: 35000,
        target: 70000,
        rewardPoints: 500,
    ...
    {
        id: 'ch-2',
        titleKey: 'journeys.health.wellness.challenges.items.meditationStreak',
        descriptionKey: 'journeys.health.wellness.challenges.items.meditationStreakDesc',
        icon: '\u{1F9D8}',
        progress: 5,
        target: 7,
        rewardPoints: 300,
    ...
    {
        id: 'ch-3',
        titleKey: 'journeys.health.wellness.challenges.items.hydrationWeek',
        descriptionKey: 'journeys.health.wellness.challenges.items.hydrationWeekDesc',
        icon: '\u{1F4A7}',
        progress: 40,
        target: 56,
        rewardPoints: 250,
    ...
    {
        id: 'ch-4',
        titleKey: 'journeys.health.wellness.challenges.items.sleepChallenge',
        descriptionKey: 'journeys.health.wellness.challenges.items.sleepChallengeDesc',
        icon: '\u{1F634}',
        progress: 0,
        target: 30,
        rewardPoints: 750,
    ...
    {
        id: 'ch-5',
        titleKey: 'journeys.health.wellness.challenges.items.nutritionQuest',
        descriptionKey: 'journeys.health.wellness.challenges.items.nutritionQuestDesc',
        icon: '\u{1F957}',
        progress: 0,
        target: 21,
        rewardPoints: 400,
    ...
    {
        id: 'ch-6',
        titleKey: 'journeys.health.wellness.challenges.items.breathingMaster',
        descriptionKey: 'journeys.health.wellness.challenges.items.breathingMasterDesc',
        icon: '\u{1F32C}',
        progress: 10,
        target: 10,
        rewardPoints: 200,
    ...
    {
        id: 'ch-7',
        titleKey: 'journeys.health.wellness.challenges.items.journalHabit',
        descriptionKey: 'journeys.health.wellness.challenges.items.journalHabitDesc',
        icon: '\u{1F4D3}',
        progress: 14,
        target: 14,
        rewardPoints: 350,
...
export const CompanionChallengesScreen: React.FC = () => {
    ...
    const renderChallengeCard = ({ item }: { item: WellnessChallenge }): React.ReactElement | null => {
    ...
    const renderSectionHeader = ({ section }: { section: { title: string } }): React.ReactElement | null => (
    ...
    const renderEmptyState = (): React.ReactElement | null => (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>{t('journeys.health.wellness.challenges.emptyTitle')}</Text>
            <Text style={styles.emptySubtitle}>{t(`journeys.health.wellness.challenges.empty.${activeTab}`)}</Text>
        </View>
    );
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-challenges-screen">
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.challenges.title')}</Text>
