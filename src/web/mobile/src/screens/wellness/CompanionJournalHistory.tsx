...
const MOCK_ENTRIES: JournalEntry[] = [
  { id: 'j-1', date: '2026-02-23', mood: 'happy', previewText: 'Today was a wonderful day. I managed to complete my morning meditation and felt very focused throughout the day...', wordCount: 156 },
  { id: 'j-2', date: '2026-02-22', mood: 'calm', previewText: 'Practiced deep breathing exercises in the afternoon. Feeling much more centered and at peace with myself...', wordCount: 89 },
  { id: 'j-3', date: '2026-02-21', mood: 'anxious', previewText: 'Had a stressful meeting but managed to use my coping techniques. The wellness breathing exercise helped...', wordCount: 203 },
  { id: 'j-4', date: '2026-02-20', mood: 'energetic', previewText: 'Great workout this morning! Hit my step goal before noon and ate well all day. Feeling accomplished...', wordCount: 112 },
  { id: 'j-5', date: '2026-02-19', mood: 'grateful', previewText: 'Thankful for my health journey progress. My sleep quality has improved significantly over the past week...', wordCount: 178 },
  { id: 'j-6', date: '2026-02-18', mood: 'tired', previewText: 'Did not sleep well last night. Going to try the sleep hygiene routine the wellness companion suggested...', wordCount: 95 },
  { id: 'j-7', date: '2026-02-17', mood: 'happy', previewText: 'Reached my weekly meditation goal! The companion AI suggested trying a longer session tomorrow...', wordCount: 134 },
];
...
export const CompanionJournalHistoryScreen: React.FC = () => {
  ...
  const filteredEntries = moodFilter === 'all'
    ? MOCK_ENTRIES
    : MOCK_ENTRIES.filter((e) => e.mood === moodFilter);
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyTitle}>
        {t('journeys.health.wellness.journalHistory.emptyTitle')}
      </Text>
      <Text style={styles.emptySubtitle}>
        {t('journeys.health.wellness.journalHistory.emptySubtitle')}
      </Text>
    </View>
  );
    ...
    <SafeAreaView style={styles.container} testID="wellness-journal-history-screen">
      ...
      <View style={styles.headerBar}>
        ...
        <Text style={styles.screenTitle}>
          {t('journeys.health.wellness.journalHistory.title')}
        </Text>
            ...
            >
              {option.key !== 'all' && (
                <Text style={styles.filterIcon}>
                  {MOOD_ICONS[option.key as MoodType]}
                </Text>
              )}
