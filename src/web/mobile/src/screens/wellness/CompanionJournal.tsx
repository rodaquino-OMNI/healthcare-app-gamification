    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-journal-screen">
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.journal.title')}</Text>
            ...
            >
                ...
                {/* Mood Tag Selector */}
                <Text style={styles.sectionLabel}>{t('journeys.health.wellness.journal.howFeeling')}</Text>
                ...
                {/* Journal Text Input */}
                <Text style={styles.sectionLabel}>{t('journeys.health.wellness.journal.writeHere')}</Text>
