    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-challenge-detail-screen">
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.challengeDetail.title')}</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.statsRow}>
                    <View style={styles.statItem}>
                        ...
                        <Text style={styles.statLabel}>{t('journeys.health.wellness.challengeDetail.duration')}</Text>
                    </View>
                    <View style={styles.statDivider} />
                    <View style={styles.statItem}>
                        <Text style={[styles.statValue, { color: colors.semantic.warning }]}>{challenge.daysLeft}</Text>
                        <Text style={styles.statLabel}>{t('journeys.health.wellness.challengeDetail.remaining')}</Text>
                    </View>
                    <View style={styles.statDivider} />
                    <View style={styles.statItem}>
                        ...
                        <Text style={styles.statLabel}>{t('journeys.health.wellness.challengeDetail.reward')}</Text>
                    </View>
                </View>
                    ...
                    {challenge.participants.map((participant) => (
                        <View key={participant.id} style={styles.participantRow}>
                            ...
                            <View style={styles.participantBarBg}>
                                <View style={[styles.participantBarFill, { width: `${participant.progress}%` }]} />
                            </View>
