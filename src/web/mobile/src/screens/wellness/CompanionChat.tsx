  ...
  const renderAvatar = () => (
    <View style={styles.avatarSection}>
      ...
      <Text style={styles.greeting}>
        {t('journeys.health.wellness.chat.greeting')}
      </Text>
      <Text style={styles.subtitle}>
        {t('journeys.health.wellness.chat.subtitle')}
      </Text>
    </View>
  );
    ...
    >
      ...
      <View style={styles.moodTextContainer}>
        <Text style={styles.moodTitle}>
          {t('journeys.health.wellness.chat.moodPromptTitle')}
        </Text>
        <Text style={styles.moodSubtitle}>
          {t('journeys.health.wellness.chat.moodPromptSubtitle')}
        </Text>
      </View>
    ...
    <SafeAreaView style={styles.container} testID="wellness-chat-screen">
      <View style={styles.headerBar}>
        ...
        <Text style={styles.screenTitle}>
          {t('journeys.health.wellness.chat.screenTitle')}
        </Text>
