...
const MOCK_GOALS: WellnessGoal[] = [
    {
        id: 'g-1',
        titleKey: 'journeys.health.wellness.goals.walkSteps',
        category: 'fitness',
        progress: 7200,
        target: 10000,
        icon: '\u{1F6B6}',
    ...
    {
        id: 'g-2',
        titleKey: 'journeys.health.wellness.goals.drinkWater',
        category: 'nutrition',
        progress: 5,
        target: 8,
        icon: '\u{1F4A7}',
    ...
    {
        id: 'g-3',
        titleKey: 'journeys.health.wellness.goals.sleepHours',
        category: 'sleep',
        progress: 7,
        target: 8,
        icon: '\u{1F634}',
    ...
    {
        id: 'g-4',
        titleKey: 'journeys.health.wellness.goals.meditateMinutes',
    ...
    {
        id: 'g-5',
        titleKey: 'journeys.health.wellness.goals.eatFruits',
        category: 'nutrition',
        progress: 2,
        target: 5,
        icon: '\u{1F34E}',
    ...
    {
        id: 'g-6',
        titleKey: 'journeys.health.wellness.goals.stretchSession',
        category: 'fitness',
        progress: 1,
        target: 2,
        icon: '\u{1F938}',
...
export const CompanionGoalsScreen: React.FC = () => {
    ...
    const filteredGoals =
        selectedCategory === 'all' ? MOCK_GOALS : MOCK_GOALS.filter((g) => g.category === selectedCategory);
    ...
    const renderGoalItem = ({ item }: { item: WellnessGoal }): React.ReactElement | null => {
        ...
        return (
            <View style={styles.goalCard} testID={`goal-card-${item.id}`}>
                <View style={styles.goalLeft}>{renderProgressRing(progress, 48, 4, ringColor)}</View>
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-goals-screen">
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.goals.title')}</Text>
            ...
            <View style={styles.overallContainer}>
                ...
                <Text style={styles.overallLabel}>{t('journeys.health.wellness.goals.overallProgress')}</Text>
            </View>
                ...
                {CATEGORIES.map((cat) => {
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            style={[styles.categoryChip, isActive && { backgroundColor: CATEGORY_COLORS[cat] }]}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptyText}>{t('journeys.health.wellness.goals.noGoals')}</Text>
                    </View>
                }
            />
            ...
            <View style={styles.bottomActions}>
                ...
                >
                    <Text style={styles.addButtonText}>{t('journeys.health.wellness.goals.addGoal')}</Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                    <Text style={styles.dailyPlanText}>{t('journeys.health.wellness.goals.viewDailyPlan')}</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
