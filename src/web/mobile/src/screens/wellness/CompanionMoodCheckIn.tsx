...
const MOCK_MOOD_HISTORY: MoodEntry[] = [
    {
        ...
        emoji: '\u{1F642}',
        date: '2024-01-14',
        note: 'journeys.health.wellness.moodCheckIn.historyNote1',
    },
    {
        id: 'mh-002',
        value: 3,
        emoji: '\u{1F610}',
        date: '2024-01-13',
        note: 'journeys.health.wellness.moodCheckIn.historyNote2',
    },
    {
        id: 'mh-003',
        value: 5,
        emoji: '\u{1F604}',
        date: '2024-01-12',
        note: 'journeys.health.wellness.moodCheckIn.historyNote3',
    },
    {
        id: 'mh-004',
        value: 2,
        emoji: '\u{1F641}',
        date: '2024-01-11',
        note: 'journeys.health.wellness.moodCheckIn.historyNote4',
    },
    {
        id: 'mh-005',
        value: 4,
        emoji: '\u{1F642}',
        date: '2024-01-10',
        note: 'journeys.health.wellness.moodCheckIn.historyNote5',
    },
];
    ...
    return (
        <SafeAreaView style={styles.container} testID="wellness-mood-check-in-screen">
            <View style={styles.headerBar}>
                ...
                <Text style={styles.screenTitle}>{t('journeys.health.wellness.moodCheckIn.screenTitle')}</Text>
                <View style={styles.headerSpacer} />
            </View>

            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                {/* Prompt */}
                <Text style={styles.prompt}>{t('journeys.health.wellness.moodCheckIn.prompt')}</Text>
                            ...
                            <TouchableOpacity
                                ...
                                style={[
                                    ...
                                    isSelected && [
                                        ...
                                        { borderColor: getMoodColor(option.value) },
                                    ],
                                ]}
                ...
                {/* Note Input */}
                <Text style={styles.noteLabel}>{t('journeys.health.wellness.moodCheckIn.noteLabel')}</Text>
                <TextInput
                ...
                >
                    <Text style={styles.saveButtonText}>{t('journeys.health.wellness.moodCheckIn.save')}</Text>
                </TouchableOpacity>

                {/* Mood History Preview */}
                <View style={styles.historySection}>
                    <Text style={styles.historyTitle}>{t('journeys.health.wellness.moodCheckIn.recentMoods')}</Text>
                    <View style={styles.historyList}>
                        {MOCK_MOOD_HISTORY.map((entry) => (
                            <View key={entry.id} style={styles.historyItem} testID={`mood-history-${entry.id}`}>
                                ...
                                <View style={[styles.historyBar, { backgroundColor: getMoodColor(entry.value) }]} />
                            </View>
                        ))}
                    </View>
                </View>
