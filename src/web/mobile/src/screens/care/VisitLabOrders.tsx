...
/**
 * Route parameters expected by VisitLabOrders.
 */
type VisitLabOrdersRouteParams = {
...
const getUrgencyStatus = (
  ...
  if (urgency === 'routine') return 'success';
...
const VisitLabOrders: React.FC = () => {
  ...
  const { appointmentId = 'apt-001' } = route.params || {};
  ...
  const maxFastingHours = Math.max(
    ...fastingTests.map((test) => test.fastingHours || 0),
    0,
  );
            ...
            <View style={styles.testHeader}>
              ...
              <View style={styles.quickInfoRow}>
                ...
                {item.fastingRequired && (
                  <Badge variant="status" status="warning" size="sm" testID={`fasting-badge-${item.id}`}>
        ...
        {fastingTests.length > 0 && (
          <View style={styles.section}>
            <Text
              ...
              fontSize="heading-md"
              journey="care"
              testID="prep-instructions-heading"
            >
