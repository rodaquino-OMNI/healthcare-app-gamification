...
const BODY_REGIONS_BASE = [
    ...
    {
        id: 'abdomen',
        labelKey: 'journeys.care.symptomChecker.bodyMap.abdomen',
        top: 29,
        left: 30,
        width: 40,
        height: 12,
    ...
    {
        id: 'left_arm',
        labelKey: 'journeys.care.symptomChecker.bodyMap.leftArm',
        top: 17,
        left: 5,
        width: 22,
        height: 28,
    ...
    {
        id: 'right_arm',
        labelKey: 'journeys.care.symptomChecker.bodyMap.rightArm',
        top: 17,
        left: 73,
        width: 22,
        height: 28,
    ...
    {
        id: 'left_leg',
        labelKey: 'journeys.care.symptomChecker.bodyMap.leftLeg',
        top: 49,
        left: 20,
        width: 24,
        height: 48,
    ...
    {
        id: 'right_leg',
        labelKey: 'journeys.care.symptomChecker.bodyMap.rightLeg',
        top: 49,
        left: 56,
        width: 24,
        height: 48,
    ...
    return (
        <View style={styles.root}>
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <Text variant="heading" journey="care" testID="body-map-title">
                    {t('journeys.care.symptomChecker.bodyMap.title')}
                </Text>

                <Text variant="body" journey="care" testID="body-map-subtitle">
