...
> = {
    ...
    c2: {
        causes: ['Pollen from trees, grasses, and weeds', 'Dust mites', 'Pet dander', 'Mold spores'],
        treatments: [
...
const SymptomConditionDetail: React.FC = () => {
    ...
    const sections = [
        ...
        {
            key: 'treatments',
            title: t('journeys.care.symptomChecker.conditionDetail.treatmentOptions', {
                defaultValue: 'Treatment Options',
            }),
            content: null,
        ...
        {
            key: 'warnings',
            title: t('journeys.care.symptomChecker.conditionDetail.whenToWorry', {
                defaultValue: 'When to Seek Medical Help',
            }),
            content: null,
