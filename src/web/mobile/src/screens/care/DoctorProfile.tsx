...
const MOCK_DOCTOR: DoctorDetail = {
    ...
    specializations: ['Cardiologia Preventiva', 'Reabilitacao Cardiaca', 'Ecocardiografia', 'Arritmias'],
    education: [
    ...
    acceptedInsurance: ['Unimed', 'Bradesco Saude', 'SulAmerica', 'Amil', 'Notre Dame Intermedica'],
    reviews: [
        {
            id: 'rev-001',
        ...
        },
        {
            ...
            reviewerName: 'Joao P.',
            rating: 5,
            comment: 'Medica muito competente. Me senti acolhido durante toda a consulta.',
            date: '08/01/2026',
        },
        {
            id: 'rev-003',
        ...
        <View style={styles.root}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.headerSection}>
                    <Avatar name={doctor.name} journey="care" size="96px" fallbackType="initials" />
                    <Text fontWeight="bold" fontSize="xl" textAlign="center" testID="doctor-name">
                        {doctor.name}
                    </Text>
