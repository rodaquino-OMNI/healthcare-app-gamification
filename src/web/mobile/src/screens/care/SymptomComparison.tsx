...
const SymptomComparison: React.FC = () => {
  const route = useRoute<RouteProp<{ params: SymptomComparisonRouteParams }, 'params'>>();
  ...
  const allSymptoms = Array.from(
    new Set([...checkA.symptoms, ...checkB.symptoms]),
  );

  const allRegions = Array.from(
    new Set([...checkA.regions, ...checkB.regions]),
  );
      ...
      >
        ...
        <Card journey="care" elevation="md">
          ...
          <View style={styles.comparisonRow}>
            ...
            >
              {severityChange === 'improved' ? '\u2193' : severityChange === 'worsened' ? '\u2191' : '\u2194'}
            </Text>
        ...
        <Card
          journey="care"
          elevation="md"
          borderColor={getChangeColor(severityChange)}
        >
          <Text variant="body" fontWeight="semiBold" journey="care">
