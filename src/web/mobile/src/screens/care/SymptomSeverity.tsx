            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <Card journey="care" elevation="md">
                    ...
                    <View style={styles.indicatorBar}>
                        ...
                        />
                        <View
                            style={[styles.indicatorSegment, { flex: 3, backgroundColor: colors.semantic.warning }]}
                        />
                        <View
                            style={[
                                styles.indicatorSegment,
                ...
                <Card journey="care" elevation="sm">
                    <View style={[styles.descriptionHeader, { borderLeftColor: severityConfig.color }]}>
                        <Text fontSize="heading-md" fontWeight="semiBold" color={severityConfig.color}>
                            {severityConfig.icon}
                        </Text>
                    </View>
