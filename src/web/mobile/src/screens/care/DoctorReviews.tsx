...
const MOCK_REVIEWS: Review[] = [
    {
        ...
        rating: 5,
        comment: 'Excelente profissional, muito atenciosa e explicou tudo com clareza. Recomendo muito para todos!',
        date: '2026-02-18',
        helpfulCount: 12,
    },
    {
        ...
        reviewerName: 'Joao P.',
        rating: 5,
        comment: 'Medica muito competente. Me senti acolhido durante toda a consulta. Muito paciente e detalhista.',
        date: '2026-02-15',
        helpfulCount: 8,
    },
    {
        ...
        rating: 4,
        comment: 'Otima consulta, mas a espera foi um pouco longa. Fora isso, tudo perfeito.',
        date: '2026-02-10',
        helpfulCount: 5,
    },
    {
        ...
        rating: 5,
        comment: 'Sempre indico para amigos e familiares. Profissional excepcional com muito conhecimento.',
        date: '2026-02-05',
        helpfulCount: 15,
    },
    {
        ...
        reviewerName: 'Ana R.',
        rating: 3,
        comment: 'Boa consulta, porem senti que poderia ter sido mais detalhada nas explicacoes.',
        date: '2026-01-28',
        helpfulCount: 3,
    },
    {
        ...
        rating: 5,
        comment: 'Melhor cardiologista que ja consultei. Muito profissional e acolhedora.',
        date: '2026-01-20',
        helpfulCount: 20,
    },
    {
        id: 'r7',
        reviewerName: 'Beatriz O.',
        rating: 4,
        comment: 'Consulta muito boa, explicou os exames com paciencia. Voltarei com certeza.',
        date: '2026-01-15',
        helpfulCount: 7,
    },
    {
        ...
        rating: 2,
        comment: 'A consulta foi rapida demais. Esperava mais tempo para tirar duvidas.',
        date: '2026-01-10',
        helpfulCount: 2,
    },
    {
        id: 'r9',
        reviewerName: 'Fernanda G.',
        rating: 5,
        comment: 'Atendimento humanizado e competente. Saí da consulta muito mais tranquila.',
        date: '2026-01-05',
        helpfulCount: 11,
    },
    {
        id: 'r10',
        reviewerName: 'Bruno K.',
        rating: 4,
        comment: 'Muito boa profissional. Recomendo para quem precisa de acompanhamento cardiologico.',
        date: '2025-12-28',
        helpfulCount: 6,
    },
];
...
export const DoctorReviews: React.FC = () => {
    ...
    const renderRatingBar = (stars: number, count: number): React.ReactElement | null => {
    ...
    const renderReviewItem = ({ item }: { item: Review }): React.ReactElement | null => {
        ...
        return (
            <Card journey="care" elevation="sm">
                ...
                <View style={styles.reviewFooter}>
                    ...
                    >
                        <Text fontSize="sm" color={isHelped ? colors.journeys.care.primary : colors.neutral.gray500}>
