        ...
        <View style={styles.root}>
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.warningHeader}>
                    <Text fontSize="display-lg" textAlign="center" testID="emergency-icon">
                        {'\u26a0\ufe0f'}
                    </Text>
                    <Text variant="heading" color={colors.neutral.white} textAlign="center" testID="emergency-title">
                ...
                <Card journey="care" elevation="sm">
                    <Text variant="caption" color={colors.neutral.gray600} testID="emergency-disclaimer">
                ...
                <View style={styles.dismissContainer}>
                    ...
                    >
                        <Text fontSize="text-xs" color={colors.neutral.gray500} textAlign="center">
