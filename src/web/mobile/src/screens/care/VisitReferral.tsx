...
const VisitReferral: React.FC = () => {
  ...
  const { appointmentId = 'apt-001', referralId = 'ref-001' } =
    route.params || {};
      ...
      >
        ...
        <View
          style={[
            ...
            remainingDays <= 7 && styles.validityBannerUrgent,
          ]}
        >
          <Text
            fontSize="text-sm"
        ...
        <View style={styles.section}>
          <Text
            ...
            fontSize="heading-md"
            journey="care"
            testID="referring-doctor-heading"
          >
