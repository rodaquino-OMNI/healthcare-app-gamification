    ...
    <View style={styles.root}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        <Card journey="care" elevation="sm">
          ...
          <Badge journey="care" size="sm">{MOCK_APPOINTMENT.specialty}</Badge>
        ...
        <Card journey="care" elevation="sm">
          <View style={styles.warningCard}>
            ...
            <View style={styles.policyItem}>
              <Badge variant="status" status="success" size="sm">24h+</Badge>
              <Text fontSize="sm" color={colors.journeys.care.text}>
                {t('consultation.cancel.fullRefund')}
              </Text>
            </View>
            <View style={styles.policyItem}>
              <Badge variant="status" status="warning" size="sm">12-24h</Badge>
              <Text fontSize="sm" color={colors.journeys.care.text}>
                {t('consultation.cancel.halfRefund')}
              </Text>
            </View>
            <View style={styles.policyItem}>
              <Badge variant="status" status="error" size="sm">{'<12h'}</Badge>
              <Text fontSize="sm" color={colors.journeys.care.text}>
        ...
        >
          <View style={[styles.checkbox, policyAccepted && styles.checkboxChecked]}>
            {policyAccepted && (
              <Text fontSize="sm" color={colors.neutral.white}>{'V'}</Text>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  reasonOption: {
    ...
    paddingVertical: spacingValues.sm, paddingHorizontal: spacingValues.md,
    borderRadius: spacingValues.xs, borderWidth: 1, borderColor: colors.neutral.gray300,
  },
  reasonOptionSelected: { borderColor: colors.journeys.care.primary },
  radio: {
    width: 20, height: 20, borderRadius: 10,
    borderWidth: 2, borderColor: colors.neutral.gray300,
  },
  ...
  checkboxRow: { flexDirection: 'row', alignItems: 'center', gap: spacingValues.sm, paddingVertical: spacingValues.xs },
  checkbox: {
