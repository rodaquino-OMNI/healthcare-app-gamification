...
const TelemedicineEndScreen: React.FC = () => {
    ...
    const getRatingLabel = useCallback(
        (stars: number): string => {
            ...
            if (stars <= 2) {
                return t('journeys.care.telemedicineDeep.endScreen.ratingLabels.poor');
            }
            if (stars === 3) {
                return t('journeys.care.telemedicineDeep.endScreen.ratingLabels.average');
            }
            if (stars === 4) {
                return t('journeys.care.telemedicineDeep.endScreen.ratingLabels.good');
            }
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.headerSection}>
                    <View style={styles.endIconCircle}>
                        <Text fontSize="heading-lg" color={colors.neutral.white} testID="call-ended-icon">
                            {'\u{1F4DE}'}
                        </Text>
                    </View>
                    <Text variant="heading" journey="care" testID="call-ended-title">
                ...
                <Card journey="care" elevation="md">
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text fontSize="text-sm" color={colors.neutral.gray600} testID="summary-appointment-id">
                            #{appointmentId}
                        </Text>
                    </View>
                </Card>
                ...
                <Card journey="care" elevation="sm">
                    <Text variant="body" fontWeight="semiBold" journey="care" testID="rating-prompt">
                    ...
                    <View style={styles.starsContainer}>
                        {Array.from({ length: MAX_STARS }, (_, i) => i + 1).map((star) => (
                            <TouchableOpacity
                                ...
                                disabled={submitted}
                                testID={`star-${star}`}
                                accessibilityLabel={t('journeys.care.telemedicineDeep.endScreen.starLabel', {
                                    star,
                                    total: MAX_STARS,
                                })}
                            ...
                            >
                                <Text
                                    fontSize="heading-lg"
                                    color={star <= rating ? colors.journeys.care.primary : colors.neutral.gray400}
                                >
                    ...
                    {rating > 0 && (
                        <Text fontSize="text-sm" color={colors.journeys.care.primary} testID="rating-label">
                    ...
                    {!submitted && (
                        <View style={styles.feedbackSection}>
                            <Text fontSize="text-sm" color={colors.neutral.gray600} testID="feedback-label">
                    ...
                    {!submitted ? (
                        ...
                        <View style={styles.thankYouContainer}>
                            <Text variant="body" color={colors.semantic.success} testID="thank-you-text">
