...
const MOCK_RECORDS: MedicalRecord[] = [
    {
        id: 'rec-001',
        title: 'Resumo da Consulta - Cardiologia',
        date: '21/02/2026',
        type: 'visit_notes',
        size: '245 KB',
        description: 'Notas da consulta com Dra. Ana Carolina Silva. Avaliacao cardiovascular completa.',
    },
    {
        id: 'rec-002',
        ...
        type: 'lab_results',
        size: '128 KB',
        description: 'Resultados do exame de sangue. Todos os valores dentro da normalidade.',
    },
    {
        id: 'rec-003',
        ...
        type: 'prescriptions',
        size: '89 KB',
        description: 'Prescricao de Losartana 50mg, 1x ao dia, por 30 dias.',
    },
    {
        id: 'rec-004',
        ...
        type: 'imaging',
        size: '2.3 MB',
        description: 'Ecocardiograma transtoracico. Fracao de ejecao 65%, sem alteracoes valvares.',
    },
    {
        id: 'rec-005',
        ...
        type: 'lab_results',
        size: '95 KB',
        description: 'Colesterol total, HDL, LDL e triglicerides. LDL levemente elevado.',
    },
    {
        id: 'rec-006',
        ...
        type: 'referral',
        size: '67 KB',
        description: 'Encaminhamento para avaliacao nutricional e plano alimentar.',
    },
];
...
const MedicalRecordsAccess: React.FC = () => {
    ...
    const handleSendToDoctor = useCallback(
        (rec: MedicalRecord) => {
            Alert.alert(
                ...
                [
                    { text: t('journeys.care.medicalRecords.cancel'), style: 'cancel' },
                    { text: t('journeys.care.medicalRecords.send') },
                ]
            );
        },
        [t]
    ...
    const handleShareSelected = useCallback(async () => {
        if (selectedRecords.size === 0) {
            Alert.alert(
                t('journeys.care.medicalRecords.noSelectionTitle'),
                t('journeys.care.medicalRecords.noSelectionMessage'),
                [{ text: t('journeys.care.medicalRecords.ok') }]
            );
            return;
        }
        try {
            const titles = MOCK_RECORDS.filter((r) => selectedRecords.has(r.id))
                .map((r) => r.title)
                .join(', ');
            await Share.share({
                title: t('journeys.care.medicalRecords.shareSelectedTitle'),
                message: t('journeys.care.medicalRecords.shareSelectedMessage', { titles }),
            });
        } catch {
            /* User cancelled */
        }
    ...
    const handleRequestRecords = useCallback(() => {
        Alert.alert(t('journeys.care.medicalRecords.requestTitle'), t('journeys.care.medicalRecords.requestMessage'), [
            { text: t('journeys.care.medicalRecords.ok') },
        ]);
    }, [t]);
            ...
            return (
                <Card journey="care" elevation="sm">
                    ...
                    >
                        ...
                        <Text fontSize="md" style={styles.recordIcon}>
                        ...
                        <View style={styles.recordInfo}>
                            ...
                            <View style={styles.recordMeta}>
                                ...
                                <Badge
                                    variant="status"
                                    status={TYPE_BADGE_STATUS[item.type]}
                        ...
                        <View style={styles.expandedContent}>
                            ...
                            <View style={styles.recordActions}>
                                <TouchableOpacity
                                    ...
                                    accessibilityLabel={t('journeys.care.medicalRecords.download')}
                                    accessibilityRole="button"
                                >
                                    <Text fontSize="text-sm" fontWeight="semiBold" color={colors.journeys.care.primary}>
                                        {t('journeys.care.medicalRecords.download')}
                                    </Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    ...
                                    accessibilityLabel={t('journeys.care.medicalRecords.share')}
                                    accessibilityRole="button"
                                >
                                    <Text fontSize="text-sm" fontWeight="semiBold" color={colors.journeys.care.primary}>
                                        {t('journeys.care.medicalRecords.share')}
                                    </Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    onPress={() => handleSendToDoctor(item)}
                                    style={styles.actionButton}
                                    testID={`send-doctor-${item.id}`}
                                    accessibilityLabel={t('journeys.care.medicalRecords.sendToDoctor')}
                                    accessibilityRole="button"
                                >
                                    <Text fontSize="text-sm" fontWeight="semiBold" color={colors.journeys.care.primary}>
                                        {t('journeys.care.medicalRecords.sendToDoctor')}
                                    </Text>
                                </TouchableOpacity>
                            </View>
                        </View>
        ...
        <View style={styles.root}>
            ...
            <View style={styles.bulkActions}>
                <TouchableOpacity
                    ...
                    accessibilityLabel={t('journeys.care.medicalRecords.downloadAll')}
                    accessibilityRole="button"
                >
                    <Text fontSize="text-sm" fontWeight="semiBold" color={colors.journeys.care.primary}>
                ...
                <TouchableOpacity
                    ...
                    testID="share-selected-button"
                    accessibilityLabel={t('journeys.care.medicalRecords.shareSelected', {
            ...
            <View style={styles.bottomSection}>
                ...
                <Button
                    onPress={handleRequestRecords}
                    journey="care"
                    variant="secondary"
                    testID="request-records-button"
                    accessibilityLabel={t('journeys.care.medicalRecords.requestRecords')}
                >
