        ...
        >
            {SPECIALTIES_KEYS.map((key, index) => (
                <TouchableOpacity
                    ...
                    style={[styles.tab, selectedSpecialty === index && styles.tabActive]}
                ...
                >
                    <Text
                        ...
                        color={selectedSpecialty === index ? colors.neutral.white : colors.journeys.care.primary}
                    >
                        {t(key)}
                    </Text>
                </TouchableOpacity>
 ...
 */
export const ControlsRow: React.FC<ControlsRowProps> = ({ sortBy, onSortChange, isMapView, onToggleView }) => {
    const { t } = useTranslation();
    ...
    return (
        <View style={styles.controlsRow}>
            ...
            <TouchableOpacity
                ...
                accessibilityLabel={
                    isMapView
                        ? t('journeys.care.doctorSearch.switchToList')
                        : t('journeys.care.doctorSearch.switchToMap')
                }
            >
