...
const MOCK_DOCTORS: Record<string, { name: string; specialty: string; location: string }> = {
  'doc-001': { name: 'Dra. Ana Carolina Silva', specialty: 'Cardiologia', location: 'Clinica Saude Total - Av. Paulista, 1000' },
  'doc-002': { name: 'Dr. Pedro Santos', specialty: 'Clinica Geral', location: 'Hospital do Coracao - R. Desembargador, 200' },
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.successSection}>
          ...
          <Text fontWeight="bold" fontSize="xl" color={colors.journeys.care.text} textAlign="center" testID="success-title">
        ...
        <Card journey="care" elevation="md">
          ...
          <View style={styles.summaryRow}>
            ...
            <Badge
              journey="care"
              size="sm"
              status={isTelemedicine ? 'info' : 'neutral'}
            >
              {typeLabel}
            </Badge>
          </View>
