...
const SymptomAnalyzing: React.FC = () => {
  ...
  }, [currentStep, totalSteps, navigation, fadeAnim, symptoms, description, regions, details, answers, overallSeverity]);
    ...
    <View style={styles.root}>
      <View style={styles.container}>
        ...
        <Text
          ...
          color={colors.neutral.gray600}
          textAlign="center"
          testID="analyzing-disclaimer"
        >
          {t('journeys.care.symptomChecker.analyzing.disclaimer', {
            defaultValue: 'This analysis is for informational purposes only and does not replace professional medical advice.',
          })}
        </Text>
      </View>
    </View>
