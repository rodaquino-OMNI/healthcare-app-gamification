    ...
    return (
        <View style={styles.root}>
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <Text fontSize="text-sm" color={colors.neutral.gray600} testID="payment-doctor-name">
                ...
                <View style={styles.securityNotice}>
                    <Text fontSize="text-sm" color={colors.neutral.gray500} textAlign="center" testID="security-notice">
