...
const DoctorAvailability: React.FC = () => {
    ...
    const availableDays = useMemo(() => getAvailableDays(currentYear, currentMonth), [currentYear, currentMonth]);

    const calendarGrid = useMemo(() => buildCalendarGrid(currentYear, currentMonth), [currentYear, currentMonth]);

    const timeSlots = useMemo(() => (selectedDay ? getTimeSlotsForDate(selectedDay) : []), [selectedDay]);
