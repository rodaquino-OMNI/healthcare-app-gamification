            ...
            if (item.sender === 'system') {
                return (
                    <View style={styles.systemMessageContainer} testID={`system-msg-${item.id}`}>
                        <Text fontSize="text-sm" color={colors.neutral.gray500} textAlign="center">
                            {item.text}
                        </Text>
                    </View>
                );
            ...
            return (
                ...
                >
                    ...
                    <View style={[styles.messageBubble, isDoctor ? styles.doctorBubble : styles.patientBubble]}>
                        ...
                        <Text fontSize="text-sm" color={isDoctor ? colors.journeys.care.text : colors.neutral.gray700}>
                            {item.text}
                        </Text>
                        <Text fontSize="text-sm" color={colors.neutral.gray500} textAlign="right">
                            {item.timestamp}
                        </Text>
                    </View>
                    {!isDoctor && (
    ...
    return (
        ...
        >
            ...
            <View style={styles.headerContainer}>
                <View style={styles.doctorHeaderInfo}>
                    ...
                    <View style={styles.doctorTextInfo}>
                        <Text fontSize="md" fontWeight="semiBold" journey="care" testID="chat-doctor-name">
                            {doctorName}
                        </Text>
                    ...
                    <Badge
                        ...
                        accessibilityLabel={
                            isOnline ? t('journeys.care.asyncChat.online') : t('journeys.care.asyncChat.offline')
                        }
                    >
                        {isOnline ? t('journeys.care.asyncChat.online') : t('journeys.care.asyncChat.offline')}
                    </Badge>
            ...
            <View style={styles.noticeContainer}>
                <Text fontSize="text-sm" color={colors.neutral.gray600} textAlign="center" testID="response-notice">
