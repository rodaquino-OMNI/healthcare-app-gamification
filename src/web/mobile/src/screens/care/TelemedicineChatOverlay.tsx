 ...
 */
const QUICK_REPLIES = ['yes', 'no', 'iUnderstand', 'canYouRepeat'] as const;
...
const TelemedicineChatOverlay: React.FC = () => {
    ...
    const renderMessage = useCallback(({ item }: { item: ChatMessage }) => {
        ...
        return (
            <View
                style={[styles.messageBubbleContainer, isDoctor ? styles.messageBubbleLeft : styles.messageBubbleRight]}
            ...
            >
                ...
                <View style={[styles.bubble, isDoctor ? styles.bubbleDoctor : styles.bubblePatient]}>
                    <Text variant="body" color={isDoctor ? colors.neutral.gray800 : colors.neutral.white}>
                        {item.text}
                    </Text>
                </View>
                <Text fontSize="text-sm" color={colors.neutral.gray500} testID={`message-time-${item.id}`}>
                    {item.timestamp}
                </Text>
            </View>
        );
    ...
    return (
        ...
        >
            ...
            <View style={styles.header}>
                <Text variant="heading" journey="care" testID="chat-header-title">
