...
const SymptomDetail: React.FC = () => {
    ...
    const getSeverityLabel = (value: number): string => {
        if (value <= 3) {
            return t('journeys.care.symptomChecker.severity.mild');
        }
        if (value <= 6) {
            return t('journeys.care.symptomChecker.severity.moderate');
        }
    ...
    return (
        <View style={styles.root}>
            ...
            >
                ...
                {details.length > 1 && (
                    <Text variant="body" journey="care" testID="detail-region-counter">
                        {t('journeys.care.symptomChecker.details.regionCounter', {
                ...
                <Card journey="care" elevation="md">
                    <Text variant="heading" fontSize="heading-lg" journey="care" testID="detail-region-name">
                    ...
                    <View style={styles.fieldGroup}>
                        ...
                        <View style={styles.severityRow}>
                            ...
                            <Text fontSize="text-sm" color={getSeverityColor(currentDetail.severity)}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    <Button
                        onPress={handleNext}
                        journey="care"
                        accessibilityLabel={currentIndex < details.length - 1 ? 'Next region' : 'Continue to questions'}
                        testID="next-button"
                    >
                        {currentIndex < details.length - 1
                            ? t('journeys.care.symptomChecker.details.nextRegion')
