        ...
        <Container>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                <ContentContainer>
                    ...
                    <Title testID="server-error-title">{t('error.server.title')}</Title>

                    <Description testID="server-error-description">{t('error.server.description')}</Description>

                    <ErrorCode testID="server-error-code">{t('error.server.errorCode', { code: '500' })}</ErrorCode>
                    ...
                    >
                        <PrimaryButtonText>{t('error.server.tryAgain')}</PrimaryButtonText>
                    </PrimaryButton>
                    ...
                    >
                        <SecondaryButtonText>{t('error.server.contactSupport')}</SecondaryButtonText>
                    </SecondaryButton>
                </ContentContainer>
            </ScrollView>
        </Container>
