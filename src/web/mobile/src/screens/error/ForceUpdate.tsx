...
const VersionValue = styled.Text<{ isOld?: boolean }>`
    ...
    color: ${(props) => (props.isOld ? colors.semantic.error : colors.semantic.success)};
`;
...
export const ForceUpdate: React.FC = () => {
    ...
    const storeName = Platform.OS === 'ios' ? t('error.forceUpdate.appStore') : t('error.forceUpdate.playStore');
        ...
        <Container>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                <ContentContainer>
                    ...
                    <Title testID="force-update-title">{t('error.forceUpdate.title')}</Title>

                    <Description testID="force-update-description">{t('error.forceUpdate.description')}</Description>
                    ...
                    <VersionCard>
                        ...
                        <VersionRow>
                            ...
                            <VersionValue testID="force-update-required-value">v{REQUIRED_VERSION}</VersionValue>
                        </VersionRow>
                    </VersionCard>
                    ...
                    >
                        <UpdateButtonText>{t('error.forceUpdate.updateNow')}</UpdateButtonText>
                    </UpdateButton>
                    ...
                    <WhatsNewContainer>
                        ...
                        {features.map((feature, index) => (
                            <FeatureRow key={index}>
                                ...
                                <FeatureText testID={`force-update-feature-${index}`}>{feature}</FeatureText>
                            </FeatureRow>
                        ))}
                    </WhatsNewContainer>
                </ContentContainer>
