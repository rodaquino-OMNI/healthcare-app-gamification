        ...
        <Container>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                <ContentContainer>
                    ...
                    <Title testID="maintenance-title">{t('error.maintenance.title')}</Title>

                    <Description testID="maintenance-description">{t('error.maintenance.description')}</Description>

                    <ScheduleCard>
                        <ScheduleLabel testID="maintenance-schedule-label">
                            {t('error.maintenance.expectedBack')}
                        </ScheduleLabel>
                        <ScheduleTime testID="maintenance-schedule-time">10:00 AM</ScheduleTime>
                    </ScheduleCard>

                    <NotifyRow>
                        <NotifyLabel testID="maintenance-notify-label">{t('error.maintenance.notifyMe')}</NotifyLabel>
                        <ToggleButton
                    ...
                    <ProgressRow>
                        ...
                        <ProgressDot active={false} />
                        <ProgressLabel testID="maintenance-progress">{t('error.maintenance.inProgress')}</ProgressLabel>
                    </ProgressRow>
                </ContentContainer>
            </ScrollView>
        </Container>
