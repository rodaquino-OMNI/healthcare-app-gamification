...
jest.mock('styled-components/native', () => {
    ...
    const safeAreaFactory = (): typeof MockSafeAreaView => MockSafeAreaView;
    safeAreaFactory.attrs = (): typeof safeAreaFactory => safeAreaFactory;
    function MockView(props: Record<string, unknown>): React.ReactElement {
        return <RN.View {...props} />;
    }
    MockView.displayName = 'MockView';
    function MockText(props: Record<string, unknown>): React.ReactElement {
        return <RN.Text {...props} />;
    }
    MockText.displayName = 'MockText';
    function MockTouchable(props: Record<string, unknown>): React.ReactElement {
        return <RN.TouchableOpacity {...props} />;
    }
    MockTouchable.displayName = 'MockTouchable';
    const styled: Record<string, unknown> = {
        SafeAreaView: safeAreaFactory,
        View: () => MockView,
        Text: () => MockText,
...
describe('NoInternet', () => {
    ...
    it('calls onRetry callback when retry is pressed', () => {
        ...
        fireEvent.press(getByTestId('no-internet-retry'));
