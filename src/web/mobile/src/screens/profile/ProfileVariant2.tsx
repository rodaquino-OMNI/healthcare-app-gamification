...
const PlanTypeChip = styled.TouchableOpacity<{ selected: boolean }>`
    ...
    border-radius: ${borderRadius.md};
    border-width: 1px;
    border-color: ${(props) => (props.selected ? colors.journeys.plan.primary : colors.gray[20])};
    background-color: ${(props) => (props.selected ? colors.journeys.plan.background : colors.neutral.white)};
    align-items: center;
`;
...
const PlanTypeText = styled.Text<{ selected: boolean }>`
    ...
    color: ${(props) => (props.selected ? colors.journeys.plan.primary : colors.neutral.gray700)};
`;
...
const ToggleBox = styled.View<{ active: boolean }>`
    ...
    border-width: 2px;
    border-color: ${(props) => (props.active ? colors.brand.primary : colors.gray[30])};
...
const ProfileVariant2: React.FC = () => {
    ...
    const onSubmit = async (data: InsuranceFormData): Promise<void> => {
                ...
                <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    <ContentWrapper>
                        ...
                        <HeaderSection>
                            ...
                            <Subtitle>{t('profile.insurance.subtitle')}</Subtitle>
                        ...
                        {hasInsurance && (
                            <>
                                ...
                                <FieldContainer>
                                    ...
                                    />
                                    {errors.planNumber && <ErrorText>{errors.planNumber.message}</ErrorText>}
                                </FieldContainer>
                                ...
                                <FieldContainer>
                                    ...
                                    {errors.planType && <ErrorText>{errors.planType.message}</ErrorText>}
                                </FieldContainer>
                            </>
                        )}
