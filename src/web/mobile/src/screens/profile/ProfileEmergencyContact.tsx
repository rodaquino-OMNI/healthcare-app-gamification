...
const Chip = styled.TouchableOpacity<{ selected: boolean }>`
    ...
    border-width: 1px;
    border-color: ${(props) => (props.selected ? colors.brand.primary : colors.gray[30])};
    border-radius: ${borderRadius.full};
...
const ChipText = styled.Text<{ selected: boolean }>`
    ...
    font-size: ${typography.fontSize['text-sm']};
    font-weight: ${typography.fontWeight.medium};
    color: ${(props) => (props.selected ? colors.neutral.white : colors.neutral.gray900)};
`;
        ...
        <Container>
            ...
            >
                <ContentWrapper>
                    ...
                    {/* Relationship */}
                    <SectionLabel>{t('profile.emergencyContact.relationshipLabel')}</SectionLabel>
                    <ChipsContainer>
                    ...
                    {/* Primary Toggle */}
                    <ToggleRow>
                        <ToggleLabel>{t('profile.emergencyContact.primaryLabel')}</ToggleLabel>
                        <Switch
                            value={isPrimary}
