...
jest.mock('../../../../../../design-system/src/tokens/spacing', () => ({
  spacing: { '3xs': '2px', '2xs': '4px', xs: '4px', sm: '8px', md: '16px', lg: '24px', xl: '32px', '2xl': '40px', '3xl': '48px', '4xl': '64px' },
...
jest.mock('../../../../../../design-system/src/tokens/typography', () => ({
  typography: {
    ...
    fontSize: { xs: '12px', sm: '14px', md: '16px', lg: '18px', xl: '20px', 'text-xs': '12px', 'text-sm': '14px', 'text-md': '16px', 'text-lg': '18px', 'heading-sm': '20px', 'heading-md': '22px', 'heading-lg': '26px', 'heading-xl': '30px', 'heading-2xl': '34px', 'display-md': '36px' },
