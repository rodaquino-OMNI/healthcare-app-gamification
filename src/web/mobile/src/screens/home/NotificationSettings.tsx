...
export const NotificationSettingsScreen: React.FC = () => {
    ...
    const handleToggle = useCallback((key: keyof NotificationToggles) => {
    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderTitle accessibilityRole="header" testID="notif-settings-title">
            ...
            >
                ...
                <ToggleRow>
                    <ToggleTextContainer>
                        <ToggleLabel>{t('notification.settings.healthUpdates')}</ToggleLabel>
                        <ToggleDescription>{t('notification.settings.healthUpdatesDesc')}</ToggleDescription>
                    </ToggleTextContainer>
                    <Switch
                ...
                <ToggleRow>
                    <ToggleTextContainer>
                        <ToggleLabel>{t('notification.settings.careReminders')}</ToggleLabel>
                        <ToggleDescription>{t('notification.settings.careRemindersDesc')}</ToggleDescription>
                    </ToggleTextContainer>
                    <Switch
                ...
                <ToggleRow>
                    <ToggleTextContainer>
                        <ToggleLabel>{t('notification.settings.planNotifications')}</ToggleLabel>
                        <ToggleDescription>{t('notification.settings.planNotificationsDesc')}</ToggleDescription>
                    </ToggleTextContainer>
                    <Switch
                ...
                <ToggleRow>
                    <ToggleTextContainer>
                        <ToggleLabel>{t('notification.settings.systemAlerts')}</ToggleLabel>
                        <ToggleDescription>{t('notification.settings.systemAlertsDesc')}</ToggleDescription>
                    </ToggleTextContainer>
                    <Switch
                ...
                <ToggleRow>
                    <ToggleTextContainer>
                        <ToggleLabel>{t('notification.settings.quietHoursEnable')}</ToggleLabel>
                        <ToggleDescription>{t('notification.settings.quietHoursDesc')}</ToggleDescription>
                    </ToggleTextContainer>
                    <Switch
                ...
                {toggles.quietHours && (
                    <>
                        <QuietHoursRow>
                            <TimeLabel>{t('notification.settings.quietFrom')}</TimeLabel>
                            <TimeValue testID="notif-settings-quiet-from">22:00</TimeValue>
                        </QuietHoursRow>
                        <QuietHoursRow>
                            <TimeLabel>{t('notification.settings.quietTo')}</TimeLabel>
                            <TimeValue testID="notif-settings-quiet-to">07:00</TimeValue>
                        </QuietHoursRow>
                    </>
                )}
            </ScrollView>
            ...
            <SaveButtonContainer>
                ...
                >
                    <SaveButtonText>{t('notification.settings.save')}</SaveButtonText>
                </SaveButton>
            </SaveButtonContainer>
        </Container>
    );
