    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderTitle accessibilityRole="header" testID="weekly-summary-title">
            ...
            >
                ...
                <MetricsGrid>
                    {MOCK_METRICS.map((metric, index) => {
                        ...
                        return (
                            ...
                            >
                                <MetricIconRow>
                                    <MetricIcon accessibilityElementsHidden>{metric.icon}</MetricIcon>
                ...
                <SectionTitle testID="weekly-insights-title">{t('home.weeklySummary.insights')}</SectionTitle>
