...
export const NotificationUnreadFilterScreen: React.FC = () => {
                        ...
                        <CardContent>
                            <CardHeader>
                                <TypeBadge bgColor={`${typeColor}20`}>
                                    <TypeBadgeText textColor={typeColor}>{t(getTypeLabelKey(item.type))}</TypeBadgeText>
                                </TypeBadge>
    ...
    const keyExtractor = useCallback((item: UnreadNotification) => item.id, []);
    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderTitle accessibilityRole="header" testID="unread-filter-title">
                ...
                {notifications.length > 0 ? (
                    ...
                    >
                        <MarkAllText>{t('notification.unread.markAll')}</MarkAllText>
                    </MarkAllButton>
                ) : (
            ...
            {notifications.length === 0 ? (
                <EmptyContainer testID="unread-filter-empty">
                    ...
                    <EmptyTitle>{t('notification.unread.emptyTitle')}</EmptyTitle>
                    <EmptyDescription>{t('notification.unread.emptyDescription')}</EmptyDescription>
                </EmptyContainer>
            ) : (
                <FlatList
                    data={notifications}
