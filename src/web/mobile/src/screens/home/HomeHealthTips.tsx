...
export const HomeHealthTipsScreen: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <SectionLabel testID="health-tips-section-label">
        {t('home.healthTips.dailyTips')}
      </SectionLabel>
      ...
      <FeaturedSection>
        <FeaturedTitle testID="health-tips-featured-title">
          {t('home.healthTips.featured')}
        </FeaturedTitle>
        ...
        {FEATURED_TIPS.map((tip) => (
          ...
          >
            <FeaturedIcon accessibilityElementsHidden>
              {tip.emoji}
            </FeaturedIcon>
            <FeaturedInfo>
