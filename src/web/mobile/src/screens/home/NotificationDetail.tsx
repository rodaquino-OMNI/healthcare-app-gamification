...
import { NotificationStatus } from '@shared/types/notification.types';
import React, { useMemo } from 'react';
import { useTranslation } from 'react-i18next';
import { View, Text, TouchableOpacity, StyleSheet, SafeAreaView, ScrollView, Share } from 'react-native';
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.card, { borderTopColor: typeColor }]}>
                    ...
                    {/* Data */}
                    <Text style={styles.timestamp}>{formatFullDate(new Date(notification.createdAt))}</Text>
                ...
                <View style={styles.actionsContainer}>
                    ...
                    {/* Botao compartilhar */}
                    <TouchableOpacity style={styles.secondaryButton} onPress={handleShare} accessibilityRole="button">
