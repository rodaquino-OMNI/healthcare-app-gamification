        ...
        ({ item }: { item: MedicationReminder }) => (
            <ReminderCard testID={`reminder-card-${item.id}`}>
                ...
                <ActionColumn>
                    ...
                    >
                        <TakeButtonText>{t('home.medicationReminders.takeNow')}</TakeButtonText>
                    </TakeButton>
                    <SkipButton
    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderTitle accessibilityRole="header" testID="med-reminders-title">
            ...
            <SectionHeader>
                <SectionTitle>{t('home.medicationReminders.upcoming')}</SectionTitle>
                <ViewAllButton
                ...
                >
                    <ViewAllText>{t('home.medicationReminders.viewAll')}</ViewAllText>
                </ViewAllButton>
            </SectionHeader>
            ...
            {reminders.length === 0 ? (
                <EmptyContainer testID="med-reminders-empty">
                    ...
                    <EmptyTitle>{t('home.medicationReminders.emptyTitle')}</EmptyTitle>
                    <EmptyDescription>{t('home.medicationReminders.emptyDescription')}</EmptyDescription>
                </EmptyContainer>
            ) : (
                <FlatList
                    data={reminders}
