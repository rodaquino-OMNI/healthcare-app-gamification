      ...
      <AppointmentCard testID={`appointment-card-${item.id}`}>
        <CardTopRow>
          ...
          {item.isTelemedicine && (
            <TelemedicineBadge>
              <BadgeText>
                {t('home.appointmentWidget.telemedicine')}
              </BadgeText>
            </TelemedicineBadge>
          )}
        </CardTopRow>
    ...
    <Container>
      <Header>
        ...
        <HeaderTitle
          ...
          testID="appointment-widget-title"
        >
      ...
      <SectionHeader>
        <SectionTitle>
          {t('home.appointmentWidget.upcoming')}
        </SectionTitle>
        <SeeAllButton
        ...
        >
          <SeeAllText>
            {t('home.appointmentWidget.seeAll')}
          </SeeAllText>
        </SeeAllButton>
      </SectionHeader>
      ...
      {MOCK_APPOINTMENTS.length === 0 ? (
        <EmptyContainer testID="appointment-widget-empty">
          ...
          <EmptyTitle>
            {t('home.appointmentWidget.emptyTitle')}
          </EmptyTitle>
          <EmptyDescription>
            {t('home.appointmentWidget.emptyDescription')}
          </EmptyDescription>
        </EmptyContainer>
      ) : (
        <FlatList
