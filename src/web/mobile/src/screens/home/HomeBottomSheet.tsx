...
export const HomeBottomSheet: React.FC<HomeBottomSheetProps> = ({ onClose }) => {
    ...
    return (
        ...
        >
            <SheetContainer onStartShouldSetResponder={() => true} onResponderRelease={() => {}}>
                <DragHandle />
                <SheetTitle accessibilityRole="header" testID="bottom-sheet-title">
                ...
                {QUICK_ACTIONS.map((action) => (
                    ...
                    >
                        <ActionIconCircle bgColor={action.bgColor}>
                            <ActionIcon accessibilityElementsHidden>{action.icon}</ActionIcon>
                        </ActionIconCircle>
