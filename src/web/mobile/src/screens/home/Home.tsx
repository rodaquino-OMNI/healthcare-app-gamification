...
const HomeScreen: React.FC = () => {
    ...
    const METRIC_SUMMARIES_LOCAL: MetricSummary[] = [
        {
            id: 'hr',
            name: t('homeWidgets.weeklySummary.heartRate'),
            value: '72',
            unit: 'bpm',
            trend: t('homeWidgets.weeklySummary.stable'),
            icon: '\u2764\uFE0F',
        },
        {
            id: 'steps',
            name: t('homeWidgets.weeklySummary.steps'),
            value: '8.432',
            unit: t('homeWidgets.weeklySummary.stepsUnit'),
            trend: t('homeWidgets.weeklySummary.rising'),
            icon: '\uD83D\uDEB6',
        },
        {
            id: 'sleep',
            name: t('homeWidgets.weeklySummary.sleep'),
            value: '7.5',
            unit: 'h',
            trend: t('homeWidgets.weeklySummary.rising'),
            icon: '\uD83C\uDF19',
        ...
        {
            id: 'bp',
            name: t('homeWidgets.weeklySummary.bloodPressure'),
            value: '120/80',
            unit: 'mmHg',
            trend: t('homeWidgets.weeklySummary.stable'),
            icon: '\uD83E\uDE7A',
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <GoalsSection goals={GOALS_LOCAL} completedLabel={t('homeWidgets.weeklySummary.completed')} />
