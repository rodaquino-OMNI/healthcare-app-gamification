...
export const Error404Screen: React.FC = () => {
    ...
    const handleGoHome = (): void => {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment -- navigation types are complex; ts-expect-error would fail when types resolve correctly
        // @ts-expect-error - navigation.navigate expects specific route names
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.message}>{t('errorScreens.notFound.message')}</Text>
            <TouchableOpacity
...
export const ErrorTimeoutScreen: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.message}>{t('errorScreens.timeout.message')}</Text>
            {onRetry && (
                <TouchableOpacity
                    style={styles.primaryButton}
                    onPress={onRetry}
