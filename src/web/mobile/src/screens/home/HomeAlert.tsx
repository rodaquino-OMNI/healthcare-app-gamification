...
const MOCK_ALERTS: HealthAlert[] = [
    {
        ...
        description: 'Sua pressao arterial esta acima do normal nas ultimas 3 medicoes.',
    ...
    },
    {
        ...
        description: 'Voce esta a 1.568 passos de completar sua meta diaria.',
    ...
    },
    {
        ...
        description: 'Voce nao registrou a tomada do medicamento de hoje.',
...
export const HomeAlertScreen: React.FC = () => {
        ...
        (action: string) => {
            const actionRouteMap: Record<string, () => void> = {
                HEALTH_METRIC_DETAIL: () =>
                    navigation.navigate('Health', { screen: 'HealthMetricDetail', params: { metricType: '' } }),
    ...
    const visibleAlerts = MOCK_ALERTS.filter((alert) => !dismissed.has(alert.id));
