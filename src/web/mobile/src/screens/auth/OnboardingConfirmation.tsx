    ...
    <Container>
      ...
      >
        <ContentWrapper>
          ...
          {/* Title & Subtitle */}
          <Title testID="onboarding-confirmation-title">
          ...
          <SummaryCard testID="onboarding-confirmation-summary">
            <SummaryTitle>
              {t('onboarding.confirmation.summaryTitle')}
            </SummaryTitle>
            {MOCK_SELECTED_GOALS.map((goal, index) => {
              ...
              return (
                <Row key={goal.key}>
                  ...
                  <SummaryLabel>
                    {t(`onboarding.goalSelection.goals.${goal.key}.title`)}
                  </SummaryLabel>
                  <SummaryBadge>
                    <SummaryBadgeText>
                      {t('onboarding.confirmation.selected')}
                    </SummaryBadgeText>
                  </SummaryBadge>
                </Row>
              );
          ...
          >
            <PrimaryButtonText>
              {t('onboarding.confirmation.startApp')}
            </PrimaryButtonText>
          </PrimaryButton>

          <CelebrationText>
            {t('onboarding.confirmation.celebration')}
          </CelebrationText>
        </ContentWrapper>
      </ScrollView>
    </Container>
