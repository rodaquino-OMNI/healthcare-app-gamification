...
jest.mock('styled-components/native', () => {
  ...
  styled.ScrollView = (strs: any) => (props: any) => <RN.ScrollView {...props} />;
  return { __esModule: true, default: styled, useTheme: () => ({ colors: { background: { default: '#fff' }, text: { default: '#000', muted: '#888', subtle: '#ccc', onBrand: '#fff' } } }) };
});
