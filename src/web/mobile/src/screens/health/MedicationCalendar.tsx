...
export const MedicationCalendar: React.FC = () => {
    ...
    const doses = useMemo(() => MOCK_SCHEDULE[selectedDate] ?? [], [selectedDate]);
    ...
    const renderDoseItem = useCallback(({ item }: ListRenderItemInfo<DoseSlot>) => {
        ...
        return (
            <Card journey="health" elevation="sm" padding="md">
                <View style={styles.doseRow}>
                    ...
                    <Badge variant="status" status={badgeConfig.badgeStatus} accessibilityLabel={badgeConfig.label}>
                        {badgeConfig.label}
                    </Badge>
                </View>
            </Card>
