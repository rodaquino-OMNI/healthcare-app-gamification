...
export const MedicationPrescriptionPhoto: React.FC = () => {
    ...
    const handleTakePhoto = useCallback(() => {
        Alert.alert(t('medication.prescriptionPhoto.cameraTitle'), t('medication.prescriptionPhoto.cameraMessage'), [
            { text: t('medication.prescriptionPhoto.ok') },
        ]);
    }, [t]);

    const handleChooseGallery = useCallback(() => {
        Alert.alert(t('medication.prescriptionPhoto.galleryTitle'), t('medication.prescriptionPhoto.galleryMessage'), [
            { text: t('medication.prescriptionPhoto.ok') },
        ]);
    }, [t]);
