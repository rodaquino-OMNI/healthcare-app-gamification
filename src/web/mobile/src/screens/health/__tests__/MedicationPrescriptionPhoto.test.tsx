...
import { MedicationPrescriptionPhoto } from '../MedicationPrescriptionPhoto';

describe('MedicationPrescriptionPhoto', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<MedicationPrescriptionPhoto />);
