...
type VideoPlayerNavigationProp = StackNavigationProp<WellnessResourcesParamList, 'HealthWellnessResourcesVideoPlayer'>;
type VideoPlayerRouteProp = RouteProp<WellnessResourcesParamList, 'HealthWellnessResourcesVideoPlayer'>;
...
export const VideoPlayer: React.FC = () => {
    ...
    const { videoId: _videoId } = route.params;
            ...
            >
                ...
                >
                    <View style={styles.videoPlaceholder}>
                        <Ionicons name="play-circle" size={64} color={colors.neutral.white} />
                ...
                <View style={styles.infoSection}>
                    ...
                    <View style={styles.metaRow}>
                        <Ionicons name="person-outline" size={14} color={colors.gray[50]} />
                        <Text fontSize="sm" color={colors.gray[50]}>
                            {currentVideo.author}
                        </Text>
                        <View style={styles.metaDot} />
                        <Ionicons name="pricetag-outline" size={14} color={colors.gray[50]} />
                        <Text fontSize="sm" color={colors.gray[50]}>
                ...
                <View style={styles.actionRow}>
                    ...
                    >
                        <View style={styles.actionButton}>
                            <Ionicons name="share-outline" size={22} color={colors.journeys.health.primary} />
                            ...
                            >
                                <View style={styles.relatedCard}>
                                    <View style={styles.relatedThumbnail}>
                                        <Ionicons name="play-circle-outline" size={28} color={colors.neutral.white} />
                                    </View>
                                    <View style={styles.relatedInfo}>
                                        ...
                                        <View style={styles.relatedDurationRow}>
                                            <Ionicons name="time-outline" size={12} color={colors.gray[40]} />
