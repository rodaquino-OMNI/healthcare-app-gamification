...
import { WellnessBookmarks } from '../WellnessBookmarks';
import { WellnessPrograms } from '../WellnessPrograms';
import { WellnessResourcesHome } from '../WellnessResourcesHome';

describe('WellnessResourcesHome', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<WellnessResourcesHome />);
...
describe('ArticleList', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ArticleList />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ArticleDetail', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ArticleDetail />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('VideoLibrary', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<VideoLibrary />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('VideoPlayer', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<VideoPlayer />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('WellnessPrograms', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<WellnessPrograms />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ProgramDetail', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ProgramDetail />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('WellnessBookmarks', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<WellnessBookmarks />);
        expect(toJSON()).toBeTruthy();
    });
});
