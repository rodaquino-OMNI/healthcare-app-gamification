...
const MOCK_BOOKMARKS: BookmarkedItem[] = [
    {
        ...
        summary:
            'Discover evidence-based strategies to improve your sleep quality and establish a healthy bedtime routine.',
        type: 'article',
    },
    {
        id: 'bm-2',
                ...
                <Card journey="health" elevation="sm" padding="md">
                    <View style={styles.itemRow}>
                        ...
                        <View style={styles.iconContainer}>
                            <Ionicons name={icon} size={24} color={colors.journeys.health.primary} />
                        </View>
                        ...
                        <View style={styles.itemContent}>
                            ...
                            <Text fontSize="sm" color={colors.gray[50]} numberOfLines={2}>
                                {item.summary}
                            </Text>
                        </View>
    ...
    const renderEmpty = useCallback(
        () => (
            <View style={styles.emptyContainer}>
                <Ionicons name="bookmark-outline" size={56} color={colors.gray[30]} />
