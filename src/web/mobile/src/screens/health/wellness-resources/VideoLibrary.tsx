...
export const VideoLibrary: React.FC = () => {
            ...
            >
                <View style={styles.videoCard}>
                    ...
                    <View style={styles.thumbnailContainer}>
                        <Ionicons name="videocam-outline" size={28} color={colors.journeys.health.primary} />
                        <View style={styles.playOverlay}>
                            <Ionicons name="play-circle-outline" size={36} color={colors.neutral.white} />
                        </View>
                        {/* Duration Badge */}
    ...
    const renderEmpty = useCallback(
        () => (
            <View style={styles.emptyContainer}>
                <Ionicons name="videocam-off-outline" size={48} color={colors.gray[30]} />
    ...
    const _renderColumnWrapper = useCallback(
        ({ children }: { children: React.ReactNode }) => <View style={styles.columnWrapper}>{children}</View>,
        []
    );
                    ...
                    return (
                        ...
                        >
                            <Text
                                ...
                                color={isActive ? colors.neutral.white : colors.gray[60]}
                            >
                                {t(filter.labelKey)}
                            </Text>
                        </Touchable>
