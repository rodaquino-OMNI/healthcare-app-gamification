        ...
        <>
            ...
            {snoozeEnabled && (
                <View style={styles.snoozeOptionsRow}>
                    <Text style={styles.snoozeOptionLabel}>
                        {t('journeys.health.medication.reminder.snoozeDuration')}:
                    </Text>
...
export const ReminderPreview: React.FC<ReminderPreviewProps> = ({
    ...
    return (
        <View style={[styles.previewCard, { borderLeftColor: journeyColors.primary }]}>
            ...
            {medicationDosage ? <Text style={styles.previewDosage}>{medicationDosage}</Text> : null}
            <View style={styles.previewTimeRow}>
                <Text style={[styles.previewTime, { color: journeyColors.primary }]}>{time}</Text>
