...
const MOCK_TRENDS: TrendMetric[] = [
  ...
  { id: 'consistency', labelKey: 'journeys.health.sleep.insights.trendConsistency', value: '78%', trend: 'declining' },
];
              ...
              return (
                <View key={metric.id}>
                  <View
                    ...
                    testID={`sleep-insights-trend-${metric.id}`}
                  >
                    ...
                    <View style={[styles.trendArrow, { backgroundColor: trendConfig.color + '20' }]}>
                      <Ionicons
