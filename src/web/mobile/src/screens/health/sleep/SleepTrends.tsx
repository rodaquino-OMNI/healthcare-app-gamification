...
const SLEEP_STAGES: SleepStage[] = [
  { id: 'deep', labelKey: 'journeys.health.sleep.trends.deep', percentage: 25, color: colors.journeys.health.secondary },
  { id: 'light', labelKey: 'journeys.health.sleep.trends.light', percentage: 45, color: colors.journeys.health.primary },
...
export const SleepTrends: React.FC = () => {
  ...
  const trendStats: TrendStat[] = useMemo(
    () => [
      { id: 'avg-time', labelKey: 'journeys.health.sleep.trends.avgSleepTime', value: `${avgHours}h`, color: colors.journeys.health.primary },
      { id: 'avg-score', labelKey: 'journeys.health.sleep.trends.avgScore', value: `${avgScore}`, color: colors.journeys.health.primary },
      { id: 'best', labelKey: 'journeys.health.sleep.trends.bestNight', value: bestNight, color: colors.semantic.success },
      { id: 'worst', labelKey: 'journeys.health.sleep.trends.worstNight', value: worstNight, color: colors.semantic.warning },
    ],
  ...
  const totalStageWidth = useMemo(
    () => SLEEP_STAGES.reduce((sum, s) => sum + s.percentage, 0),
    [],
  );
