...
const DATA_SOURCE_OPTIONS: {
    ...
    {
        id: 'apple_health',
        labelKey: 'journeys.health.sleep.device.sourceAppleHealth',
        descKey: 'journeys.health.sleep.device.sourceAppleHealthDesc',
        icon: 'heart-outline',
    },
    {
        id: 'fitbit',
        labelKey: 'journeys.health.sleep.device.sourceFitbit',
        descKey: 'journeys.health.sleep.device.sourceFitbitDesc',
        icon: 'watch-outline',
    },
    {
        id: 'manual',
        labelKey: 'journeys.health.sleep.device.sourceManual',
        descKey: 'journeys.health.sleep.device.sourceManualDesc',
        icon: 'create-outline',
    },
];
...
export const SleepDeviceSync: React.FC = () => {
    ...
    const handleSync = useCallback(() => {
        Alert.alert(t('journeys.health.sleep.device.syncTitle'), t('journeys.health.sleep.device.syncMessage'));
    }, [t]);
