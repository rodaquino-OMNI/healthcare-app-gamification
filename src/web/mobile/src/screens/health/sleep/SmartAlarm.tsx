...
const SOUND_OPTIONS: { id: SoundLevel; labelKey: string; descKey: string; icon: keyof typeof Ionicons.glyphMap }[] = [
  { id: 'gentle', labelKey: 'journeys.health.sleep.alarm.soundGentle', descKey: 'journeys.health.sleep.alarm.soundGentleDesc', icon: 'musical-note-outline' },
  { id: 'moderate', labelKey: 'journeys.health.sleep.alarm.soundModerate', descKey: 'journeys.health.sleep.alarm.soundModerateDesc', icon: 'musical-notes-outline' },
  { id: 'strong', labelKey: 'journeys.health.sleep.alarm.soundStrong', descKey: 'journeys.health.sleep.alarm.soundStrongDesc', icon: 'volume-high-outline' },
];
...
export const SmartAlarm: React.FC = () => {
  ...
  const handleSave = useCallback(() => {
    Alert.alert(
      t('journeys.health.sleep.alarm.savedTitle'),
      t('journeys.health.sleep.alarm.savedMessage'),
    );
  }, [t]);
