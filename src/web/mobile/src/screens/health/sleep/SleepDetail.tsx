...
const MOCK_ENVIRONMENT: EnvironmentReading[] = [
  { id: 'env-temp', icon: 'thermometer-outline', labelKey: 'journeys.health.sleep.detail.temperature', value: '21°C' },
  { id: 'env-humidity', icon: 'water-outline', labelKey: 'journeys.health.sleep.detail.humidity', value: '45%' },
  { id: 'env-noise', icon: 'volume-medium-outline', labelKey: 'journeys.health.sleep.detail.noiseLevel', value: '32 dB' },
];
...
export const SleepDetail: React.FC = () => {
  ...
  const scoreColor = useMemo(() => {
    if (MOCK_SCORE >= 80) return colors.semantic.success;
    if (MOCK_SCORE >= 60) return colors.semantic.warning;
