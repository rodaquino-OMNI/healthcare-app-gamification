...
export const SleepQuality: React.FC = () => {
    ...
    const handleSave = useCallback(() => {
        Alert.alert(t('journeys.health.sleep.quality.savedTitle'), t('journeys.health.sleep.quality.savedMessage'), [
                                    ...
                                    <Card journey="health" elevation="sm" padding="md">
                                        ...
                                        >
                                            ...
                                            <Text
                                                fontSize="sm"
                                                fontWeight={isSelected ? 'semiBold' : 'regular'}
                                                color={isSelected ? colors.journeys.health.primary : colors.gray[60]}
                                            >
                                                {t(factor.labelKey)}
                                            </Text>
                                        </View>
