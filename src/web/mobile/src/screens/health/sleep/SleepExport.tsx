...
export const SleepExport: React.FC = () => {
    ...
    const handleShare = useCallback(() => {
        Alert.alert(t('journeys.health.sleep.export.shareTitle'), t('journeys.health.sleep.export.shareMessage'));
    }, [t]);
                                    ...
                                    <View style={styles.radioRow}>
                                        ...
                                        <View style={styles.formatInfo}>
                                            ...
                                            <Text fontSize="sm" color={colors.gray[50]}>
                                                {t(
                                                    `journeys.health.sleep.export.formatDesc${fmt === 'pdf' ? 'Pdf' : 'Csv'}`
                                                )}
                                            </Text>
                                        </View>
                                    </View>
