...
export const MedicationAlarmScreen: React.FC = () => {
     ...
     */
    const handleTakeNow = async (): Promise<void> => {
        try {
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.content}>
                ...
                <View style={styles.actionsContainer}>
                    ...
                    <View
                        style={[styles.actionButton, styles.takeNowButton, { backgroundColor: journeyColors.primary }]}
                    >
                    ...
                    <View style={[styles.actionButton, styles.snoozeButton, { borderColor: journeyColors.secondary }]}>
                        <Text style={[styles.snoozeText, { color: journeyColors.secondary }]} onPress={handleSnooze}>
                ...
                {nextDoseTime ? (
                    <View style={styles.nextDoseContainer}>
                        ...
                        <Text style={[styles.nextDoseTime, { color: journeyColors.primary }]}>{nextDoseTime}</Text>
                    </View>
                ) : null}
            </View>
        </SafeAreaView>
