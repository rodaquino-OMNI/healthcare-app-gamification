...
export const MedicationPharmacyLocator: React.FC = () => {
  ...
  const handleGetDirections = useCallback((pharmacy: Pharmacy) => {
    Alert.alert(
  ...
  const handleCall = useCallback((pharmacy: Pharmacy) => {
    ...
    Linking.canOpenURL(phoneUrl).then((supported) => {
      if (supported) {
        ...
        Alert.alert(
          t('medication.pharmacyLocator.callTitle'),
          pharmacy.phone,
        );
      }
    });
      ...
      <Card journey="health" elevation="sm" padding="md">
        <View style={styles.pharmacyHeader}>
          ...
          <Badge
            ...
            accessibilityLabel={
              item.isOpen
                ? t('medication.pharmacyLocator.open')
                : t('medication.pharmacyLocator.closed')
            }
          >
            {item.isOpen
              ? t('medication.pharmacyLocator.open')
