    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.circleContainer} testID="overall-score-display">
                <View style={[styles.circleOuter, { borderColor: getScoreColor(overallScore) }]}>
                    <View style={styles.circleInner}>
                        <Text fontSize="heading-xl" fontWeight="bold" color={colors.brand.primary} textAlign="center">
                            {String(overallScore)}
                        </Text>
            ...
            {/* Category Breakdown */}
            <Text fontSize="md" fontWeight="semiBold" color={colors.journeys.health.text} style={styles.breakdownTitle}>
            ...
            {CATEGORIES.map((cat) => {
                ...
                return (
                    <Card key={cat.key} journey="health" elevation="sm" padding="md" style={styles.categoryCard}>
            ...
            <View style={styles.ctaContainer}>
                ...
                >
                    <Text fontSize="md" fontWeight="semiBold" color={colors.journeys.health.primary} textAlign="center">
