                    ...
                    <View style={styles.severityRow}>
                        {SEVERITY_RANGE.map((level) => {
                            ...
                            return (
                                <Touchable
                                    key={level}
                                    onPress={() => onUpdate('painSeverity', level)}
                                    accessibilityLabel={t('healthAssessment.chronicPain.severityLevel', {
                                        level: String(level),
                                    })}
                                    accessibilityRole="button"
                    ...
                    <View style={styles.optionList}>
                        {PAIN_FREQUENCY.map((freq) => {
                            ...
                            return (
                                <Touchable
                                    key={freq}
                                    onPress={() => onUpdate('painFrequency', freq)}
                    ...
                    <View style={styles.chipGrid}>
                        {PAIN_IMPACT.map((impact) => {
                            ...
                            return (
                                <Touchable
                                    key={impact}
                                    onPress={() => onUpdate('painImpact', impact)}
