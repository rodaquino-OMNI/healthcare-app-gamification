...
const showSmokingDetails = (status: string | undefined): boolean =>
  status === 'current' || status === 'former';

const showAlcoholDetails = (frequency: string | undefined): boolean =>
  frequency !== undefined && frequency !== 'never';
  ...
  return (
    ...
    >
      ...
      {showSmokingDetails(data.smokingStatus) && (
        <>
          <Text fontSize="md" fontWeight="medium" color={colors.neutral.gray700} style={styles.subSectionTitle}>
