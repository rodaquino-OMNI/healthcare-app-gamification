...
const STRESS_SOURCES = ['work', 'finances', 'relationships', 'health', 'family', 'other'] as const;

const COPING_MECHANISMS = ['exercise', 'meditation', 'therapy', 'hobbies', 'socialSupport'] as const;
