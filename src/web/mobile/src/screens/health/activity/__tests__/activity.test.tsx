...
import { ActivityDeviceSync } from '../ActivityDeviceSync';
...
describe('ActivityHome', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ActivityHome />);
...
describe('WorkoutLog', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<WorkoutLog />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('WorkoutDetail', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<WorkoutDetail />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ActivityTrends', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ActivityTrends />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ExerciseDetail', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ExerciseDetail />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ActivityDeviceSync', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ActivityDeviceSync />);
        expect(toJSON()).toBeTruthy();
    });
});
...
describe('ActivityExport', () => {
    it('renders without crashing', () => {
        const { toJSON } = render(<ActivityExport />);
        expect(toJSON()).toBeTruthy();
    });
});
