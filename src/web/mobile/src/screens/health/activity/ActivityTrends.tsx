...
const MOCK_MONTH_COMPARISONS: MonthComparison[] = [
  { id: 'cmp-steps', labelKey: 'journeys.health.activity.trends.totalSteps', thisMonth: '245,800', lastMonth: '218,400', trend: 'up' },
  { id: 'cmp-calories', labelKey: 'journeys.health.activity.trends.totalCalories', thisMonth: '9,620', lastMonth: '10,150', trend: 'down' },
  { id: 'cmp-active', labelKey: 'journeys.health.activity.trends.activeDaysLabel', thisMonth: '22', lastMonth: '19', trend: 'up' },
  { id: 'cmp-distance', labelKey: 'journeys.health.activity.trends.totalDistance', thisMonth: '187 km', lastMonth: '165 km', trend: 'up' },
];
...
export const ActivityTrends: React.FC = () => {
  ...
  const trendStats: TrendStat[] = useMemo(
    () => [
      { id: 'avg-steps', labelKey: 'journeys.health.activity.trends.avgSteps', value: avgSteps, color: colors.journeys.health.primary },
      { id: 'avg-cal', labelKey: 'journeys.health.activity.trends.avgCalories', value: avgCalories, color: colors.journeys.health.primary },
      { id: 'best-day', labelKey: 'journeys.health.activity.trends.bestDay', value: bestDay, color: colors.semantic.success },
      { id: 'active-days', labelKey: 'journeys.health.activity.trends.activeDays', value: activeDays, color: colors.semantic.info },
    ],
          ...
          <Card journey="health" elevation="sm" padding="md">
            {MOCK_MONTH_COMPARISONS.map((cmp, index) => (
              <View key={cmp.id}>
                <View style={styles.comparisonRow}>
                  ...
                  <View style={styles.comparisonValues}>
                    ...
                    <Ionicons
                      ...
                      size={16}
                      color={cmp.trend === 'up' ? colors.semantic.success : colors.semantic.warning}
                    />
                ...
                {index < MOCK_MONTH_COMPARISONS.length - 1 && (
