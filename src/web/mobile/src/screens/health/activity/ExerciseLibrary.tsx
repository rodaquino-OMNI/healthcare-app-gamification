...
const MOCK_EXERCISES: Exercise[] = [
    {
        id: 'ex-1',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.running',
        category: 'cardio',
        difficulty: 'medium',
    ...
    {
        id: 'ex-2',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.cycling',
        category: 'cardio',
        difficulty: 'medium',
    ...
    {
        id: 'ex-3',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.walking',
        category: 'cardio',
        difficulty: 'easy',
        icon: 'walk-outline',
    },
    {
        id: 'ex-4',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.squats',
        category: 'strength',
        difficulty: 'medium',
    ...
    {
        id: 'ex-5',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.pushups',
        category: 'strength',
        difficulty: 'hard',
        icon: 'body-outline',
    },
    {
        id: 'ex-6',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.deadlift',
        category: 'strength',
        difficulty: 'hard',
        icon: 'barbell-outline',
    },
    {
        id: 'ex-7',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.yoga',
    ...
    {
        id: 'ex-8',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.stretching',
        category: 'flexibility',
        difficulty: 'easy',
        icon: 'body-outline',
    },
    {
        id: 'ex-9',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.taiChi',
        category: 'balance',
        difficulty: 'medium',
        icon: 'body-outline',
    },
    {
        id: 'ex-10',
        nameKey: 'journeys.health.activity.exerciseLibrary.exercises.singleLegStand',
        category: 'balance',
        difficulty: 'easy',
        icon: 'body-outline',
    },
                ...
                <Card journey="health" elevation="sm" padding="md">
                    <View style={styles.exerciseRow}>
                        <View style={styles.exerciseIconContainer}>
                            <Ionicons name={item.icon} size={24} color={colors.journeys.health.primary} />
                        </View>
                        <View style={styles.exerciseInfo}>
                            ...
                            <Text fontSize="xs" color={colors.gray[40]}>
                                {t(
                                    `journeys.health.activity.exerciseLibrary.category${item.category.charAt(0).toUpperCase()}${item.category.slice(1)}`
                                )}
                            </Text>
                        </View>
                        <View style={[styles.difficultyBadge, { backgroundColor: DIFFICULTY_COLORS[item.difficulty] }]}>
                            <Text fontSize="xs" fontWeight="semiBold" color={colors.gray[0]}>
                                {t(
                                    `journeys.health.activity.exerciseLibrary.difficulty${item.difficulty.charAt(0).toUpperCase()}${item.difficulty.slice(1)}`
                                )}
                            </Text>
                        </View>
                    </View>
    ...
    const renderEmpty = useCallback(
        () => (
            <View style={styles.emptyState}>
                <Ionicons name="search-outline" size={40} color={colors.gray[30]} />
                ...
                {CATEGORY_FILTERS.map((filter) => (
                    ...
                    >
                        <Text
                            ...
                            color={selectedCategory === filter.id ? colors.journeys.health.primary : colors.gray[50]}
                        >
                            {t(filter.labelKey)}
                        </Text>
                    </Touchable>
