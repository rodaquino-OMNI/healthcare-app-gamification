...
export const ActivityExport: React.FC = () => {
  ...
  const handleShare = useCallback(() => {
    Alert.alert(
      t('journeys.health.activity.export.shareTitle'),
      t('journeys.health.activity.export.shareMessage'),
    );
  }, [t]);
                  ...
                  <View style={styles.radioRow}>
                    ...
                    <View style={styles.formatInfo}>
                      ...
                      <Text fontSize="sm" color={colors.gray[50]}>
                        {t(`journeys.health.activity.export.formatDesc${fmt === 'pdf' ? 'Pdf' : 'Csv'}`)}
                      </Text>
                    </View>
                  </View>
                </Card>
