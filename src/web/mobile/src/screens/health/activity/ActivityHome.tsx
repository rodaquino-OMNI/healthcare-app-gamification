            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <Card journey="health" elevation="md" padding="md">
                    <View style={styles.stepRingContainer} testID="activity-home-step-ring">
                        <View style={[styles.stepRingOuter, { borderColor: getStepColor(currentSteps, STEP_GOAL) }]}>
                            <View style={styles.stepRingInner}>
                                <Ionicons name="footsteps-outline" size={20} color={colors.journeys.health.primary} />
                                <Text
