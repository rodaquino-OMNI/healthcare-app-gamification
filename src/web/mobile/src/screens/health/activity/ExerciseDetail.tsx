...
export const ExerciseDetail: React.FC = () => {
  ...
  const difficultyColor = useMemo(
    () => DIFFICULTY_COLORS[MOCK_EXERCISE.difficulty] || colors.gray[40],
    [],
  );
          ...
          <View style={styles.badgeRow}>
            ...
            >
              <Text fontSize="xs" fontWeight="semiBold" color={colors.gray[0]}>
                {t(`journeys.health.activity.exerciseDetail.difficulty${MOCK_EXERCISE.difficulty.charAt(0).toUpperCase()}${MOCK_EXERCISE.difficulty.slice(1)}`)}
              </Text>
            </View>
          </View>
        </View>
