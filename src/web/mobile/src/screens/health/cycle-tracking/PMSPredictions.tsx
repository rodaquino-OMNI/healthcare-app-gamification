...
export const PMSPredictions: React.FC = () => {
  ...
  const sortedPredictions = useMemo(
    () => [...MOCK_PREDICTIONS].sort((a, b) => b.probability - a.probability),
    [],
  );

  const renderSymptomItem = ({ item }: ListRenderItemInfo<PredictedSymptom>) => {
            ...
            <View style={styles.sectionContainer}>
              ...
              <View style={styles.legendRow}>
                <View style={styles.legendItem}>
                  <View
                    style={[styles.legendDot, { backgroundColor: colors.journeys.community.primary }]}
                  />
                  <Text fontSize="xs" color={colors.gray[50]}>
                ...
                <View style={styles.legendItem}>
                  <View
                    style={[styles.legendDot, { backgroundColor: colors.journeys.community.accent }]}
                  />
                  <Text fontSize="xs" color={colors.gray[50]}>
