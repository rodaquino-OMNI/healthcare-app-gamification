...
const MOCK_CYCLES: CycleRecord[] = [
  { id: 'c-1', startDate: '2026-02-14', endDate: '2026-02-18', length: 28, periodDays: 5, flowSummary: 'Medium', trend: 'same' },
  { id: 'c-2', startDate: '2026-01-17', endDate: '2026-01-22', length: 28, periodDays: 6, flowSummary: 'Heavy', trend: 'same' },
  { id: 'c-3', startDate: '2025-12-20', endDate: '2025-12-24', length: 27, periodDays: 5, flowSummary: 'Medium', trend: 'shorter' },
  { id: 'c-4', startDate: '2025-11-22', endDate: '2025-11-27', length: 29, periodDays: 6, flowSummary: 'Heavy', trend: 'longer' },
  { id: 'c-5', startDate: '2025-10-24', endDate: '2025-10-28', length: 28, periodDays: 5, flowSummary: 'Medium', trend: 'same' },
  { id: 'c-6', startDate: '2025-09-26', endDate: '2025-09-30', length: 30, periodDays: 5, flowSummary: 'Light', trend: 'longer' },
  { id: 'c-7', startDate: '2025-08-27', endDate: '2025-08-31', length: 27, periodDays: 5, flowSummary: 'Medium', trend: 'shorter' },
  { id: 'c-8', startDate: '2025-07-31', endDate: '2025-08-04', length: 28, periodDays: 5, flowSummary: 'Medium', trend: 'same' },
  { id: 'c-9', startDate: '2025-07-03', endDate: '2025-07-07', length: 29, periodDays: 5, flowSummary: 'Heavy', trend: 'longer' },
  { id: 'c-10', startDate: '2025-06-04', endDate: '2025-06-08', length: 28, periodDays: 5, flowSummary: 'Medium', trend: 'same' },
  { id: 'c-11', startDate: '2025-05-07', endDate: '2025-05-11', length: 27, periodDays: 5, flowSummary: 'Light', trend: 'shorter' },
  { id: 'c-12', startDate: '2025-04-10', endDate: '2025-04-14', length: 28, periodDays: 5, flowSummary: 'Medium', trend: 'same' },
];
...
export const CycleHistory: React.FC = () => {
  ...
  const regularityConfig = useMemo(
    () => REGULARITY_CONFIG[MOCK_REGULARITY],
    [],
  );
