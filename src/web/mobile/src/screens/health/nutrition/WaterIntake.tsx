...
export const WaterIntake: React.FC = () => {
    ...
    const fillPercent = useMemo(() => Math.min(currentIntake / DAILY_GOAL, 1), [currentIntake]);
    ...
    const handleAddGlasses = useCallback(
        (count: number) => {
            ...
            setHistory((prev) => [{ id: String(Date.now()), time: timeStr, glasses: count }, ...prev.slice(0, 4)]);
        },
        [currentIntake]
    );
                            ...
                            <View
                                style={[
                                    styles.ringFill,
                                    {
                                        ...
                                        backgroundColor:
                                            fillPercent >= 1 ? colors.semantic.success : colors.journeys.health.primary,
                                    },
                                ]}
                            />
                            <View style={styles.ringCenter}>
                                <Ionicons name="water-outline" size={28} color={colors.journeys.health.primary} />
                            ...
                            >
                                <Card journey="health" elevation="sm" padding="md">
                                    <View style={styles.quickAddContent}>
                                        <Ionicons name="water" size={24} color={colors.journeys.health.primary} />
                        ...
                        <Card key={entry.id} journey="health" elevation="sm" padding="md">
                            <View style={styles.historyRow}>
                                ...
                                <View style={styles.historyGlasses}>
                                    <Ionicons name="water-outline" size={16} color={colors.journeys.health.primary} />
