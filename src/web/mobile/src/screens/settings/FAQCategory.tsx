...
const FAQ_ITEMS: FAQItemData[] = [
    {
        ...
        answer: 'Acesse Configuracoes > Seguranca > Alterar Senha. Voce precisara inserir sua senha atual e depois a nova senha. A nova senha deve ter no minimo 8 caracteres, incluindo letras maiusculas e numeros.',
    },
    {
        id: '2',
        question: 'Como exportar meus dados?',
        answer: 'De acordo com a LGPD, voce pode solicitar uma copia dos seus dados. Va em Configuracoes > Dados > Exportar Dados. Selecione as categorias desejadas e o formato (JSON ou PDF). O arquivo sera preparado e disponibilizado para download.',
    },
    {
        id: '3',
        question: 'Como conectar um dispositivo?',
        answer: 'Va em Configuracoes > Dispositivos > Dispositivos Conectados e toque em "Parear Novo Dispositivo". Certifique-se de que o Bluetooth esta ativado e o dispositivo esta no modo de pareamento. Siga as instrucoes na tela para concluir.',
    },
    {
        id: '4',
        question: 'Como agendar uma consulta?',
        answer: 'Acesse a jornada "Cuidar-me Agora" e toque em "Agendar Consulta". Voce pode buscar por especialidade, medico ou local. Selecione o profissional, escolha a data e horario disponiveis, e confirme o agendamento.',
    },
    {
        id: '5',
        question: 'Como solicitar reembolso?',
        answer: 'Va em "Meu Plano" > "Reembolsos" > "Solicitar Reembolso". Preencha o formulario com os dados do atendimento, anexe os comprovantes e envie. Voce pode acompanhar o status da solicitacao a qualquer momento.',
    },
];
...
export const FAQCategoryScreen: React.FC = () => {
    ...
    const handleViewDetail = (item: FAQItemData): void => {
    ...
    const filteredItems = category
        ? FAQ_ITEMS.filter((item) => item.question.toLowerCase().includes(category.toLowerCase()))
        : FAQ_ITEMS;
                        ...
                        filteredItems.map((item) => {
                            ...
                            return (
                                <FAQItem key={item.id}>
                                    ...
                                    {isExpanded && (
                                        <AnswerContainer>
                                            <AnswerText testID={`faq-answer-${item.id}`}>{item.answer}</AnswerText>
                                            <ViewDetailLink
