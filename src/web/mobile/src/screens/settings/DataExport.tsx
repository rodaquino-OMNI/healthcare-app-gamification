...
export const DataExportScreen: React.FC = () => {
    ...
    const handleRequestExport = (): void => {
        ...
        Alert.alert(t('settings.dataExport.request'), t('settings.dataExport.requestConfirm'));
    };
                    ...
                    <StatusSection>
                        ...
                        <StatusRow>
                            ...
                            <StatusBadge status={lastExportStatus}>
                                <StatusBadgeText>{t(`settings.dataExport.status.${lastExportStatus}`)}</StatusBadgeText>
                            </StatusBadge>
                        </StatusRow>
                    </StatusSection>
                </ContentWrapper>
