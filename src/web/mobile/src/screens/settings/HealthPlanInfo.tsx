...
const ActionButton = styled.TouchableOpacity<{ variant?: 'primary' | 'outline' }>`
    ...
    height: ${sizing.component.lg};
    background-color: ${({ variant }) => (variant === 'outline' ? colors.neutral.white : colors.brand.primary)};
    border-radius: ${borderRadius.md};
...
const ActionButtonText = styled.Text<{ variant?: 'primary' | 'outline' }>`
    ...
    font-size: ${typography.fontSize['text-md']};
    font-weight: ${typography.fontWeight.semiBold};
    color: ${({ variant }) => (variant === 'outline' ? colors.brand.primary : colors.neutral.white)};
`;
    ...
    return (
        <Container>
            ...
            >
                ...
                {/* Member Section */}
                <SectionHeader>
                    <SectionHeaderText>{t('settings.healthPlan.memberName')}</SectionHeaderText>
                </SectionHeader>
                ...
                <ActionButton
                    onPress={() =>
                        navigation
                            ...
                            ?.navigate('Plan', { screen: 'DigitalCard' })
                    }
                    accessibilityRole="button"
                    accessibilityLabel={t('settings.healthPlan.viewCard')}
                    testID="health-plan-view-card"
                >
                    <ActionButtonText>{t('settings.healthPlan.viewCard')}</ActionButtonText>
                </ActionButton>
                ...
                >
                    <ActionButtonText variant="outline">{t('settings.healthPlan.viewDocs')}</ActionButtonText>
                </ActionButton>
            </ScrollView>
        </Container>
    );
