...
const FontSizeButton = styled.TouchableOpacity<{ isSelected: boolean }>`
    ...
    background-color: ${({ isSelected }) => (isSelected ? colors.brand.primary : colors.gray[10])};
    border-radius: ${borderRadius.md};
    border-width: 1px;
    border-color: ${({ isSelected }) => (isSelected ? colors.brand.primary : colors.gray[20])};
`;
...
const FontSizeButtonText = styled.Text<{ isSelected: boolean }>`
    ...
    font-weight: ${typography.fontWeight.semiBold};
    color: ${({ isSelected }) => (isSelected ? colors.neutral.white : colors.neutral.gray900)};
`;
    ...
    return (
        <Container>
            ...
            >
                ...
                {/* Font Size Section */}
                <SectionHeader>
                    <SectionHeaderText>{t('settings.accessibility.fontSize')}</SectionHeaderText>
                </SectionHeader>
                ...
                <FontSizeRow>
                    {FONT_SIZES.map((fs) => {
                        ...
                        return (
                            ...
                            >
                                <FontSizeButtonText isSelected={isSelected}>{fs.key}</FontSizeButtonText>
                            </FontSizeButton>
                        );
                    })}
                </FontSizeRow>
                ...
                <PreviewContainer>
                    ...
                    <InfoText style={{ fontSize: currentFontSize?.size ?? 16 }} testID="font-size-preview">
                ...
                {/* Screen Reader Info */}
                <SectionHeader>
                    <SectionHeaderText>{t('settings.accessibility.screenReaderInfo')}</SectionHeaderText>
                </SectionHeader>
