    ...
    <Container>
      ...
      >
        <ContentWrapper>
          ...
          <VersionText testID="about-version">
            {t('settings.aboutApp.version')} 1.0.0
          </VersionText>
          <BuildText testID="about-build">
            {t('settings.aboutApp.build')} 2024.1
          </BuildText>
          ...
          {/* Credits */}
          <CreditsText testID="about-credits">
          ...
          {/* Copyright */}
          <CopyrightText testID="about-copyright">
            {t('settings.aboutApp.copyright')}
          </CopyrightText>
        </ContentWrapper>
      </ScrollView>
    </Container>
