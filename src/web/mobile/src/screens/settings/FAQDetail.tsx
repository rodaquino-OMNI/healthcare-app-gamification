...
const RELATED_ARTICLES = [
    {
        ...
        answer: 'Acesse Configuracoes > Conta > Editar Perfil para alterar seu email cadastrado.',
    },
    {
        id: '2',
        question: 'Como ativar notificacoes?',
        answer: 'Va em Configuracoes > Notificacoes para gerenciar suas preferencias de notificacao.',
    },
    {
        id: '3',
        question: 'Como entrar em contato com suporte?',
        answer: 'Acesse a Central de Ajuda > Fale Conosco para chat, telefone ou email.',
    },
];
...
export const FAQDetailScreen: React.FC = () => {
    ...
    const handleVote = (value: 'yes' | 'no'): void => {
        setVote(value);
    };

    const handleRelatedArticle = (article: { id: string; question: string; answer: string }): void => {
        ...
        <Container>
            ...
            >
                ...
                <HelpfulSection>
                    ...
                    {vote !== null && (
                        <ThankYouText testID="faq-thank-you">{t('help.faqDetail.thankYou')}</ThankYouText>
                    )}
                </HelpfulSection>
