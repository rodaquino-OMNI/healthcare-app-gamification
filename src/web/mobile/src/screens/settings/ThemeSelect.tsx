...
const ThemeCard = styled.TouchableOpacity<{ isSelected: boolean }>`
    ...
    border-width: 2px;
    border-color: ${({ isSelected, theme }) => (isSelected ? theme.colors.brand.primary : theme.colors.border.default)};
`;
        ...
        <Container>
            ...
            >
                ...
                <PreviewContainer bgColor={preview.bg}>
                    <PreviewCardInner cardColor={preview.card} borderColor={preview.border}>
                        <PreviewTitle textColor={preview.text}>AUSTA SuperApp</PreviewTitle>
                        <PreviewSubtext textColor={preview.subtext}>
                            {t('settings.themeSelect.preview')} - {t(`settings.themeSelect.${themeMode}`)}
                        </PreviewSubtext>
                        <PreviewButton>
