...
const StatusBadge = styled.View<{ isEnabled: boolean }>`
    ...
    background-color: ${(props) => (props.isEnabled ? colors.semantic.success : colors.gray[30])};
...
const RadioCircle = styled.View<{ isSelected: boolean }>`
    ...
    border-radius: 10px;
    border-width: 2px;
    border-color: ${(props) => (props.isSelected ? colors.brand.primary : colors.gray[40])};
    align-items: center;
...
export const TwoFactorAuthScreen: React.FC = () => {
    ...
    const handleDisable = (): void => {
        Alert.alert(t('settings.twoFactor.disable'), t('settings.twoFactor.disableConfirm'), [
            ...
            >
                <ContentWrapper>
                    <SectionHeader>
                        ...
                        <SectionDescription>{t('settings.twoFactor.description')}</SectionDescription>
                    </SectionHeader>
                    ...
                    <MasterToggleRow>
                        ...
                        <MasterToggleLabel>{t('settings.twoFactor.title')}</MasterToggleLabel>
                        <Switch
                            value={isEnabled}
                        ...
                        <>
                            ...
                            {method === 'authenticator' && (
                                <DetailSection>
                                    ...
                                    <InstructionsText>{t('settings.twoFactor.qrInstructions')}</InstructionsText>
                                </DetailSection>
                            )}
