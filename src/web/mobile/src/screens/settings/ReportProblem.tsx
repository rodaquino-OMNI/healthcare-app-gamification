...
const CategoryChip = styled.TouchableOpacity<{ isSelected: boolean }>`
    ...
    border-width: 1px;
    border-color: ${(props) => (props.isSelected ? colors.brand.primary : colors.gray[20])};
    background-color: ${(props) => (props.isSelected ? colors.brand.primary + '10' : colors.neutral.white)};
`;
...
const CategoryChipText = styled.Text<{ isSelected: boolean }>`
    ...
    font-size: ${typography.fontSize['text-sm']};
    font-weight: ${typography.fontWeight.medium};
    color: ${(props) => (props.isSelected ? colors.brand.primary : colors.gray[50])};
`;
...
const SubmitButton = styled.TouchableOpacity<{ disabled: boolean }>`
    background-color: ${(props) => (props.disabled ? colors.gray[20] : colors.brand.primary)};
    border-radius: ${borderRadius.md};
    padding-vertical: ${spacing.md};
    align-items: center;
    justify-content: center;
...
export const ReportProblemScreen: React.FC = () => {
    ...
    const handleAttachScreenshot = (): void => {
        Alert.alert(
    ...
    const handleSubmit = (): void => {
        ...
        Alert.alert(t('help.report.submit'), 'Relatorio enviado com sucesso! Obrigado pelo seu feedback.', [
            { text: 'OK' },
        ]);
    };
                ...
                <FormSection>
                    ...
                    <DeviceInfoSection>
                        <DeviceInfoRow>
                            ...
                            <DeviceInfoValue testID="report-device-model">{deviceModel}</DeviceInfoValue>
                        </DeviceInfoRow>
                        <DeviceInfoRow>
                            <DeviceInfoLabel>App</DeviceInfoLabel>
                            <DeviceInfoValue testID="report-app-version">{appVersion}</DeviceInfoValue>
                        </DeviceInfoRow>
                    </DeviceInfoSection>
