...
const CheckboxBox = styled.View<{ checked: boolean }>`
    ...
    border-width: 2px;
    border-color: ${(props) => (props.checked ? colors.semantic.error : colors.gray[40])};
    background-color: ${(props) => (props.checked ? colors.semantic.error : 'transparent')};
    align-items: center;
    justify-content: center;
    margin-right: ${spacing.sm};
`;
            ...
            >
                <ContentWrapper>
                    ...
                    <ConsequencesContainer>
                        <ConsequencesTitle>{t('settings.deleteAccount.consequencesTitle')}</ConsequencesTitle>
