...
const MessageBubble = styled.View<{ isUser: boolean }>`
    ...
    background-color: ${(props) => (props.isUser ? colors.brand.primary : colors.gray[10])};
`;
...
const MessageText = styled.Text<{ isUser: boolean }>`
    ...
    color: ${(props) => (props.isUser ? colors.neutral.white : colors.neutral.gray900)};
    line-height: 22px;
`;
...
const MessageTime = styled.Text<{ isUser: boolean }>`
    font-family: ${typography.fontFamily.body};
    font-size: ${typography.fontSize['text-xs']};
    color: ${(props) => (props.isUser ? 'rgba(255,255,255,0.7)' : colors.gray[40])};
    margin-top: 2px;
    align-self: ${(props) => (props.isUser ? 'flex-end' : 'flex-start')};
`;
            ...
            >
                <Header>
                    <HeaderTitleContainer>
                        <HeaderTitle accessibilityRole="header" testID="live-chat-title">
                            {t('help.chat.title')}
                        </HeaderTitle>
                        <HeaderStatus>
                            <StatusDot />
