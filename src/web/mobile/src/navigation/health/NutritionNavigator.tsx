...
try { const m = require('../../screens/health/nutrition/NutritionHome'); NutritionHomeScreen = m.NutritionHome || m.default || NutritionHomeScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/MealLog'); MealLogScreen = m.MealLog || m.default || MealLogScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/MealDetail'); MealDetailScreen = m.MealDetail || m.default || MealDetailScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/FoodDiary'); FoodDiaryScreen = m.FoodDiary || m.default || FoodDiaryScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/MacroTracker'); MacroTrackerScreen = m.MacroTracker || m.default || MacroTrackerScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/WaterIntake'); WaterIntakeScreen = m.WaterIntake || m.default || WaterIntakeScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/DietaryGoals'); DietaryGoalsScreen = m.DietaryGoals || m.default || DietaryGoalsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/NutritionInsights'); NutritionInsightsScreen = m.NutritionInsights || m.default || NutritionInsightsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/FoodSearch'); FoodSearchScreen = m.FoodSearch || m.default || FoodSearchScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/nutrition/NutritionExport'); NutritionExportScreen = m.NutritionExport || m.default || NutritionExportScreen; } catch { /* not available */ }
