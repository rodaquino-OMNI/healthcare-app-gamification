...
try { const m = require('../../screens/health/cycle-tracking/CycleHome'); CycleHomeScreen = m.CycleHome || m.default || CycleHomeScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleCalendar'); CycleCalendarScreen = m.CycleCalendar || m.default || CycleCalendarScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/LogPeriodStart'); LogPeriodStartScreen = m.LogPeriodStart || m.default || LogPeriodStartScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/LogSymptoms'); LogSymptomsScreen = m.LogSymptoms || m.default || LogSymptomsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/LogFlowIntensity'); LogFlowIntensityScreen = m.LogFlowIntensity || m.default || LogFlowIntensityScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/FertilityWindow'); FertilityWindowScreen = m.FertilityWindow || m.default || FertilityWindowScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/PMSPredictions'); PMSPredictionsScreen = m.PMSPredictions || m.default || PMSPredictionsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleHistory'); CycleHistoryScreen = m.CycleHistory || m.default || CycleHistoryScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleAnalysis'); CycleAnalysisScreen = m.CycleAnalysis || m.default || CycleAnalysisScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleInsights'); CycleInsightsScreen = m.CycleInsights || m.default || CycleInsightsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleArticleDetail'); CycleArticleDetailScreen = m.CycleArticleDetail || m.default || CycleArticleDetailScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleReminders'); CycleRemindersScreen = m.CycleReminders || m.default || CycleRemindersScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/PartnerSharing'); PartnerSharingScreen = m.PartnerSharing || m.default || PartnerSharingScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/CycleSettings'); CycleSettingsScreen = m.CycleSettings || m.default || CycleSettingsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/cycle-tracking/ExportCycleReport'); ExportCycleReportScreen = m.ExportCycleReport || m.default || ExportCycleReportScreen; } catch { /* not available */ }
