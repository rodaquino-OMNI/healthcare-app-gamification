...
try { const m = require('../../screens/health/sleep/SleepHome'); SleepHomeScreen = m.SleepHome || m.default || SleepHomeScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepLog'); SleepLogScreen = m.SleepLog || m.default || SleepLogScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepQuality'); SleepQualityScreen = m.SleepQuality || m.default || SleepQualityScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepDiary'); SleepDiaryScreen = m.SleepDiary || m.default || SleepDiaryScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepTrends'); SleepTrendsScreen = m.SleepTrends || m.default || SleepTrendsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepGoals'); SleepGoalsScreen = m.SleepGoals || m.default || SleepGoalsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepDetail'); SleepDetailScreen = m.SleepDetail || m.default || SleepDetailScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/BedtimeRoutine'); BedtimeRoutineScreen = m.BedtimeRoutine || m.default || BedtimeRoutineScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SmartAlarm'); SmartAlarmScreen = m.SmartAlarm || m.default || SmartAlarmScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepInsights'); SleepInsightsScreen = m.SleepInsights || m.default || SleepInsightsScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepDeviceSync'); SleepDeviceSyncScreen = m.SleepDeviceSync || m.default || SleepDeviceSyncScreen; } catch { /* not available */ }
try { const m = require('../../screens/health/sleep/SleepExport'); SleepExportScreen = m.SleepExport || m.default || SleepExportScreen; } catch { /* not available */ }
