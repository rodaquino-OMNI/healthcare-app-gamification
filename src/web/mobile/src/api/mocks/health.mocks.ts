        ...
        schedule[fullDate] = [
            {
                ...
                dosage: '500mg',
                time: '08:00 AM',
                status: i < 4 ? 'taken' : i === 4 ? 'missed' : 'pending',
            },
            {
                id: `${fullDate}-2`,
            ...
            },
            {
                ...
                dosage: '20mg',
                time: '08:00 PM',
                status: i < 2 ? 'taken' : i === 2 ? 'missed' : 'pending',
            },
        ];
    }
...
export const MOCK_HEALTH_METRICS: HealthMetric[] = [
    {
        ...
        value: '120/80',
        unit: 'mmHg',
        recordedAt: '2026-02-22T08:30:00',
        trend: 'stable',
    },
    { id: 'hm-02', type: 'heart_rate', value: '72', unit: 'bpm', recordedAt: '2026-02-22T08:30:00', trend: 'stable' },
    {
        ...
        value: '95',
        unit: 'mg/dL',
        recordedAt: '2026-02-22T07:00:00',
        trend: 'down',
    },
    { id: 'hm-04', type: 'weight', value: '74.5', unit: 'kg', recordedAt: '2026-02-21T07:15:00', trend: 'down' },
    {
        ...
        value: '36.5',
        unit: '\u00B0C',
        recordedAt: '2026-02-22T08:00:00',
        trend: 'stable',
    },
