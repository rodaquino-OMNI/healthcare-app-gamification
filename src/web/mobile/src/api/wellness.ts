...
export async function getCompanionHistory(
  userId: string,
  sessionId?: string,
): Promise<CompanionChatHistory> {
  const session = await requireSession();
  const response: AxiosResponse<CompanionChatHistory> = await restClient.get(
...
export async function getMoodCheckInPrompt(userId: string): Promise<MoodCheckInPrompt> {
  const session = await requireSession();
  const response: AxiosResponse<MoodCheckInPrompt> = await restClient.get(
...
export async function getDailyPlan(
  ...
  const session = await requireSession();
  const response: AxiosResponse<DailyWellnessPlan> = await restClient.get(
    '/wellness/daily-plan',
    {
      params: { userId, date },
      headers: { Authorization: `Bearer ${session.accessToken}` },
...
export async function getWellnessInsights(userId: string): Promise<WellnessInsight[]> {
  const session = await requireSession();
  const response: AxiosResponse<WellnessInsight[]> = await restClient.get(
    '/wellness/insights',
    {
      params: { userId },
      headers: { Authorization: `Bearer ${session.accessToken}` },
...
export async function getWellnessGoals(userId: string): Promise<WellnessGoal[]> {
  const session = await requireSession();
  const response: AxiosResponse<WellnessGoal[]> = await restClient.get(
    '/wellness/goals',
    {
      params: { userId },
      headers: { Authorization: `Bearer ${session.accessToken}` },
...
export async function updateWellnessGoal(
  goalId: string,
  updates: Partial<WellnessGoal>,
): Promise<WellnessGoal> {
  const session = await requireSession();
  const response: AxiosResponse<WellnessGoal> = await restClient.put(
    `/wellness/goals/${goalId}`,
    updates,
    { headers: { Authorization: `Bearer ${session.accessToken}` } },
  );
  return response.data;
...
export async function getJournalEntries(
  ...
  const session = await requireSession();
  const response: AxiosResponse<JournalHistory> = await restClient.get(
    '/wellness/journal',
    {
...
export async function getJournalHistory(
  ...
  const session = await requireSession();
  const response: AxiosResponse<JournalEntry[]> = await restClient.get(
...
export async function getWellnessChallenges(userId: string): Promise<WellnessChallenge[]> {
  const session = await requireSession();
  const response: AxiosResponse<WellnessChallenge[]> = await restClient.get(
    '/wellness/challenges',
    {
      params: { userId },
      headers: { Authorization: `Bearer ${session.accessToken}` },
...
export async function getWellnessChallengeDetail(
  challengeId: string,
): Promise<WellnessChallengeDetail> {
  const session = await requireSession();
...
export async function joinWellnessChallenge(
  userId: string,
  challengeId: string,
...
export async function getWellnessStreaks(userId: string): Promise<WellnessStreak[]> {
  const session = await requireSession();
  const response: AxiosResponse<WellnessStreak[]> = await restClient.get(
    '/wellness/streaks',
    {
      params: { userId },
      headers: { Authorization: `Bearer ${session.accessToken}` },
...
export async function updateWellnessStreak(
  userId: string,
  type: string,
): Promise<WellnessStreak> {
  const session = await requireSession();
...
export async function getCompanionQuickReplies(
  userId: string,
  sessionId: string,
): Promise<string[]> {
  const session = await requireSession();
