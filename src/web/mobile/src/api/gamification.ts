import type { Achievement, Quest, Reward, GameProfile } from '@shared/types/gamification.types';
...
export async function getGameProfile(userId: string): Promise<GameProfile> {
    ...
    const response: AxiosResponse<GameProfile> = await restClient.get(endpoint, { headers });
 ...
 */
export async function updateGameProfile(userId: string, profileData: Partial<GameProfile>): Promise<GameProfile> {
    const headers = await authHeaders();
    const endpoint = `/api/gamification/profiles/${userId}`;
    const response: AxiosResponse<GameProfile> = await restClient.patch(endpoint, profileData, { headers });
    return response.data;
}
...
export async function getAchievements(userId: string): Promise<Achievement[]> {
    ...
    const response: AxiosResponse<Achievement[]> = await restClient.get(endpoint, { headers });
    return response.data;
}
...
export async function getQuests(userId: string): Promise<Quest[]> {
    ...
    const response: AxiosResponse<Quest[]> = await restClient.get(endpoint, { headers });
    return response.data;
}
...
export async function getRewards(userId: string): Promise<Reward[]> {
    ...
    const response: AxiosResponse<Reward[]> = await restClient.get(endpoint, { headers });
    return response.data;
}
 ...
 */
export async function getLeaderboard(period?: 'daily' | 'weekly' | 'monthly' | 'allTime'): Promise<LeaderboardEntry[]> {
    const headers = await authHeaders();
    const response: AxiosResponse<LeaderboardEntry[]> = await restClient.get('/api/gamification/leaderboard', {
        params: { period },
        headers,
    });
    return response.data;
 ...
 */
export async function updateQuestProgress(userId: string, questId: string, progress: number): Promise<Quest> {
    const headers = await authHeaders();
    const endpoint = `/api/gamification/profiles/${userId}/quests/${questId}/progress`;
    const response: AxiosResponse<Quest> = await restClient.post(endpoint, { progress }, { headers });
    return response.data;
}
 ...
 */
export async function completeQuest(userId: string, questId: string): Promise<Quest> {
    const headers = await authHeaders();
    const endpoint = `/api/gamification/profiles/${userId}/quests/${questId}/complete`;
    const response: AxiosResponse<Quest> = await restClient.post(endpoint, {}, { headers });
    return response.data;
}
 ...
 */
export async function redeemReward(userId: string, rewardId: string): Promise<RewardRedemption> {
    const headers = await authHeaders();
    const endpoint = `/api/gamification/profiles/${userId}/rewards/${rewardId}/redeem`;
    const response: AxiosResponse<RewardRedemption> = await restClient.post(endpoint, {}, { headers });
    return response.data;
}
...
export async function getRewardHistory(userId: string): Promise<RewardRedemption[]> {
    ...
    const response: AxiosResponse<RewardRedemption[]> = await restClient.get(endpoint, { headers });
    return response.data;
}
...
export async function getStreakStatus(userId: string): Promise<StreakStatus> {
    ...
    const response: AxiosResponse<StreakStatus> = await restClient.get(endpoint, { headers });
    return response.data;
}
 ...
 */
export async function updateStreak(userId: string, streakType: string): Promise<StreakStatus> {
    const headers = await authHeaders();
    const endpoint = `/api/gamification/profiles/${userId}/streak/update`;
    const response: AxiosResponse<StreakStatus> = await restClient.post(endpoint, { streakType }, { headers });
    return response.data;
}
