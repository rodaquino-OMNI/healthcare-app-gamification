...
const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  const getJourneyColor = () => {
    if (currentJourney === 'health') return theme.colors.journey.health;
    if (currentJourney === 'care') return theme.colors.journey.care;
    if (currentJourney === 'plan') return theme.colors.journey.plan;
