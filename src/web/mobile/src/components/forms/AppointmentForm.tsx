...
const AppointmentForm: React.FC = () => {
  ...
  const bookAppointment = async (appointmentData: Partial<Appointment>): Promise<{id: string}> => {
  ...
  // Mock implementation of gamification event trigger
  const triggerGamificationEvent = (eventType: string, data: any) => {
    console.log('Gamification event triggered:', eventType, data);
  };
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={[styles.title, { color: careColor }]}>
        Agendar Consulta
      </Text>
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <View style={styles.inputContainer}>
            ...
            {errors.providerId && (
              <Text style={styles.errorText}>{errors.providerId.message}</Text>
            )}
          </View>
        )}
      />
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <View style={styles.inputContainer}>
            ...
            >
              <Text>
                {value ? value.toLocaleString('pt-BR') : 'Selecione data e hora'}
              </Text>
            </TouchableOpacity>
            {showDatePicker && (
              <DateTimePicker
      ...
      <View style={styles.coverageInfo}>
        ...
        <Text style={styles.coverageText}>
          ✓ Esta consulta está coberta pelo seu plano
        </Text>
        <Text style={styles.coverageText}>
          ✓ Copagamento estimado: R$ 30,00
        </Text>
      </View>
