...
describe('NutritionHome', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<NutritionHome navigation={jest.fn() as any} route={{ params: {} } as any} />);
...
describe('MealLog', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<MealLog navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('MealDetail', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<MealDetail navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('FoodDiary', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<FoodDiary navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('MacroTracker', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<MacroTracker navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('WaterIntake', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<WaterIntake navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('DietaryGoals', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<DietaryGoals navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('NutritionInsights', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<NutritionInsights navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('FoodSearch', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<FoodSearch navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
...
describe('NutritionExport', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<NutritionExport navigation={jest.fn() as any} route={{ params: {} } as any} />);
    expect(toJSON()).toBeTruthy();
  });
});
