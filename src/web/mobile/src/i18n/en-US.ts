    ...
    health: {
      ...
      cycle: {
        ...
        fertility: {
          ...
          lowProbability: 'Low',
          disclaimer: 'This is an estimate based on your cycle data. It should not be used as a contraceptive method.',
          learnMore: 'Learn More',
          edu: {
            windowTitle: 'Understanding Your Fertile Window',
            windowDesc: 'The fertile window is the period when conception is most likely, typically spanning 6 days including ovulation day.',
            ovulationTitle: 'What Is Ovulation?',
            ovulationDesc: 'Ovulation is when an egg is released from the ovary. It usually occurs around day 14 of a 28-day cycle.',
            signsTitle: 'Signs of Ovulation',
            signsDesc: 'Common signs include changes in cervical mucus, slight rise in basal body temperature, and mild pelvic pain.',
          },
        },
        pms: {
        ...
        settings: {
          ...
          deleteConfirm: 'This will permanently delete all your cycle tracking data. This action cannot be undone.',
          days: 'days',
        },
        export: {
