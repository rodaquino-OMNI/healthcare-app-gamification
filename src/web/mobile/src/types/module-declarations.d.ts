...
declare module '@shared/types' {
  ...
  export type { Claim, Plan, Coverage, Benefit, ClaimStatus, ClaimType, PlanType, CoverageType } from '@shared/types/plan.types';
  export type { Achievement, Quest, Reward, GameProfile } from '@shared/types/gamification.types';
  export type { Notification, NotificationPreference, NotificationFilter, FilterOption } from '@shared/types/notification.types';
}
