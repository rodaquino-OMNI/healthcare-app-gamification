...
describe('NotificationsService', () => {
    ...
    let _preferencesService: PreferencesService;
    let _templatesService: TemplatesService;
    ...
    beforeEach(async () => {
        ...
        _preferencesService = module.get<PreferencesService>(PreferencesService);
        _templatesService = module.get<TemplatesService>(TemplatesService);
    });
    ...
    describe('markAsRead', () => {
        ...
        it('should throw AppException when notification is not found', async () => {
            ...
            await expect(service.markAsRead('nonexistent-id', 'user-1')).rejects.toThrow(
                AppException
            );
        });
    });
