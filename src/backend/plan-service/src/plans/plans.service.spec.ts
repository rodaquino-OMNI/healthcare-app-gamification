...
describe('PlansService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should throw AppException when query fails', async () => {
      ...
      await expect(service.findAll({ limit: 10 } as any)).rejects.toBeInstanceOf(AppException);
    });
  });
  ...
  describe('findOne', () => {
    ...
    it('should re-throw AppException from inner calls', async () => {
      const appException = new AppException('Not found', 'BUSINESS' as any, 'PLAN_NOT_FOUND', {});
  ...
  describe('update', () => {
    ...
    it('should throw AppException when plan not found for update', async () => {
      ...
      await expect(service.update('non-existent-id', { name: 'New' })).rejects.toBeInstanceOf(AppException);
    });
    ...
    it('should throw AppException on DB update error', async () => {
      ...
      await expect(service.update('test-plan-id', { name: 'New' })).rejects.toBeInstanceOf(AppException);
    });
  });
  ...
  describe('verifyCoverage', () => {
    ...
    it('should throw AppException when plan not found', async () => {
      ...
      await expect(service.verifyCoverage('non-existent', '99213')).rejects.toBeInstanceOf(AppException);
    });
  });
  ...
  describe('calculateCoverage', () => {
    ...
    it('should throw AppException when plan not found', async () => {
      ...
      await expect(service.calculateCoverage('non-existent', '99213', 100)).rejects.toBeInstanceOf(AppException);
    });
  });
});
