...
const createValidationSchema = (): Joi.ObjectSchema => {
    return Joi.object({
        ...
        gamification: Joi.object({
            ...
            events: Joi.object({
                claimSubmitted: Joi.string()
                    .default('CLAIM_SUBMITTED')
                    .description('Event name for claim submission'),
                claimApproved: Joi.string()
                    .default('CLAIM_APPROVED')
                ...
                benefitUsed: Joi.string()
                    .default('BENEFIT_USED')
