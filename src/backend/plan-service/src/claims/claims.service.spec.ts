...
describe('ClaimsService', () => {
    ...
    describe('create', () => {
        ...
        it('should throw AppException when user does not own the plan', async () => {
            ...
            await expect(service.create(userId, createClaimDto)).rejects.toBeInstanceOf(
                AppException
            );
        });
    ...
    describe('update', () => {
        ...
        it('should throw AppException when claim status is not updatable', async () => {
            ...
            await expect(service.update('test-claim-id', updateDto)).rejects.toBeInstanceOf(
                AppException
            );
        });
        ...
        it('should throw AppException when claim not found', async () => {
            ...
            await expect(service.update('non-existent', {} as any)).rejects.toBeInstanceOf(
                AppException
            );
        });
    });
