...
export const validationSchema = Joi.object({
    ...
    ACHIEVEMENT_NOTIFICATION_ENABLED: Joi.boolean()
        .default(true)
        .description('Enable achievement notifications'),
    DEFAULT_POINTS_EXPIRY_DAYS: Joi.number()
        .default(365)
    ...
    ENABLE_LEADERBOARDS: Joi.boolean()
        .default(true)
    ...
    RULE_EVALUATION_TIMEOUT_MS: Joi.number()
        .default(5000)
        .description('Timeout for rule evaluation in milliseconds'),
    MAX_EVENT_QUEUE_SIZE: Joi.number()
        .default(10000)
