...
describe('ProvidersService', () => {
    ...
    describe('update', () => {
        ...
        it('should throw AppException when update query fails', async () => {
            ...
            await expect(service.update('provider-test-123', { name: 'New Name' })).rejects.toThrow(
                AppException
            );
        });
    });
    ...
    describe('checkAvailability', () => {
        ...
        it('should throw AppException when provider does not exist', async () => {
            ...
            await expect(service.checkAvailability('nonexistent', dateTime)).rejects.toThrow(
                AppException
            );
        });
    });
    ...
    describe('getAvailableTimeSlots', () => {
        ...
        it('should throw AppException when provider does not exist', async () => {
            ...
            await expect(service.getAvailableTimeSlots('nonexistent', date)).rejects.toThrow(
                AppException
            );
        });
    });
    ...
    describe('getTelemedicineProviders', () => {
        ...
        it('should throw AppException when query fails', async () => {
            ...
            await expect(service.getTelemedicineProviders({ page: 1, limit: 10 })).rejects.toThrow(
                AppException
            );
        });
    });
