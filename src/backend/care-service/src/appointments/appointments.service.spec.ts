...
describe('AppointmentsService', () => {
  ...
  const mockAppointment = {
    ...
    user: { id: 'user-test-123', name: 'Test User', email: 'test@example.com', phone: '+5511999990000' },
  };
  ...
  describe('create', () => {
    ...
    it('should create an appointment when all validations pass', async () => {
      const mockProvider = { id: 'provider-test-123', name: 'Dr. Test', telemedicineAvailable: true };
  ...
  describe('update', () => {
    ...
    it('should throw AppException when appointment does not exist', async () => {
      ...
      await expect(
        service.update('nonexistent', { notes: 'test' } as any),
    ...
    it('should throw AppException when appointment is already completed', async () => {
      ...
      await expect(
        service.update('appt-test-123', { notes: 'test' } as any),
      ).rejects.toThrow(AppException);
    });
