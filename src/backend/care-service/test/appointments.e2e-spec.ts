...
describe('AppointmentsController (e2e)', () => {
    ...
    it('/appointments (POST) should return 201 if successful', () => {
        ...
        return agent.post('/appointments').send(createAppointmentDto).expect(HttpStatus.CREATED);
    });
    ...
    it('/appointments (GET) should return 200 if successful', () => {
        return agent.get('/appointments').expect(HttpStatus.OK);
    });

    it('/appointments/:id (GET) should return 200 if successful', () => {
        return agent.get('/appointments/valid-uuid').expect(HttpStatus.OK);
    });
    ...
    it('/appointments/:id (DELETE) should return 204 if successful', () => {
        return agent.delete('/appointments/valid-uuid').expect(HttpStatus.NO_CONTENT);
    });
});
