...
describe('PrivacyService', () => {
    ...
    beforeEach(async () => {
        const module: TestingModule = await Test.createTestingModule({
            providers: [PrivacyService, { provide: PrismaService, useValue: mockPrismaService }],
        }).compile();
    ...
    describe('rectifyMyData', () => {
        ...
        it('updates user name and returns the updated record', async () => {
            ...
            const result = (await service.rectifyMyData(userId, { name: 'Maria Souza' })) as Record<
                string,
                any
            >;
        ...
        it('updates user phone and returns the updated record', async () => {
            ...
            const result = (await service.rectifyMyData(userId, {
                phone: '+5511888888888',
