...
export class ApiGatewayConfigValidation {
    ...
    static schema = Joi.object({
        ...
        authentication: Joi.object({
            ...
            refreshTokenExpiration: Joi.string()
                .pattern(/^\d+[smhd]$/)
                .required()
        ...
        services: Joi.object({
            health: Joi.string().uri().required().description('Health journey service URL'),
            care: Joi.string().uri().required().description('Care journey service URL'),
            plan: Joi.string().uri().required().description('Plan journey service URL'),
            game: Joi.string().uri().required().description('Gamification service URL'),
            auth: Joi.string().uri().required().description('Authentication service URL'),
        })
            .required()
