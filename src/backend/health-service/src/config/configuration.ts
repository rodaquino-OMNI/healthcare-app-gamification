...
export const health = registerAs('health', () => ({
    ...
    metricsRetentionDays: parseInt(process.env.METRICS_RETENTION_DAYS ?? '730', 10) || 730,
    ...
    wearablesSyncInterval: parseInt(process.env.WEARABLES_SYNC_INTERVAL ?? '15', 10) || 15,
    ...
    redisTtl: parseInt(process.env.REDIS_TTL ?? '3600', 10) || 3600,
    medicalHistoryMaxEvents: parseInt(process.env.MEDICAL_HISTORY_MAX_EVENTS ?? '1000', 10) || 1000,
