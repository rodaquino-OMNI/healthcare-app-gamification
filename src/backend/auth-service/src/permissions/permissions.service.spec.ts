...
describe('PermissionsService', () => {
    ...
    describe('create', () => {
        ...
        it('should throw AppException (TECHNICAL / PERM_001) when creation fails', async () => {
            mockPrismaService.permission.create.mockRejectedValue(new Error('Database error'));
    ...
    describe('findOne', () => {
        ...
        it('should throw AppException (TECHNICAL / PERM_003) when retrieval fails', async () => {
            mockPrismaService.permission.findUnique.mockRejectedValue(new Error('Database error'));
