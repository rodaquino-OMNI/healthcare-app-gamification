...
# Security group outputs (referenced by root)
output "cluster_security_group_id" {
  description = "The ID of the security group attached to the EKS cluster"
...
output "kubeconfig" {
  description = "kubectl config content as generated by the module"
